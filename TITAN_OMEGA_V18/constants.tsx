...
import { StrikeStatus, LegalStrike, Priority, Case, SupportedLanguage } from './types';

export const TRANSLATIONS: Record<SupportedLanguage, any> = {
  AR: {
    wolf_proverb: "السيادة الرقمية هي السلاح الوحيد ضد نفاق السحابة والشركات الكبرى",
  ...
  EN: {
    wolf_proverb: "Digital sovereignty is the only weapon against global cloud hypocrisy",
  ...
  HI: { wolf_proverb: "डिजिटल संप्रभुता हथियार है", action_quote: "पूर्ण संप्रभुता", arsenal: "शस्त्रागार", dashboard: "बेस", status: "स्थिति: स्वतंत्र", threat: "निवारण", uplink: "ओमेगा", thinking: "विखंडन...", execute: "चлаएं", upload: "अपलोड", radio_mode_truth: "सच्चائي", radio_mode_music: "संगीत", deploy_strike: "स्ट्राइक", infra: "बुनियादी ढांचा", command: "कमान", mesh: "मेश", tools: "उपकरण" },
...
export const INITIAL_CASES: Case[] = [
  { id: 'CASE-HILO-RECLAMATION', title: "HILO/FALLA CRIME SYNDICATE", description: "Operation Riyadh-Zero. Surgical audit of a $600,000 fraud infrastructure. Reclaiming stolen digital assets." }
];

export const INITIAL_STRIKES: LegalStrike[] = [
  {
    id: 'strike-hilo-01',
    entity: 'Sweden-Node-01 Intercept',
    platform: 'ws.faceline.live',
    status: StrikeStatus.COMPLETED,
    timestamp: '2026-01-22 04:03 AM',
    description: "TLS handshake captured. live RSA/AES handshakes indexed for forensic deconstruction.",
    type: 'LEGAL',
    priority: Priority.HIGH,
    caseId: 'CASE-HILO-RECLAMATION'
  },
  {
    id: 'strike-hilo-02',
    entity: 'Firebase Breach Audit',
    platform: 'nextvideo-1590999469166',
    status: StrikeStatus.IN_PROGRESS,
    timestamp: '2026-01-22 11:24 PM',
    description: "Targeting 'pay_callback' and 'config' nodes. Shared DNA mapped via Google Project 432159938851.",
    type: 'GOVERNMENT',
    priority: Priority.HIGH,
    caseId: 'CASE-HILO-RECLAMATION'
  },
  {
    id: 'strike-hilo-03',
    entity: 'Identity Lockdown (Hong Kong)',
    platform: 'HKhuanyu@iyinguo.com',
    status: StrikeStatus.PENDING,
    timestamp: '2026-01-23 01:15 AM',
    description: "Tracking logistical origin (+852). Accountable parties identified for surgical reclamation.",
    type: 'LEGAL',
