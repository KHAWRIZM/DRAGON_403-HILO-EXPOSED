...
class a implements ISecurity {
    ...
    public String sign(Context context, String str, String str2, String str3) {
        if (TextUtils.isEmpty(this.f٤٨٨٥a) || !ISecurity.SIGN_ALGORITHM_HMAC_SHA1.equalsIgnoreCase(str)) {
            return null;
        }
        return HMacUtil.hmacSha1Hex(this.f٤٨٨٥a.getBytes(), str3.getBytes());
    }
}
