...
public class a implements IRemoteConfig {
    ...
    public void onConfigUpdate(String str) {
        ...
        if ("networkSdk".equals(str)) {
            ...
            try {
                c.a.f٤٩٨٣a.a(Boolean.valueOf(getConfig(str, "network_empty_scheme_https_switch", "true")).booleanValue());
            } catch (Exception unused) {
            }
            try {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config7)) {
                    ...
                    NetworkConfigCenter.setBgForbidRequestThreshold(i10);
                }
