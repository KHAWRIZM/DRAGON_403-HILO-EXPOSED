...
public class ErrorConstant {
    ...
    public static String formatMsg(int i10, String str) {
        return StringUtils.concatString(getErrMsg(i10), CertificateUtil.DELIMITER, str);
    }

    public static String getErrMsg(int i10) {
        return StringUtils.stringNull2Empty(errorMsgMap.get(i10));
    }
}
