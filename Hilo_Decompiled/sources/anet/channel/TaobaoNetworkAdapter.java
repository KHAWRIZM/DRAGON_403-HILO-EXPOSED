    ...
    private static void a(String str, String str2, ConnProtocol connProtocol, boolean z10, boolean z11) {
        ...
        if (z10) {
            if (!z11) {
                ...
                SessionCenter.getInstance(new Config.Builder().setAppkey(str2).setEnv(ENV.ONLINE).build()).get(HttpUrl.parse(StringUtils.concatString(HttpConstant.HTTPS, HttpConstant.SCHEME_SPLIT, str)), anet.channel.entity.c.f٤٧٧١a, 0L);
            }
        }
    }
