...
public class MatchRatingApproachEncoder implements StringEncoder {
    ...
    boolean isVowel(String str) {
        if (!str.equalsIgnoreCase("E") && !str.equalsIgnoreCase("A") && !str.equalsIgnoreCase("O") && !str.equalsIgnoreCase("I") && !str.equalsIgnoreCase("U")) {
            return false;
        }
        return true;
    }
    ...
    String removeAccents(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (indexOf > -1) {
                sb2.append(PLAIN_ASCII.charAt(indexOf));
            } else {
                sb2.append(charAt);
            }
        }
