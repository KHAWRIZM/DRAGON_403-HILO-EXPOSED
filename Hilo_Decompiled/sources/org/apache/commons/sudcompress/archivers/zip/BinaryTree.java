...
class BinaryTree {
    ...
    public BinaryTree(int i) {
        ...
        throw new IllegalArgumentException(m.a(i, "depth must be bigger than 0 and not bigger than 30 but is "));
    }

    public static BinaryTree decode(InputStream inputStream, int i) {
        if (i >= 0) {
            int read = inputStream.read() + 1;
            if (read != 0) {
                byte[] bArr = new byte[read];
                if (k0.a.a(inputStream, bArr, 0, read) == read) {
                    int[] iArr = new int[i];
                    int i2 = 0;
                    int i3 = 0;
        ...
        throw new IllegalArgumentException(m.a(i, "totalNumberOfValues must be bigger than 0, is "));
    }
