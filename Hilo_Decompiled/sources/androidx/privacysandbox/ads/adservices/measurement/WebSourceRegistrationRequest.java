...
public final class WebSourceRegistrationRequest {
    ...
    public final android.adservices.measurement.WebSourceRegistrationRequest convertToAdServices$ads_adservices_release() {
        ...
        e0.a();
        webDestination = d0.a(WebSourceParams.INSTANCE.convertWebSourceParams$ads_adservices_release(this.WebSourceParams), this.TopOriginUri).setWebDestination(this.WebDestination);
