...
public final class Topic {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.TaxonomyVersion == topic.TaxonomyVersion && this.ModelVersion == topic.ModelVersion && this.TopicCode == topic.TopicCode) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((androidx.collection.c.a(this.TaxonomyVersion) * 31) + androidx.collection.c.a(this.ModelVersion)) * 31) + this.TopicCode;
    }
