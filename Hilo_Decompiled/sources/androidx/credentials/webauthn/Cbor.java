...
public final class Cbor {
    ...
    private final byte[] createArg(int type, long arg) {
        ...
        int i11 = (int) arg;
        if (arg < 24) {
            return new byte[]{(byte) ((i10 | i11) & KotlinVersion.MAX_COMPONENT_VALUE)};
        }
        if (arg <= 255) {
            return new byte[]{(byte) ((i10 | 24) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) (i11 & KotlinVersion.MAX_COMPONENT_VALUE)};
        }
        if (arg <= 65535) {
            return new byte[]{(byte) ((i10 | 25) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i11 >> 8) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) (i11 & KotlinVersion.MAX_COMPONENT_VALUE)};
        }
        if (arg <= 4294967295L) {
            return new byte[]{(byte) ((i10 | 26) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i11 >> 24) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i11 >> 16) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) ((i11 >> 8) & KotlinVersion.MAX_COMPONENT_VALUE), (byte) (i11 & KotlinVersion.MAX_COMPONENT_VALUE)};
        }
    ...
    private final int getType(byte[] data, int offset) {
        return (data[offset] & UByte.MAX_VALUE) >> 5;
    }
    ...
    public final byte[] encode(@NotNull Object data) {
        ...
        if (data instanceof Map) {
            ...
            CollectionsKt.sortedWith(arrayList, new Comparator() { // from class: q2.b
