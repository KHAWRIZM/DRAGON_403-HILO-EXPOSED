...
public final class PasswordCredentialEntry extends CredentialEntry {
    ...
    public static final class Api28Impl {
        ...
        public static final PasswordCredentialEntry fromSlice(@NotNull Slice slice) {
            ...
            try {
                ...
                return new PasswordCredentialEntry(charSequence2, charSequence3, charSequence4, pendingIntent, instant, icon, z10, companion.createFrom$credentials_release(bundle, charSequence.toString()), z11, charSequence5, charSequence6, z12, true, z13);
            } catch (Exception e10) {
        ...
        public static final boolean isDefaultIcon(@NotNull PasswordCredentialEntry entry) {
            ...
            if (entry.getIcon().getType() == 2 && entry.getIcon().getResId() == R.drawable.ic_password) {
                return true;
            }
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final PasswordCredentialEntry build() {
            ...
            if (this.icon == null && Build.VERSION.SDK_INT >= 23) {
                createWithResource = Icon.createWithResource(this.context, R.drawable.ic_password);
        ...
        @NotNull
        public final Builder setAffiliatedDomain(@Nullable CharSequence affiliatedDomain) {
    ...
    public /* synthetic */ PasswordCredentialEntry(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, PendingIntent pendingIntent, Instant instant, Icon icon, boolean z10, BeginGetPasswordOption beginGetPasswordOption, boolean z11, CharSequence charSequence4, CharSequence charSequence5, boolean z12, boolean z13, boolean z14, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(charSequence, charSequence2, charSequence3, pendingIntent, instant, icon, z10, beginGetPasswordOption, z11, (i10 & 512) != 0 ? charSequence : charSequence4, (i10 & 1024) != 0 ? null : charSequence5, (i10 & 2048) != 0 ? CredentialOption.INSTANCE.extractAutoSelectValue$credentials_release(beginGetPasswordOption.getCandidateQueryData()) : z12, (i10 & 4096) != 0 ? false : z13, (i10 & 8192) != 0 ? false : z14);
    }
    ...
    */
    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z10, CharSequence charSequence3, boolean z11, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, charSequence, pendingIntent, beginGetPasswordOption, r8, r9, r10, (i10 & 128) != 0 ? false : z10, (i10 & 256) != 0 ? null : charSequence3, (i10 & 512) != 0 ? false : z11);
        Icon icon2;
        Icon createWithResource;
        ...
        if ((i10 & 64) != 0) {
            ...
            Intrinsics.checkNotNullExpressionValue(createWithResource, "createWithResource(conte…, R.drawable.ic_password)");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public PasswordCredentialEntry(@NotNull Context context, @NotNull CharSequence username, @NotNull PendingIntent pendingIntent, @NotNull BeginGetPasswordOption beginGetPasswordOption, @Nullable CharSequence charSequence, @Nullable Instant instant, @NotNull Icon icon, boolean z10, @Nullable CharSequence charSequence2, boolean z11) {
        this(username, charSequence, r0, pendingIntent, instant, icon, z10, beginGetPasswordOption, z11, null, charSequence2, false, false, false, 14848, null);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(username, "username");
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        Intrinsics.checkNotNullParameter(beginGetPasswordOption, "beginGetPasswordOption");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence2, Instant instant, Icon icon, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, charSequence, pendingIntent, beginGetPasswordOption, r8, r9, r10, (i10 & 128) != 0 ? false : z10);
        Icon icon2;
        Icon createWithResource;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public /* synthetic */ PasswordCredentialEntry(Context context, CharSequence username, PendingIntent pendingIntent, BeginGetPasswordOption beginGetPasswordOption, CharSequence charSequence, Instant instant, Icon icon, boolean z10) {
        this(username, charSequence, r0, pendingIntent, instant, icon, z10, beginGetPasswordOption, false, null, null, false, false, false, 15872, null);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(username, "username");
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        Intrinsics.checkNotNullParameter(beginGetPasswordOption, "beginGetPasswordOption");
