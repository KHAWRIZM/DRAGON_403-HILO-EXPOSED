...
public final class CustomCredentialEntry extends CredentialEntry {
    ...
    public static final class Api28Impl {
        ...
        public static final CustomCredentialEntry fromSlice(@NotNull Slice slice) {
            ...
            try {
                ...
                return new CustomCredentialEntry(type, charSequence2, pendingIntent, z10, charSequence3, charSequence4, icon, instant, new BeginGetCustomCredentialOption(charSequence.toString(), type, new Bundle()), z11, charSequence5, charSequence6, z12, true, z13);
            } catch (Exception e10) {
        ...
        public static final boolean isDefaultIcon(@NotNull CustomCredentialEntry entry) {
            ...
            if (entry.getIcon().getType() == 2 && entry.getIcon().getResId() == R.drawable.ic_other_sign_in) {
                return true;
            }
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final CustomCredentialEntry build() {
            ...
            Icon icon = this.icon;
            Intrinsics.checkNotNull(icon);
            return new CustomCredentialEntry(str, charSequence, pendingIntent, z10, charSequence2, charSequence3, icon, this.lastUsedTime, this.beginGetCredentialOption, this.isDefaultIconPreferredAsSingleProvider, this.entryGroupId, null, false, false, false, 30720, null);
        }
        ...
        @NotNull
        public final Builder setTypeDisplayName(@Nullable CharSequence typeDisplayName) {
    ...
    public /* synthetic */ CustomCredentialEntry(String str, CharSequence charSequence, PendingIntent pendingIntent, boolean z10, CharSequence charSequence2, CharSequence charSequence3, Icon icon, Instant instant, BeginGetCredentialOption beginGetCredentialOption, boolean z11, CharSequence charSequence4, CharSequence charSequence5, boolean z12, boolean z13, boolean z14, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, charSequence, pendingIntent, z10, charSequence2, charSequence3, icon, instant, beginGetCredentialOption, z11, (i10 & 1024) != 0 ? charSequence : charSequence4, (i10 & 2048) != 0 ? null : charSequence5, (i10 & 4096) != 0 ? CredentialOption.INSTANCE.extractAutoSelectValue$credentials_release(beginGetCredentialOption.getCandidateQueryData()) : z12, (i10 & 8192) != 0 ? false : z13, (i10 & DownloadTask.Builder.DEFAULT_FLUSH_BUFFER_SIZE) != 0 ? false : z14);
    }
    ...
    */
    public /* synthetic */ CustomCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetCredentialOption beginGetCredentialOption, CharSequence charSequence2, CharSequence charSequence3, Instant instant, Icon icon, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, charSequence, pendingIntent, beginGetCredentialOption, r8, r9, r10, r11, (i10 & 256) != 0 ? false : z10);
        Icon icon2;
        Icon createWithResource;
        CharSequence charSequence4 = (i10 & 16) != 0 ? null : charSequence2;
        CharSequence charSequence5 = (i10 & 32) != 0 ? null : charSequence3;
        Instant instant2 = (i10 & 64) != 0 ? null : instant;
        if ((i10 & 128) != 0) {
            createWithResource = Icon.createWithResource(context, R.drawable.ic_other_sign_in);
            Intrinsics.checkNotNullExpressionValue(createWithResource, "createWithResource(conte…rawable.ic_other_sign_in)");
    ...
    public /* synthetic */ CustomCredentialEntry(Context context, CharSequence title, PendingIntent pendingIntent, BeginGetCredentialOption beginGetCredentialOption, CharSequence charSequence, CharSequence charSequence2, Instant instant, Icon icon, boolean z10) {
        this(beginGetCredentialOption.getType(), title, pendingIntent, z10, charSequence, charSequence2, icon, instant, beginGetCredentialOption, false, null, null, false, false, false, 31744, null);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        Intrinsics.checkNotNullParameter(beginGetCredentialOption, "beginGetCredentialOption");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public /* synthetic */ CustomCredentialEntry(Context context, CharSequence charSequence, PendingIntent pendingIntent, BeginGetCredentialOption beginGetCredentialOption, CharSequence charSequence2, CharSequence charSequence3, Instant instant, Icon icon, boolean z10, CharSequence charSequence4, boolean z11, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, charSequence, pendingIntent, beginGetCredentialOption, r8, r9, r10, r11, (i10 & 256) != 0 ? false : z10, (i10 & 512) != 0 ? charSequence : charSequence4, (i10 & 1024) != 0 ? false : z11);
        Icon icon2;
        Icon createWithResource;
        CharSequence charSequence5 = (i10 & 16) != 0 ? null : charSequence2;
        CharSequence charSequence6 = (i10 & 32) != 0 ? null : charSequence3;
        Instant instant2 = (i10 & 64) != 0 ? null : instant;
        if ((i10 & 128) != 0) {
            createWithResource = Icon.createWithResource(context, R.drawable.ic_other_sign_in);
            Intrinsics.checkNotNullExpressionValue(createWithResource, "createWithResource(conte…rawable.ic_other_sign_in)");
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public CustomCredentialEntry(@NotNull Context context, @NotNull CharSequence title, @NotNull PendingIntent pendingIntent, @NotNull BeginGetCredentialOption beginGetCredentialOption, @Nullable CharSequence charSequence, @Nullable CharSequence charSequence2, @Nullable Instant instant, @NotNull Icon icon, boolean z10, @NotNull CharSequence entryGroupId, boolean z11) {
        this(beginGetCredentialOption.getType(), title, pendingIntent, z10, charSequence, charSequence2, icon, instant, beginGetCredentialOption, z11, entryGroupId.length() == 0 ? title : entryGroupId, null, false, false, false, 30720, null);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        Intrinsics.checkNotNullParameter(beginGetCredentialOption, "beginGetCredentialOption");
