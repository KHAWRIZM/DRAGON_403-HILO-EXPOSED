...
public class NestedScrollView extends FrameLayout implements g0, d0, o0 {
    ...
    @VisibleForTesting
    androidx.core.view.o mDifferentialMotionFlingController;
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f٣٠٦٨a + "}";
        }

        @Override // android.view.View.BaseSavedState, android.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i10) {
            super.writeToParcel(parcel, i10);
            parcel.writeInt(this.f٣٠٦٨a);
        }

        SavedState(Parcel parcel) {
            super(parcel);
            this.f٣٠٦٨a = parcel.readInt();
        }
    }
    ...
    static class a extends androidx.core.view.a {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            m2.i0.a(accessibilityEvent, nestedScrollView.getScrollX());
            m2.i0.b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
    ...
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes.dex */
    class d implements androidx.core.view.p {
        d() {
        }
    ...
    private boolean A(EdgeEffect edgeEffect, int i10) {
        if (i10 > 0) {
            return true;
        }
        if (i(-i10) < f.b(edgeEffect) * getHeight()) {
            return true;
        }
        return false;
    }
    ...
    private void r(int i10, int i11, int[] iArr) {
        int scrollY = getScrollY();
        scrollBy(0, i10);
    ...
    */
    private int u(int i10, float f10) {
        ...
        float f11 = 0.0f;
        if (f.b(this.mEdgeGlowTop) != 0.0f) {
            d10 = -f.d(this.mEdgeGlowTop, -height, width);
            if (f.b(this.mEdgeGlowTop) == 0.0f) {
                this.mEdgeGlowTop.onRelease();
            }
        } else {
            if (f.b(this.mEdgeGlowBottom) != 0.0f) {
                d10 = f.d(this.mEdgeGlowBottom, height, 1.0f - width);
                if (f.b(this.mEdgeGlowBottom) == 0.0f) {
                    this.mEdgeGlowBottom.onRelease();
                }
            }
    ...
    private boolean w(int i10, int i11, int i12) {
        ...
        if (h10 != findFocus()) {
            h10.requestFocus(i10);
        }
        return z11;
    }

    private int x(int i10, int i11, int i12, boolean z10) {
        int i13;
        int i14;
        boolean z11;
        boolean z12;
        ...
        if (z13 && i12 == 0 && (velocityTracker = this.mVelocityTracker) != null) {
            velocityTracker.clear();
        }
        if (i12 == 1) {
    ...
    int consumeFlingInVerticalStretch(int i10) {
        ...
        if (i10 > 0 && f.b(this.mEdgeGlowTop) != 0.0f) {
            int round = Math.round(((-height) / FLING_DESTRETCH_FACTOR) * f.d(this.mEdgeGlowTop, ((-i10) * FLING_DESTRETCH_FACTOR) / height, MAX_SCROLL_FACTOR));
            if (round != i10) {
        ...
        if (i10 < 0 && f.b(this.mEdgeGlowBottom) != 0.0f) {
            float f10 = height;
            int round2 = Math.round((f10 / FLING_DESTRETCH_FACTOR) * f.d(this.mEdgeGlowBottom, (i10 * FLING_DESTRETCH_FACTOR) / f10, MAX_SCROLL_FACTOR));
            if (round2 != i10) {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        boolean c10 = c();
        int i10 = Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED;
        if (!c10) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED);
            if (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED)) {
                return false;
            }
            return true;
        }
        ...
        if (keyCode != 19) {
                    ...
                    if (keyCode != 92) {
                        if (keyCode != 93) {
                            if (keyCode != 122) {
                                ...
                                pageScroll(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED);
                                return false;
                            }
                            pageScroll(33);
                            return false;
                        }
                        return fullScroll(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED);
                    }
            ...
            return arrowScroll(Constants.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISHED);
        }
        if (keyEvent.isAltPressed()) {
            return fullScroll(33);
        }
    ...
    public boolean fullScroll(int i10) {
        ...
        return w(i10, rect3.top, rect3.bottom);
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (f10 != 0.0f) {
                x(-((int) (f10 * getVerticalScrollFactorCompat())), i11, 1, c0.a(motionEvent, 8194));
                if (i10 != 0) {
    ...
    protected void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (!this.mIsLaidOut) {
            if (this.mSavedState != null) {
                scrollTo(getScrollX(), this.mSavedState.f٣٠٦٨a);
    ...
    protected boolean onRequestFocusInDescendants(int i10, Rect rect) {
        ...
        if (findNextFocusFromRect == null || o(findNextFocusFromRect)) {
            return false;
        }
            ...
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        int u10 = i10 - u(i10, motionEvent.getX(findPointerIndex));
                        if (!this.mIsBeingDragged && Math.abs(u10) > this.mTouchSlop) {
                            ViewParent parent2 = getParent();
                            if (parent2 != null) {
                                parent2.requestDisallowInterceptTouchEvent(true);
                            }
                            this.mIsBeingDragged = true;
                            u10 = u10 > 0 ? u10 - this.mTouchSlop : u10 + this.mTouchSlop;
                        }
                        if (this.mIsBeingDragged) {
                            int x10 = x(u10, (int) motionEvent.getX(findPointerIndex), 0, false);
                            this.mLastMotionY = y10 - x10;
                            this.mNestedYOffset += x10;
                        }
                    }
                }
            } else {
    ...
    */
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.mDifferentialMotionFlingController = new androidx.core.view.o(getContext(), dVar);
