...
public class a {
    ...
    private final float f٢٧٣٥a;

    /* renamed from: b, reason: collision with root package name */
    private final float f٢٧٣٦b;

    /* renamed from: c, reason: collision with root package name */
    private final float f٢٧٣٧c;

    /* renamed from: d, reason: collision with root package name */
    private final float f٢٧٣٨d;

    /* renamed from: e, reason: collision with root package name */
    private final float f٢٧٣٩e;

    /* renamed from: f, reason: collision with root package name */
    private final float f٢٧٤٠f;

    /* renamed from: g, reason: collision with root package name */
    private final float f٢٧٤١g;

    /* renamed from: h, reason: collision with root package name */
    private final float f٢٧٤٢h;

    /* renamed from: i, reason: collision with root package name */
    private final float f٢٧٤٣i;
    ...
    private static a b(float f10, float f11, float f12) {
        ...
        while (Math.abs(f16 - f13) > 0.01f) {
            ...
            if (f14 == DownloadProgress.UNKNOWN_PROGRESS && f15 == DownloadProgress.UNKNOWN_PROGRESS) {
                break;
            }
            if (b10 < f12) {
                f16 = f17;
    ...
    static void d(int i10, l lVar, float[] fArr, float[] fArr2) {
        ...
        if (atan2 < DownloadProgress.UNKNOWN_PROGRESS) {
            atan2 += 360.0f;
    ...
    static int n(float f10, float f11, float f12, l lVar) {
        ...
        if (f11 >= 1.0d && Math.round(f12) > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && Math.round(f12) < 100.0d) {
            if (f10 < DownloadProgress.UNKNOWN_PROGRESS) {
                min = DownloadProgress.UNKNOWN_PROGRESS;
            } else {
    ...
    int o(l lVar) {
        float f10;
        if (i() != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && k() != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
        ...
        float signum = Math.signum(f16) * (100.0f / lVar.c()) * ((float) Math.pow((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (Math.abs(f16) * 27.13d) / (400.0d - Math.abs(f16))), 2.380952380952381d));
        float signum2 = Math.signum(f17) * (100.0f / lVar.c()) * ((float) Math.pow((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (Math.abs(f17) * 27.13d) / (400.0d - Math.abs(f17))), 2.380952380952381d));
        float signum3 = Math.signum(((f15 - (f13 * 220.0f)) - (f14 * 6300.0f)) / 1403.0f) * (100.0f / lVar.c()) * ((float) Math.pow((float) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (Math.abs(r8) * 27.13d) / (400.0d - Math.abs(r8))), 2.380952380952381d));
        ...
        float[] fArr4 = fArr[2];
        return x.b(f21, f22, (f18 * fArr4[0]) + (f19 * fArr4[1]) + (f20 * fArr4[2]));
    }
