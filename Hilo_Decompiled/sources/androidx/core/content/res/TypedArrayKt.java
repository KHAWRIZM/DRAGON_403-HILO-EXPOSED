...
public final class TypedArrayKt {
    ...
    public static final boolean getBooleanOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getBoolean(i10, false);
    }

    public static final int getColorOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getColor(i10, 0);
    }

    @NotNull
    public static final ColorStateList getColorStateListOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
    ...
    public static final float getDimensionOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getDimension(i10, DownloadProgress.UNKNOWN_PROGRESS);
    }

    @Dimension
    public static final int getDimensionPixelOffsetOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getDimensionPixelOffset(i10, 0);
    }

    @Dimension
    public static final int getDimensionPixelSizeOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getDimensionPixelSize(i10, 0);
    }

    @NotNull
    public static final Drawable getDrawableOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
    ...
    public static final float getFloatOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getFloat(i10, DownloadProgress.UNKNOWN_PROGRESS);
    }

    @RequiresApi(26)
    @NotNull
    public static final Typeface getFontOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return TypedArrayApi26ImplKt.getFont(typedArray, i10);
    }

    public static final int getIntOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getInt(i10, 0);
    }

    public static final int getIntegerOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getInteger(i10, 0);
    }

    public static final int getResourceIdOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getResourceId(i10, 0);
    }

    @NotNull
    public static final String getStringOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
    ...
    @NotNull
    public static final CharSequence[] getTextArrayOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
        return typedArray.getTextArray(i10);
    }

    @NotNull
    public static final CharSequence getTextOrThrow(@NotNull TypedArray typedArray, int i10) {
        checkAttribute(typedArray, i10);
