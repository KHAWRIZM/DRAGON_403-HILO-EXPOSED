...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(@NotNull Context context, @Nullable AttributeSet attributeSet, @NotNull int[] iArr, int i10, int i11, @NotNull Function1<? super TypedArray, Unit> function1) {
    ...
    public static final void withStyledAttributes(@NotNull Context context, int i10, @NotNull int[] iArr, @NotNull Function1<? super TypedArray, Unit> function1) {
