...
public class FileProvider extends ContentProvider {
    ...
    public static class c implements b {
        ...
        private final String f٢٧٢٩a;

        /* renamed from: b, reason: collision with root package name */
        private final HashMap f٢٧٣٠b = new HashMap();
        ...
        public Uri a(File file) {
            ...
            try {
                ...
                for (Map.Entry entry2 : this.f٢٧٣٠b.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f٢٧٢٩a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
                }
        ...
        public File b(Uri uri) {
            ...
            File file = (File) this.f٢٧٣٠b.get(decode);
            if (file != null) {
        ...
        void c(String str, File file) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    this.f٢٧٣٠b.put(str, file.getCanonicalFile());
                    return;
    ...
    private b d() {
        ...
        synchronized (this.mLock) {
            try {
                f.d(this.mAuthority, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
