            ...
            if (i10 != 0) {
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: androidx.databinding.ViewDataBindingKtx.StateFlowListener.startCollection.1.1.1
                    ...
                    public final Object emit(@Nullable Object obj2, @NotNull Continuation<? super Unit> continuation) {
                        ...
                        s sVar2;
                        s sVar3;
                        sVar = ViewDataBindingKtx.StateFlowListener.this.listener;
                        ViewDataBinding a10 = sVar.a();
                        if (a10 != null) {
                            sVar2 = ViewDataBindingKtx.StateFlowListener.this.listener;
                            int i11 = sVar2.f٣٢٢٧b;
                            sVar3 = ViewDataBindingKtx.StateFlowListener.this.listener;
                            a10.handleFieldChange(i11, sVar3.b(), 0);
                        }
