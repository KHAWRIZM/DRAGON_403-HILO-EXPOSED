...
public abstract class g {
    ...
    public static class a implements TypeEvaluator {
        ...
        public d0.b[] evaluate(float f10, d0.b[] bVarArr, d0.b[] bVarArr2) {
            if (d0.b(bVarArr, bVarArr2)) {
                if (!d0.b(this.f٤٤٠٦a, bVarArr)) {
                    this.f٤٤٠٦a = d0.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f٤٤٠٦a[i10].h(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f٤٤٠٦a;
            }
    ...
    */
    private static Animator b(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet, AnimatorSet animatorSet, int i10, float f10) {
        int i11;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        if (name.equals("set")) {
                            ...
                            TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f٤٣٨٤h);
                            b(context, resources, theme, xmlPullParser, attributeSet, animatorSet2, k.g(k10, xmlPullParser, "ordering", 0, 0), f10);
                            k10.recycle();
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        if (i10 == 2) {
            ...
            d0.b[] d10 = d0.d(string);
            d0.b[] d11 = d0.d(string2);
        ...
        if (z12) {
            if (z10) {
                if (i13 == 5) {
                    f11 = typedArray.getDimension(i11, DownloadProgress.UNKNOWN_PROGRESS);
                } else {
                    f11 = typedArray.getFloat(i11, DownloadProgress.UNKNOWN_PROGRESS);
                }
                if (z11) {
                    if (i14 == 5) {
                        f12 = typedArray.getDimension(i12, DownloadProgress.UNKNOWN_PROGRESS);
                    } else {
                        f12 = typedArray.getFloat(i12, DownloadProgress.UNKNOWN_PROGRESS);
                    }
                ...
                if (i14 == 5) {
                    f10 = typedArray.getDimension(i12, DownloadProgress.UNKNOWN_PROGRESS);
                } else {
                    f10 = typedArray.getFloat(i12, DownloadProgress.UNKNOWN_PROGRESS);
                }
            ...
            if (i13 == 5) {
                i16 = (int) typedArray.getDimension(i11, DownloadProgress.UNKNOWN_PROGRESS);
            } else if (h(i13)) {
            ...
            if (z11) {
                if (i14 == 5) {
                    i17 = (int) typedArray.getDimension(i12, DownloadProgress.UNKNOWN_PROGRESS);
                } else if (h(i14)) {
            ...
            if (i14 == 5) {
                i15 = (int) typedArray.getDimension(i12, DownloadProgress.UNKNOWN_PROGRESS);
            } else if (h(i14)) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f٤٣٨٦j);
        int i10 = 0;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f٤٣٨٣g);
        TypedArray k11 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f٤٣٨٧k);
        ...
        if (h10 > 0) {
            valueAnimator.setInterpolator(f.a(context, h10));
        }
        k10.recycle();
        if (k11 != null) {
            k11.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) {
        ...
        if (z10) {
            if (i10 != 0) {
                if (i10 != 1 && i10 != 3) {
                    ...
                    ofInt = Keyframe.ofInt(f10, k.g(k10, xmlPullParser, "value", 0, 0));
                }
            } else {
                ofInt = Keyframe.ofFloat(f10, k.f(k10, xmlPullParser, "value", 0, DownloadProgress.UNKNOWN_PROGRESS));
            }
        } else if (i10 == 0) {
        ...
        if (h10 > 0) {
            ofInt.setInterpolator(f.a(context, h10));
        }
        k10.recycle();
        return ofInt;
    }
    ...
    private static PropertyValuesHolder o(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i10) {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            if (fraction < 1.0f) {
                if (fraction < DownloadProgress.UNKNOWN_PROGRESS) {
            ...
            if (fraction2 != DownloadProgress.UNKNOWN_PROGRESS) {
                if (fraction2 < DownloadProgress.UNKNOWN_PROGRESS) {
                    keyframe.setFraction(DownloadProgress.UNKNOWN_PROGRESS);
                } else {
                    arrayList.add(0, c(keyframe, DownloadProgress.UNKNOWN_PROGRESS));
                    size++;
                }
            }
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ...
                if (keyframe3.getFraction() < DownloadProgress.UNKNOWN_PROGRESS) {
                    if (i11 == 0) {
                        keyframe3.setFraction(DownloadProgress.UNKNOWN_PROGRESS);
                    } else {
                        int i12 = size - 1;
                        if (i11 == i12) {
                            ...
                            int i13 = i11;
                            for (int i14 = i11 + 1; i14 < i12 && keyframeArr[i14].getFraction() < DownloadProgress.UNKNOWN_PROGRESS; i14++) {
                                i13 = i14;
                            }
        ...
        while (true) {
            ...
            if (eventType != 2) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray k10 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f٤٣٨٥i);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        if (i11 != null) {
            ...
            s(d0.e(i11), objectAnimator, f10 * 0.5f, i12, i13);
            return;
        }
    ...
    private static void s(Path path, ObjectAnimator objectAnimator, float f10, String str, String str2) {
        ...
        arrayList.add(Float.valueOf(DownloadProgress.UNKNOWN_PROGRESS));
