...
public abstract class Feature {
    ...
    public static final class Corner extends Feature {
        ...
        /* renamed from: roundedCenter, reason: from kotlin metadata and from toString */
        private final long center;
        private final long vertex;

        public /* synthetic */ Corner(List list, long j10, long j11, boolean z10, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        public String toString() {
            return "Corner: vertex=" + ((Object) FloatFloatPair.m١٠toStringimpl(this.vertex)) + ", center=" + ((Object) FloatFloatPair.m١٠toStringimpl(this.center)) + ", convex=" + this.convex;
        }
        ...
        public Feature transformed$graphics_shapes_release(@NotNull PointTransformer f10) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                createListBuilder.add(getCubics().get(i10).transformed(f10));
            }
            return new Corner(CollectionsKt.build(createListBuilder), PointKt.m٥٢transformedso9K2fw(this.vertex, f10), PointKt.m٥٢transformedso9K2fw(this.center, f10), this.convex, null);
        }

        public /* synthetic */ Corner(List list, long j10, long j11, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            this(list, j10, j11, (i10 & 8) != 0 ? true : z10, null);
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        private Corner(List<? extends Cubic> cubics, long j10, long j11, boolean z10) {
            super(cubics);
    ...
    @NotNull
    public abstract Feature transformed$graphics_shapes_release(@NotNull PointTransformer f10);
}
