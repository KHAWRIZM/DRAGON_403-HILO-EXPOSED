...
public class FragmentController {
    ...
    public static FragmentController createController(FragmentHostCallback<?> fragmentHostCallback) {
        return new FragmentController((FragmentHostCallback) androidx.core.util.h.h(fragmentHostCallback, "callbacks == null"));
    }
    ...
    public void dispatchMultiWindowModeChanged(boolean z10) {
        this.mHost.getFragmentManager().dispatchMultiWindowModeChanged(z10, true);
    }
    ...
    public void dispatchPictureInPictureModeChanged(boolean z10) {
        this.mHost.getFragmentManager().dispatchPictureInPictureModeChanged(z10, true);
    }
    ...
    @Deprecated
    public void restoreLoaderNonConfig(@SuppressLint({"UnknownNullness"}) SimpleArrayMap<String, androidx.loader.app.a> simpleArrayMap) {
    }
    ...
    @Deprecated
    public SimpleArrayMap<String, androidx.loader.app.a> retainLoaderNonConfig() {
        return null;
    }
