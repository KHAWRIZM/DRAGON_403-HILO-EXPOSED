...
public final class FragmentLifecycleCallbacksDispatcher {
    ...
    public final void dispatchOnFragmentActivityCreated(@NotNull Fragment f10, @Nullable Bundle savedInstanceState, boolean onlyRecursive) {
        ...
        if (parent != null) {
            ...
            parentFragmentManager.getLifecycleCallbacksDispatcher().dispatchOnFragmentActivityCreated(f10, savedInstanceState, true);
        }
    ...
    public final void dispatchOnFragmentCreated(@NotNull Fragment f10, @Nullable Bundle savedInstanceState, boolean onlyRecursive) {
        ...
        if (parent != null) {
            FragmentManager parentFragmentManager = parent.getParentFragmentManager();
            Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "parent.getParentFragmentManager()");
            parentFragmentManager.getLifecycleCallbacksDispatcher().dispatchOnFragmentCreated(f10, savedInstanceState, true);
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.lifecycleCallbacks.iterator();
        while (it.hasNext()) {
            FragmentLifecycleCallbacksHolder next = it.next();
    ...
    public final void dispatchOnFragmentPreCreated(@NotNull Fragment f10, @Nullable Bundle savedInstanceState, boolean onlyRecursive) {
        ...
        if (parent != null) {
            FragmentManager parentFragmentManager = parent.getParentFragmentManager();
            Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "parent.getParentFragmentManager()");
            parentFragmentManager.getLifecycleCallbacksDispatcher().dispatchOnFragmentPreCreated(f10, savedInstanceState, true);
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.lifecycleCallbacks.iterator();
        while (it.hasNext()) {
            FragmentLifecycleCallbacksHolder next = it.next();
    ...
    public final void dispatchOnFragmentViewCreated(@NotNull Fragment f10, @NotNull View v10, @Nullable Bundle savedInstanceState, boolean onlyRecursive) {
        ...
        if (parent != null) {
            FragmentManager parentFragmentManager = parent.getParentFragmentManager();
            Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "parent.getParentFragmentManager()");
            parentFragmentManager.getLifecycleCallbacksDispatcher().dispatchOnFragmentViewCreated(f10, v10, savedInstanceState, true);
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.lifecycleCallbacks.iterator();
        while (it.hasNext()) {
            FragmentLifecycleCallbacksHolder next = it.next();
    ...
    public final void registerFragmentLifecycleCallbacks(@NotNull FragmentManager.FragmentLifecycleCallbacks cb2, boolean recursive) {
