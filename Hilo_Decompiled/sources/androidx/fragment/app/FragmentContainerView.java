...
public final class FragmentContainerView extends FrameLayout {
    ...
    private final void addDisappearingFragmentView(View v10) {
    ...
    public WindowInsets dispatchApplyWindowInsets(@NotNull WindowInsets insets) {
        ...
        Intrinsics.checkNotNullParameter(insets, "insets");
        d2 x10 = d2.x(insets);
        Intrinsics.checkNotNullExpressionValue(x10, "toWindowInsetsCompat(insets)");
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.applyWindowInsetsListener;
        if (onApplyWindowInsetsListener != null) {
            Api20Impl api20Impl = Api20Impl.INSTANCE;
            Intrinsics.checkNotNull(onApplyWindowInsetsListener);
            c02 = d2.x(api20Impl.onApplyWindowInsets(onApplyWindowInsetsListener, this, insets));
        } else {
            c02 = d1.c0(this, x10);
        }
