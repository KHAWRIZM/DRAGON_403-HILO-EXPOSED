...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (((Float) FastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == DownloadProgress.UNKNOWN_PROGRESS) {
    ...
    private void drawHorizontalScrollbar(Canvas canvas) {
        ...
        canvas.translate(DownloadProgress.UNKNOWN_PROGRESS, i10 - i11);
        this.mHorizontalTrackDrawable.draw(canvas);
        canvas.translate(i12 - (i13 / 2), DownloadProgress.UNKNOWN_PROGRESS);
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        canvas.translate(i12, DownloadProgress.UNKNOWN_PROGRESS);
        this.mVerticalTrackDrawable.draw(canvas);
        canvas.translate(DownloadProgress.UNKNOWN_PROGRESS, i15);
        this.mVerticalThumbDrawable.draw(canvas);
    ...
    void hide(int i10) {
        ...
        valueAnimator.setFloatValues(((Float) valueAnimator.getAnimatedValue()).floatValue(), DownloadProgress.UNKNOWN_PROGRESS);
    ...
    public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1 && this.mState == 2) {
            this.mVerticalDragY = DownloadProgress.UNKNOWN_PROGRESS;
            this.mHorizontalDragX = DownloadProgress.UNKNOWN_PROGRESS;
            setState(1);
            this.mDragState = 0;
            return;
        }
