...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        if (computeScrollVectorForPosition != null && (computeScrollVectorForPosition.x != DownloadProgress.UNKNOWN_PROGRESS || computeScrollVectorForPosition.y != DownloadProgress.UNKNOWN_PROGRESS)) {
