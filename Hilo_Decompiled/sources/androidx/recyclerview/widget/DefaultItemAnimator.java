...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        MoveInfo(RecyclerView.ViewHolder viewHolder, int i10, int i11, int i12, int i13) {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(DownloadProgress.UNKNOWN_PROGRESS).setListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.4
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        ...
        viewHolder.itemView.setAlpha(DownloadProgress.UNKNOWN_PROGRESS);
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i10, int i11, int i12, int i13) {
        ...
        if (viewHolder2 != null) {
            ...
            viewHolder2.itemView.setAlpha(DownloadProgress.UNKNOWN_PROGRESS);
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(DownloadProgress.UNKNOWN_PROGRESS).setListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.7
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
        ...
        if (view2 != null) {
            ...
            animate.translationX(DownloadProgress.UNKNOWN_PROGRESS).translationY(DownloadProgress.UNKNOWN_PROGRESS).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.8
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    animate.setListener(null);
                    view2.setAlpha(1.0f);
                    view2.setTranslationX(DownloadProgress.UNKNOWN_PROGRESS);
    ...
    public void runPendingAnimations() {
        ...
        if (!isEmpty2) {
            ...
            if (!isEmpty) {
                d1.j0(arrayList.get(0).holder.itemView, runnable, getRemoveDuration());
            } else {
                runnable.run();
            }
        }
        if (!isEmpty3) {
            ...
            if (!isEmpty) {
                d1.j0(arrayList2.get(0).oldHolder.itemView, runnable2, getRemoveDuration());
            } else {
                runnable2.run();
            }
        }
        if (!isEmpty4) {
            ...
            d1.j0(arrayList3.get(0).itemView, runnable3, j10 + Math.max(j11, j12));
        }
    }
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, RecyclerView.ViewHolder viewHolder) {
        ...
        viewHolder.itemView.setAlpha(1.0f);
        viewHolder.itemView.setTranslationX(DownloadProgress.UNKNOWN_PROGRESS);
        viewHolder.itemView.setTranslationY(DownloadProgress.UNKNOWN_PROGRESS);
