...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final int findInsertIndex(int key) {
        ...
        int i12 = i11 ^ (i11 << 16);
        int i13 = i12 >>> 7;
        int i14 = i12 & io.agora.rtc.Constants.ERR_WATERMARKR_INFO;
        ...
        while (true) {
            ...
            for (long j13 = (~j12) & (j12 - ScatterMapKt.BitmaskLsb) & (-9187201950435737472L); j13 != 0; j13 &= j13 - 1) {
                int numberOfTrailingZeros = (i16 + (Long.numberOfTrailingZeros(j13) >> 3)) & i15;
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                ...
                this.growthLimit = i21 - i10;
                jArr2[i22] = (j14 & (~(255 << i23))) | (j11 << i23);
                int i24 = this._capacity;
                int i25 = ((findFirstAvailableSlot - 7) & i24) + (i24 & 7);
                int i26 = i25 >> 3;
                int i27 = (i25 & 7) << 3;
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i11 < i10) {
            if (((jArr2[i11 >> 3] >> ((i11 & 7) << 3)) & 255) < 128) {
                ...
                long j10 = i14 & io.agora.rtc.Constants.ERR_WATERMARKR_INFO;
                long[] jArr5 = this.metadata;
                int i15 = findFirstAvailableSlot >> 3;
                int i16 = (findFirstAvailableSlot & 7) << 3;
                jArr = jArr2;
                iArr = iArr2;
                jArr5[i15] = (jArr5[i15] & (~(255 << i16))) | (j10 << i16);
                int i17 = this._capacity;
                int i18 = ((findFirstAvailableSlot - 7) & i17) + (i17 & 7);
                int i19 = i18 >> 3;
                int i20 = (i18 & 7) << 3;
                jArr5[i19] = ((~(255 << i20)) & jArr5[i19]) | (j10 << i20);
                iArr3[findFirstAvailableSlot] = i12;
                jArr4[findFirstAvailableSlot] = jArr3[i11];
            } else {
                jArr = jArr2;
                iArr = iArr2;
            }
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (predicate.invoke(Integer.valueOf(this.keys[i13]), Long.valueOf(this.values[i13])).booleanValue()) {
                                removeValueAt(i13);
                            }
                        }
                        j10 >>= 8;
    ...
    public /* synthetic */ MutableIntLongMap(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
    ...
    public final long put(int key, long value, long r72) {
        int findInsertIndex = findInsertIndex(key);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
            r72 = this.values[findInsertIndex];
        }
        this.keys[findInsertIndex] = key;
        this.values[findInsertIndex] = value;
        return r72;
