...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int put(K key, int value, int r52) {
        int findIndex = findIndex(key);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        } else {
