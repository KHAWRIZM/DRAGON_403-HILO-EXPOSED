...
public final class MutableFloatList extends FloatList {
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull float[] elements) {
        ...
        if (index >= 0 && index <= (i10 = this._size)) {
            ...
            int i11 = this._size;
            if (index != i11) {
                ArraysKt.copyInto(fArr, fArr, elements.length + index, index, i11);
            }
        ...
        if (start >= 0 && start <= (i10 = this._size) && end >= 0 && end <= i10) {
            if (end >= start) {
                if (end != start) {
                    if (end < i10) {
                        float[] fArr = this.content;
                        ArraysKt.copyInto(fArr, fArr, start, end, i10);
                    }
    ...
    public final void add(@IntRange(from = 0) int index, float element) {
        ...
        if (index >= 0 && index <= (i10 = this._size)) {
            ...
            int i11 = this._size;
            if (index != i11) {
                ArraysKt.copyInto(fArr, fArr, index + 1, index, i11);
            }
            fArr[index] = element;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull FloatList elements) {
        ...
        if (index >= 0 && index <= this._size) {
            ...
            int i10 = this._size;
            if (index != i10) {
                ArraysKt.copyInto(fArr, fArr, elements._size + index, index, i10);
            }
