...
public abstract class FloatLongMap {
    ...
    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        ...
        return floatLongMap.joinToString(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (jArr[i13] != floatLongMap.get(fArr[i13])) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final long getOrElse(float key, @NotNull Function0<Long> defaultValue) {
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i14 = 0; i14 < i13; i14++) {
                        if ((255 & j10) < 128) {
                            int i15 = (i11 << 3) + i14;
                            i12 += Float.floatToIntBits(fArr[i15]) ^ c.a(jArr[i15]);
                        }
                        j10 >>= 8;
                    }
                    if (i13 != 8) {
                    ...
                    if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i17 < i16) {
                            if ((j10 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) transform.invoke(Float.valueOf(f10), Long.valueOf(j11)));
                                i14++;
                            } else {
                                jArr2 = jArr4;
                            }
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int limit, @NotNull CharSequence truncated, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> transform) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j10 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Float.valueOf(f10), Long.valueOf(j11)));
                            i11++;
                        }
                        j10 >>= 8;
                        i14++;
