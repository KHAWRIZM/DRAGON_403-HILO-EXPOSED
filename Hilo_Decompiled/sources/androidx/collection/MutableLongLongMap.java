...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i11 < i10) {
            if (((jArr3[i11 >> 3] >> ((i11 & 7) << 3)) & 255) < 128) {
                ...
                jArr = jArr3;
                jArr2 = jArr4;
                jArr8[i13] = (jArr8[i13] & (~(255 << i14))) | (j11 << i14);
                int i15 = this._capacity;
                int i16 = ((findFirstAvailableSlot - 7) & i15) + (i15 & 7);
                int i17 = i16 >> 3;
                int i18 = (i16 & 7) << 3;
                jArr8[i17] = (jArr8[i17] & (~(255 << i18))) | (j11 << i18);
                jArr6[findFirstAvailableSlot] = j10;
                jArr7[findFirstAvailableSlot] = jArr5[i11];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
            }
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (predicate.invoke(Long.valueOf(this.keys[i13]), Long.valueOf(this.values[i13])).booleanValue()) {
                                removeValueAt(i13);
                            }
                        }
                        j10 >>= 8;
    ...
    public /* synthetic */ MutableLongLongMap(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
