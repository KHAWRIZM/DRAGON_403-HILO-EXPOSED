...
public abstract class FloatIntMap {
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return floatIntMap.joinToString(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (iArr[i13] != floatIntMap.get(fArr[i13])) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, Function2 transform, int i11, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j10 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Float.valueOf(f10), Integer.valueOf(i16)));
                            i11++;
                        }
                        j10 >>= 8;
                        i14++;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull Function2<? super Float, ? super Integer, ? extends CharSequence> transform) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((j10 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Float.valueOf(f10), Integer.valueOf(i15)));
                            i11++;
                        }
                        j10 >>= 8;
                    }
