...
public abstract class IntIntMap {
    ...
    public static /* synthetic */ String joinToString$default(IntIntMap intIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        ...
        return intIntMap.joinToString(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (iArr2[i13] != intIntMap.get(iArr[i13])) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int getOrElse(int key, @NotNull Function0<Integer> defaultValue) {
                    ...
                    if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i17 < i16) {
                            if ((j10 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) transform.invoke(valueOf, Integer.valueOf(i20)));
                                i14++;
                            } else {
                                jArr2 = jArr3;
                            }
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int limit, @NotNull CharSequence truncated, @NotNull Function2<? super Integer, ? super Integer, ? extends CharSequence> transform) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j10 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Integer.valueOf(i16), Integer.valueOf(i17)));
                            i11++;
                        }
                        j10 >>= 8;
                        i14++;
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((j10 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Integer.valueOf(i15), Integer.valueOf(i16)));
                            i11++;
                        }
                        j10 >>= 8;
                    }
