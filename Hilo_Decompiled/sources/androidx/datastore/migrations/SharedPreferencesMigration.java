...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    public static final class AnonymousClass3 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t10, @Nullable Continuation<? super Boolean> continuation) {
            return ((AnonymousClass3) create(t10, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    */
    public Object shouldMigrate(T t10, @NotNull Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof SharedPreferencesMigration$shouldMigrate$1) {
            ...
            int i11 = sharedPreferencesMigration$shouldMigrate$1.label;
            if ((i11 & Integer.MIN_VALUE) != 0) {
                sharedPreferencesMigration$shouldMigrate$1.label = i11 - Integer.MIN_VALUE;
                obj = sharedPreferencesMigration$shouldMigrate$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i10 = sharedPreferencesMigration$shouldMigrate$1.label;
                boolean z10 = true;
                if (i10 == 0) {
                    if (i10 == 1) {
                    ...
                    obj = function2.invoke(t10, sharedPreferencesMigration$shouldMigrate$1);
