...
public final class OkioSerializerWrapper<T> implements OkioSerializer<T> {
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    @Nullable
    public Object writeTo(T t10, @NotNull BufferedSink bufferedSink, @NotNull Continuation<? super Unit> continuation) {
        Object writeTo = this.delegate.writeTo(t10, bufferedSink.outputStream(), continuation);
