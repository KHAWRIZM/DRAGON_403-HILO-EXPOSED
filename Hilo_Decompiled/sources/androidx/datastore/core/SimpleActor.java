...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(@Nullable Throwable th) {
                    ...
                    do {
                        Object obj = ChannelResult.m٢١٧٦getOrNullimpl(((SimpleActor) this).messageQueue.mo٢١٩٣tryReceivePtdJZtk());
                        if (obj != null) {
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo٢١٩٤trySendJP2dKIU(msg);
