...
public final class StorageConnectionKt {
    ...
    @Nullable
    public static final <T> Object writeData(@NotNull StorageConnection<T> storageConnection, T t10, @NotNull Continuation<? super Unit> continuation) {
        Object writeScope = storageConnection.writeScope(new StorageConnectionKt$writeData$2(t10, null), continuation);
