...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    public final class InitDataStore extends RunOnce {
        ...
        public InitDataStore(@NotNull DataStoreImpl dataStoreImpl, List<? extends Function2<? super InitializerApi<T>, ? super Continuation<? super Unit>, ? extends Object>> initTasksList) {
        ...
        */
        public Object doRun(@NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof DataStoreImpl$InitDataStore$doRun$1) {
                ...
                if ((i11 & Integer.MIN_VALUE) != 0) {
                    dataStoreImpl$InitDataStore$doRun$1.label = i11 - Integer.MIN_VALUE;
                    Object obj = dataStoreImpl$InitDataStore$doRun$1.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i10 = dataStoreImpl$InitDataStore$doRun$1.label;
                    if (i10 == 0) {
                        if (i10 != 1) {
                            if (i10 == 2) {
    ...
    public DataStoreImpl(@NotNull Storage<T> storage, @NotNull List<? extends Function2<? super InitializerApi<T>, ? super Continuation<? super Unit>, ? extends Object>> initTasksList, @NotNull CorruptionHandler<T> corruptionHandler, @NotNull CoroutineScope scope) {
    ...
    */
    public final Object decrementCollector(Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof DataStoreImpl$decrementCollector$1) {
                ...
                int i12 = dataStoreImpl$decrementCollector$1.label;
                if ((i12 & Integer.MIN_VALUE) != 0) {
                    dataStoreImpl$decrementCollector$1.label = i12 - Integer.MIN_VALUE;
                    Object obj = dataStoreImpl$decrementCollector$1.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i10 = dataStoreImpl$decrementCollector$1.label;
                    if (i10 == 0) {
                        if (i10 == 1) {
                        ...
                        if (mutex2.lock((Object) null, dataStoreImpl$decrementCollector$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        dataStoreImpl = this;
                        mutex = mutex2;
                    }
                    i11 = dataStoreImpl.collectorCounter - 1;
                    dataStoreImpl.collectorCounter = i11;
                    if (i11 == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final <R> Object doWithWriteFileLock(boolean z10, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
        if (z10) {
    ...
    */
    public final Object handleUpdate(Message.Update<T> update, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof DataStoreImpl$handleUpdate$1) {
            ...
            if ((i11 & Integer.MIN_VALUE) != 0) {
                dataStoreImpl$handleUpdate$1.label = i11 - Integer.MIN_VALUE;
                Object obj2 = dataStoreImpl$handleUpdate$1.result;
                coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i10 = dataStoreImpl$handleUpdate$1.label;
                boolean z10 = true;
                if (i10 == 0) {
                    if (i10 != 1) {
                        if (i10 != 2) {
                    ...
                    ResultKt.throwOnFailure(obj2);
                    update = update3;
                    obj = Result.m٥٤٤constructorimpl(obj2);
                    r92 = update;
                    CompletableDeferredKt.completeWith(r92, obj);
                    return Unit.INSTANCE;
                }
                ResultKt.throwOnFailure(obj2);
                ack = update.getAck();
                ...
                if (!(currentState instanceof ReadException)) {
                    z10 = currentState instanceof UnInitialized;
                }
                if (z10) {
        ...
        Object obj22 = dataStoreImpl$handleUpdate$1.result;
        coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        i10 = dataStoreImpl$handleUpdate$1.label;
        boolean z102 = true;
        if (i10 == 0) {
        ...
        update = update522;
        obj = Result.m٥٤٤constructorimpl(obj22);
        r92 = update;
        CompletableDeferredKt.completeWith(r92, obj);
        return Unit.INSTANCE;
    }
    ...
    public final Object incrementCollector(Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof DataStoreImpl$incrementCollector$1) {
                ...
                int i12 = dataStoreImpl$incrementCollector$1.label;
                if ((i12 & Integer.MIN_VALUE) != 0) {
                    dataStoreImpl$incrementCollector$1.label = i12 - Integer.MIN_VALUE;
                    Object obj = dataStoreImpl$incrementCollector$1.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i10 = dataStoreImpl$incrementCollector$1.label;
                    if (i10 == 0) {
                        if (i10 == 1) {
                        ...
                        if (mutex2.lock((Object) null, dataStoreImpl$incrementCollector$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        dataStoreImpl = this;
                        mutex = mutex2;
    ...
    */
    public final Object readAndInitOrPropagateAndThrowFailure(Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1) {
                ...
                if ((i12 & Integer.MIN_VALUE) != 0) {
                    dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.label = i12 - Integer.MIN_VALUE;
                    Object obj = dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.result;
                    coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i10 = dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.label;
                    if (i10 == 0) {
                        if (i10 != 1) {
                            if (i10 == 2) {
                                i11 = dataStoreImpl$readAndInitOrPropagateAndThrowFailure$1.I$0;
                                ...
                                try {
                                    ...
                                    th = th2;
                                    dataStoreImpl2.inMemoryCache.tryUpdate(new ReadException(th, i11));
                                    throw th;
                                }
                            }
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object readDataAndUpdateCache(boolean z10, Continuation<? super State<T>> continuation) {
        ...
        if (continuation instanceof DataStoreImpl$readDataAndUpdateCache$1) {
            ...
            int i12 = dataStoreImpl$readDataAndUpdateCache$1.label;
            if ((i12 & Integer.MIN_VALUE) != 0) {
                dataStoreImpl$readDataAndUpdateCache$1.label = i12 - Integer.MIN_VALUE;
                Object obj2 = dataStoreImpl$readDataAndUpdateCache$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i10 = dataStoreImpl$readDataAndUpdateCache$1.label;
                if (i10 == 0) {
                    if (i10 != 1) {
                        if (i10 != 2) {
                            if (i10 == 3) {
                    ...
                    boolean z13 = dataStoreImpl$readDataAndUpdateCache$1.Z$0;
                ...
                z12 = state instanceof Data;
                if (!z12) {
                    i11 = state.getVersion();
                } else {
                    i11 = -1;
                }
                if (!z12 && intValue == i11) {
                ...
                DataStoreImpl$readDataAndUpdateCache$4 dataStoreImpl$readDataAndUpdateCache$4 = new DataStoreImpl$readDataAndUpdateCache$4(dataStoreImpl, i11, null);
                dataStoreImpl$readDataAndUpdateCache$1.L$0 = dataStoreImpl;
                dataStoreImpl$readDataAndUpdateCache$1.L$1 = null;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object readDataOrHandleCorruption(boolean z10, Continuation<? super Data<T>> continuation) {
            ...
            if ((i11 & Integer.MIN_VALUE) != 0) {
                ...
                switch (r22) {
                    case 0:
                        ...
                        try {
                            if (z10) {
                                ...
                                if (obj2 == null) {
                                    try {
                                        ...
                                        try {
                                            ...
                                            if (dataStoreImpl.doWithWriteFileLock(z10, dataStoreImpl$readDataOrHandleCorruption$3, dataStoreImpl$readDataOrHandleCorruption$1) != coroutine_suspended) {
                                            }
                                        } catch (Throwable th) {
                                            th = th;
                                ...
                                obj = obj2;
                                obj2 = (T) version;
                                return new Data(obj, i10, ((Number) obj2).intValue());
                            }
                    ...
                    case 2:
                        ...
                        z11 = dataStoreImpl$readDataOrHandleCorruption$1.Z$0;
                    ...
                    case 5:
                        ...
                        return new Data(t10, i12, intRef.element);
                    case 6:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final Object readState(boolean z10, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new DataStoreImpl$readState$2(this, z10, null), continuation);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object writeData$datastore_core_release(T t10, boolean z10, @NotNull Continuation<? super Integer> continuation) {
        ...
        if (continuation instanceof DataStoreImpl$writeData$1) {
            ...
            if ((i11 & Integer.MIN_VALUE) != 0) {
                dataStoreImpl$writeData$1.label = i11 - Integer.MIN_VALUE;
                Object obj = dataStoreImpl$writeData$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                i10 = dataStoreImpl$writeData$1.label;
                if (i10 == 0) {
                    if (i10 == 1) {
                    ...
                    DataStoreImpl$writeData$2 dataStoreImpl$writeData$2 = new DataStoreImpl$writeData$2(intRef2, this, t10, z10, null);
    ...
    public /* synthetic */ DataStoreImpl(Storage storage, List list, CorruptionHandler corruptionHandler, CoroutineScope coroutineScope, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(storage, (i10 & 2) != 0 ? CollectionsKt.emptyList() : list, (i10 & 4) != 0 ? new NoOpCorruptionHandler() : corruptionHandler, (i10 & 8) != 0 ? CoroutineScopeKt.CoroutineScope(Actual_jvmKt.ioDispatcher().plus(SupervisorKt.SupervisorJob$default((Job) null, 1, (Object) null))) : coroutineScope);
    }
}
