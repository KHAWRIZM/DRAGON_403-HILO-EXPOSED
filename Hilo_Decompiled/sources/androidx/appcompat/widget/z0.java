...
public class z0 extends i0 {
    ...
    private static boolean f١٧٠٩c;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference f١٧١٠b;

    public z0(Context context, Resources resources) {
        super(resources);
        this.f١٧١٠b = new WeakReference(context);
    }
    ...
    @Override // androidx.appcompat.widget.i0, android.content.res.Resources
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f١٧١٠b.get();
        if (context != null) {
            return h0.h().t(context, this, i10);
        }
        return a(i10);
    }
