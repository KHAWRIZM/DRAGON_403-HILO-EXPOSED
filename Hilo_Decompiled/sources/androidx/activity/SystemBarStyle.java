...
public final class SystemBarStyle {
    ...
    public static final class Companion {
        ...
        @JvmOverloads
        @NotNull
        public final SystemBarStyle auto(int i10, int i11) {
        ...
        @JvmOverloads
        @NotNull
        public final SystemBarStyle auto(int lightScrim, int darkScrim, @NotNull Function1<? super Resources, Boolean> detectDarkMode) {
    ...
    @JvmOverloads
    @NotNull
    public static final SystemBarStyle auto(int i10, int i11) {
        return INSTANCE.auto(i10, i11);
    }

    @JvmStatic
    @NotNull
    public static final SystemBarStyle dark(int i10) {
        return INSTANCE.dark(i10);
    }

    @JvmStatic
    @NotNull
    public static final SystemBarStyle light(int i10, int i11) {
        return INSTANCE.light(i10, i11);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final SystemBarStyle auto(int i10, int i11, @NotNull Function1<? super Resources, Boolean> function1) {
        return INSTANCE.auto(i10, i11, function1);
    }
}
