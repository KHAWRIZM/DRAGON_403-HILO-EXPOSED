...
public abstract class ParcelableSerializer<T extends Parcelable> implements KSerializer<T> {
    ...
    public final T m٢٢٢deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        if (decoder instanceof SavedStateDecoder) {
            SavedStateDecoder savedStateDecoder = (SavedStateDecoder) decoder;
            T t10 = (T) SavedStateReader.m١٣٤getParcelableimpl(SavedStateReader.m٨٨constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m١٩٨putParcelableimpl(SavedStateWriter.m١٧٤constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
