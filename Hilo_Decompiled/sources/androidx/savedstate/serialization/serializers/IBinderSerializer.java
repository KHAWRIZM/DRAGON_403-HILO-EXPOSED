...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public IBinder m٢١٧deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        if (decoder instanceof SavedStateDecoder) {
            SavedStateDecoder savedStateDecoder = (SavedStateDecoder) decoder;
            return SavedStateReader.m٩٥getBinderimpl(SavedStateReader.m٨٨constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull IBinder value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        if (encoder instanceof SavedStateEncoder) {
            SavedStateEncoder savedStateEncoder = (SavedStateEncoder) encoder;
            SavedStateWriter.m١٧٩putBinderimpl(SavedStateWriter.m١٧٤constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
