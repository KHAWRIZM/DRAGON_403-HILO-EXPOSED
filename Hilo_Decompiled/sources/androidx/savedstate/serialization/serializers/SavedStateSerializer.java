...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public Bundle m٢٢٣deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m١٤٥getSavedStateimpl(SavedStateReader.m٨٨constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull Bundle value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            if (Intrinsics.areEqual(savedStateEncoder.getKey(), "")) {
                SavedStateWriter.m١٧٨putAllimpl(SavedStateWriter.m١٧٤constructorimpl(savedStateEncoder.getSavedState()), value);
                return;
            } else {
                SavedStateWriter.m٢٠١putSavedStateimpl(SavedStateWriter.m١٧٤constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
                return;
            }
        }
