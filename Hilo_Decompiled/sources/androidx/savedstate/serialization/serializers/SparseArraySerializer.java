...
public final class SparseArraySerializer<T> implements KSerializer<SparseArray<T>> {
    ...
    public static final class SparseArraySurrogate<T> {
        ...
        @JvmField
        @NotNull
        private static final Lazy<KSerializer<Object>>[] $childSerializers = {LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: androidx.savedstate.serialization.serializers.a
        ...
        public /* synthetic */ SparseArraySurrogate(int i10, List list, List list2, SerializationConstructorMarker serializationConstructorMarker) {
            if (3 != (i10 & 3)) {
    ...
    public SparseArray<T> m٢٢٦deserialize(@NotNull Decoder decoder) {
