...
public final class DBUtil__DBUtil_androidKt$performInTransactionSuspending$3<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public DBUtil__DBUtil_androidKt$performInTransactionSuspending$3(RoomDatabase roomDatabase, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super DBUtil__DBUtil_androidKt$performInTransactionSuspending$3> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
        return ((DBUtil__DBUtil_androidKt$performInTransactionSuspending$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
