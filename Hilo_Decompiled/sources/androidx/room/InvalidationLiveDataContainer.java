...
public final class InvalidationLiveDataContainer {
    ...
    @NotNull
    public final <T> LiveData<T> create(@NotNull String[] tableNames, boolean inTransaction, @NotNull Callable<T> callableFunction) {
    ...
    @NotNull
    public final <T> LiveData<T> create(@NotNull String[] tableNames, boolean inTransaction, @NotNull Function1<? super SQLiteConnection, ? extends T> lambdaFunction) {
        Intrinsics.checkNotNullParameter(tableNames, "tableNames");
