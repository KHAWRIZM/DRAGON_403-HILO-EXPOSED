...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb2.append(", ");
                sb2.append(Utils.typeToString(this.typeArguments[i]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static ResponseBody buffer(ResponseBody responseBody) throws IOException {
        ...
        return ResponseBody.create(responseBody.get$contentType(), responseBody.get$contentLength(), (BufferedSource) buffer);
    }
