    ...
    public static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof GET) {
                parseHttpMethodAndPath(SpdyRequest.GET_METHOD, ((GET) annotation).value(), false);
                return;
            }
            ...
            if (annotation instanceof POST) {
                parseHttpMethodAndPath(SpdyRequest.POST_METHOD, ((POST) annotation).value(), true);
                return;
            }
                ...
                if (this.isMultipart) {
                    ...
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
                            ...
                            if (!MultipartBody.Part.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                return new ParameterHandler.Part(this.method, i, of2, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                            }
                    ...
                    if (rawType8.isArray()) {
                        ...
                        if (!MultipartBody.Part.class.isAssignableFrom(boxIfPrimitive)) {
                            return new ParameterHandler.Part(this.method, i, of2, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                        }
                        throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
                    if (!MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                        return new ParameterHandler.Part(this.method, i, of2, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    }
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
