...
public final class C٠٢٧٧SegmentedByteString extends ByteString {
    ...
    public C٠٢٧٧SegmentedByteString(@NotNull byte[][] segments, @NotNull int[] directory) {
    ...
    public boolean rangeEquals(int offset, @NotNull ByteString other, int otherOffset, int byteCount) {
        ...
        while (offset < i10) {
            ...
            if (!other.rangeEquals(otherOffset, getSegments()[segment], i13 + (offset - i11), min)) {
                return false;
            }
            otherOffset += min;
            offset += min;
    ...
    public boolean rangeEquals(int offset, @NotNull byte[] other, int otherOffset, int byteCount) {
        ...
        while (offset < i10) {
            ...
            int i13 = getDirectory()[getSegments().length + segment];
            int min = Math.min(i10, i12 + i11) - offset;
            if (!SegmentedByteString.arrayRangeEquals(getSegments()[segment], i13 + (offset - i11), other, otherOffset, min)) {
                return false;
            }
            otherOffset += min;
            offset += min;
