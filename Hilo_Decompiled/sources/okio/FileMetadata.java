...
public final class FileMetadata {
    ...
    public static /* synthetic */ FileMetadata copy$default(FileMetadata fileMetadata, boolean z10, boolean z11, Path path, Long l10, Long l11, Long l12, Long l13, Map map, int i10, Object obj) {
        ...
        if ((i10 & 8) != 0) {
            l14 = fileMetadata.size;
        } else {
            l14 = l10;
        }
        if ((i10 & 16) != 0) {
            l15 = fileMetadata.createdAtMillis;
        } else {
            l15 = l11;
        }
        if ((i10 & 32) != 0) {
            l16 = fileMetadata.lastModifiedAtMillis;
        } else {
            l16 = l12;
        }
        if ((i10 & 64) != 0) {
            l17 = fileMetadata.lastAccessedAtMillis;
        } else {
            l17 = l13;
        }
        if ((i10 & 128) != 0) {
        ...
        return fileMetadata.copy(z12, z13, path2, l14, l15, l16, l17, map2);
    }
