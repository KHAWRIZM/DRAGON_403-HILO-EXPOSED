...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m٢٢٢٦write$default(FileSystem fileSystem, Path file, boolean z10, Function1 writerAction, int i10, Object obj) throws IOException {
        Object obj2;
        if (obj == null) {
            if ((i10 & 2) != 0) {
                z10 = false;
    ...
    public final <T> T m٢٢٢٧read(@NotNull Path file, @NotNull Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        T t10;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m٢٢٢٨write(@NotNull Path file, boolean mustCreate, @NotNull Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        T t10;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
