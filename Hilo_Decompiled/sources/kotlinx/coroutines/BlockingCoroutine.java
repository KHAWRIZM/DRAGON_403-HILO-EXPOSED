        ...
        try {
            ...
            while (!Thread.interrupted()) {
                try {
                    ...
                    if (eventLoop2 != null) {
                        j10 = eventLoop2.processNextEvent();
                    } else {
                    ...
                    if (!isCompleted()) {
                        ...
                        if (abstractTimeSource2 != null) {
                            abstractTimeSource2.parkNanos(this, j10);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
                        ...
                        if (t10 instanceof CompletedExceptionally) {
                            completedExceptionally = (CompletedExceptionally) t10;
                        }
