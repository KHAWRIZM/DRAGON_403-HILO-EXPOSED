...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public String toString() {
        return super/*kotlinx.coroutines.CoroutineDispatcher*/.toString() + "[scheduler = " + this.coroutineScheduler + ']';
    }
