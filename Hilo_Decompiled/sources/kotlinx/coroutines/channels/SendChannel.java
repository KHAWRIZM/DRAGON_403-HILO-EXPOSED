...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e10) {
            Object obj = sendChannel.mo٢١٩٤trySendJP2dKIU(e10);
    ...
    @Nullable
    Object send(E e10, @NotNull Continuation<? super Unit> continuation);

    @NotNull
    /* renamed from: trySend-JP2dKIU, reason: contains not printable characters */
    Object mo٢١٩٤trySendJP2dKIU(E element);
}
