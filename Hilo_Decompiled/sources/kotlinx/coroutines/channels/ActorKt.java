...
public final class ActorKt {
    ...
    public static final <E> SendChannel<E> actor(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineContext coroutineContext, int i10, @NotNull CoroutineStart coroutineStart, @Nullable Function1<? super Throwable, Unit> function1, @NotNull Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        if (function1 != null) {
            ((JobSupport) actorCoroutine).invokeOnCompletion(function1);
        }
        ((AbstractCoroutine) actorCoroutine).start(coroutineStart, actorCoroutine, function2);
        return (SendChannel<E>) actorCoroutine;
    }
