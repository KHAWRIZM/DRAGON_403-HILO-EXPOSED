...
public final class ChannelKt {
    @NotNull
    public static final <E> Channel<E> Channel(int i10, @NotNull BufferOverflow bufferOverflow, @Nullable Function1<? super E, Unit> function1) {
    ...
    public static final <T> T m٢١٦٧getOrElseWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, ? extends T> function1) {
        if (obj instanceof ChannelResult.Failed) {
            return function1.invoke(ChannelResult.m٢١٧٥exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m٢١٦٨onClosedWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m٢١٧٥exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m٢١٦٩onFailureWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m٢١٧٥exceptionOrNullimpl(obj));
        }
        return obj;
    ...
    public static final <T> Object m٢١٧٠onSuccessWpGqRn0(@NotNull Object obj, @NotNull Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
