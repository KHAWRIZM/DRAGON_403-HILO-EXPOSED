...
public interface ChildJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(@NotNull ChildJob childJob, R r10, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) Job.DefaultImpls.fold(childJob, r10, function2);
        }
