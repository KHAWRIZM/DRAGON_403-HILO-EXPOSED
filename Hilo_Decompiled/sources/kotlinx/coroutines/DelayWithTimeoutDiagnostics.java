...
public interface DelayWithTimeoutDiagnostics extends Delay {
    ...
    public static final class DefaultImpls {
        ...
        @Nullable
        public static Object delay(@NotNull DelayWithTimeoutDiagnostics delayWithTimeoutDiagnostics, long j10, @NotNull Continuation<? super Unit> continuation) {
        ...
        @NotNull
        public static DisposableHandle invokeOnTimeout(@NotNull DelayWithTimeoutDiagnostics delayWithTimeoutDiagnostics, long j10, @NotNull Runnable runnable, @NotNull CoroutineContext coroutineContext) {
    ...
    String m٢١٤٦timeoutMessageLRDsOJo(long timeout);
}
