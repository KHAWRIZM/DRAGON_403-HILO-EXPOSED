        ...
        try {
            ...
            while (true) {
                ...
                if (processNextEvent == LongCompanionObject.MAX_VALUE) {
                    ...
                    processNextEvent = RangesKt.coerceAtMost(processNextEvent, j11);
                } else {
                    j10 = Long.MAX_VALUE;
                }
