...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(@NotNull LockFreeLinkedListNode affected, @Nullable Object failure) {
            ...
            if (lockFreeLinkedListNode != null && b.a(LockFreeLinkedListNode.access$get_next$volatile$FU(), affected, this, lockFreeLinkedListNode) && z) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x004c, code lost:
        ...
        if (androidx.concurrent.futures.b.a(kotlinx.coroutines.internal.LockFreeLinkedListNode._next$volatile$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L٢٦;
     */
    /*
    ...
    */
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (obj == this) {
                        ...
                        if (b.a(_prev$volatile$FU, this, lockFreeLinkedListNode, lockFreeLinkedListNode2)) {
                            return lockFreeLinkedListNode2;
                        }
                    } else {
                        if (isRemoved()) {
    ...
    public final void finishAdd(LockFreeLinkedListNode next) {
        ...
        } while (!b.a(_prev$volatile$FU, next, lockFreeLinkedListNode, this));
        if (isRemoved()) {
    ...
    public final boolean addNext(@NotNull LockFreeLinkedListNode node, @NotNull LockFreeLinkedListNode next) {
        ...
        if (!b.a(_next$volatile$FU, this, next, node)) {
            return false;
        }
        node.finishAdd(next);
        return true;
    ...
    public final boolean addOneIfEmpty(@NotNull LockFreeLinkedListNode node) {
        ...
        while (getNext() == this) {
            if (b.a(_next$volatile$FU, this, this, node)) {
                node.finishAdd(this);
                return true;
            }
        }
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!b.a(_next$volatile$FU, this, next, lockFreeLinkedListNode.removed()));
    ...
    public String toString() {
        return new PropertyReference0Impl(this) { // from class: kotlinx.coroutines.internal.LockFreeLinkedListNode$toString$1
            @Nullable
            public Object get() {
                return DebugStringsKt.getClassSimpleName(((CallableReference) this).receiver);
            }
    ...
    public final int tryCondAddNext(@NotNull LockFreeLinkedListNode node, @NotNull LockFreeLinkedListNode next, @NotNull CondAddOp condAdd) {
        ...
        if (!b.a(_next$volatile$FU, this, next, condAdd)) {
            return 0;
        }
