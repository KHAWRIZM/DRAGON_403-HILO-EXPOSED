...
public final class TimeoutCoroutine<U, T extends U> extends ScopeCoroutine<T> implements Runnable {
    ...
    public TimeoutCoroutine(long j10, @NotNull Continuation<? super U> continuation) {
    ...
    public String nameString$kotlinx_coroutines_core() {
        return super/*kotlinx.coroutines.AbstractCoroutine*/.nameString$kotlinx_coroutines_core() + "(timeMillis=" + this.time + ')';
    }
