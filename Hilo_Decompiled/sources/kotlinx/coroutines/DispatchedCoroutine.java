...
public final class DispatchedCoroutine<T> extends ScopeCoroutine<T> {
    ...
    protected void afterResume(@Nullable Object state) {
        ...
        DispatchedContinuationKt.resumeCancellableWith$default(IntrinsicsKt.intercepted(((ScopeCoroutine) this).uCont), CompletionStateKt.recoverResult(state, ((ScopeCoroutine) this).uCont), (Function1) null, 2, (Object) null);
    }
