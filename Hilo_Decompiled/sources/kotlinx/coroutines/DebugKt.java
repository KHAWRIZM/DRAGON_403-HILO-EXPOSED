...
public final class DebugKt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0037, code lost:
        ...
        if (r0.equals(kotlinx.coroutines.DebugKt.DEBUG_PROPERTY_VALUE_ON) != false) goto L٢٣;
     */
    ...
    static {
        ...
        if (systemProp != null) {
            ...
            DEBUG = z10;
            if (z10 || !SystemPropsKt.systemProp(STACKTRACE_RECOVERY_PROPERTY_NAME, true)) {
                z11 = false;
            }
            RECOVER_STACK_TRACES = z11;
    ...
    private static final void m٢١٤٣assert(Function0<Boolean> function0) {
    }
