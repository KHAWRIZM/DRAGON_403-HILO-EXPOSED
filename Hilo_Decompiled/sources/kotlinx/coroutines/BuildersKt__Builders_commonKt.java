...
public final /* synthetic */ class BuildersKt__Builders_commonKt {
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [kotlin.coroutines.Continuation, kotlinx.coroutines.DispatchedCoroutine, java.lang.Object] */
    @Nullable
    public static final <T> Object withContext(@NotNull CoroutineContext coroutineContext, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        ...
        if (newCoroutineContext == coroutineContext2) {
            ...
            if (Intrinsics.areEqual(newCoroutineContext.get(companion), coroutineContext2.get(companion))) {
                ScopeCoroutine undispatchedCoroutine = new UndispatchedCoroutine(newCoroutineContext, continuation);
                CoroutineContext coroutineContext3 = undispatchedCoroutine.get$context();
                Object updateThreadContext = ThreadContextKt.updateThreadContext(coroutineContext3, (Object) null);
                try {
                ...
                ?? dispatchedCoroutine = new DispatchedCoroutine(newCoroutineContext, continuation);
                CancellableKt.startCoroutineCancellable$default(function2, (Object) dispatchedCoroutine, (Continuation) dispatchedCoroutine, (Function1) null, 4, (Object) null);
