...
public abstract class AbstractTimeSource {
    ...
    public abstract void parkNanos(@NotNull Object blocker, long nanos);
    ...
    @NotNull
    public abstract Runnable wrapTask(@NotNull Runnable block);
}
