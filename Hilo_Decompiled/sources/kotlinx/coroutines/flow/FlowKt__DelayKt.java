...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> debounce(@NotNull Flow<? extends T> flow, final long j) {
        if (j >= 0) {
            return j == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$2
                ...
                public /* bridge */ /* synthetic */ Object m١٩٨invoke(Object obj) {
    ...
    public static final <T> Flow<T> m١٩٤debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.toDelayMillis-LRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(@NotNull Flow<? extends T> flow, @NotNull final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            /* JADX WARN: Multi-variable type inference failed */
            /* renamed from: invoke, reason: collision with other method in class */
            public /* bridge */ /* synthetic */ Object m١٩٩invoke(Object obj) {
                return invoke((FlowKt__DelayKt$debounce$3<T>) obj);
            }

            @NotNull
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.toDelayMillis-LRDsOJo(((Duration) function1.invoke(t)).unbox-impl()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(@NotNull CoroutineScope coroutineScope, long j) {
        return ProduceKt.produce$default(coroutineScope, (CoroutineContext) null, 0, new FlowKt__DelayKt$fixedPeriodTicker$1(j, null), 1, (Object) null);
    }
    ...
    public static final <T> Flow<T> m١٩٥sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.toDelayMillis-LRDsOJo(j));
    }

    @FlowPreview
    @NotNull
    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m١٩٦timeoutHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return m١٩٧timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m١٩٧timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
