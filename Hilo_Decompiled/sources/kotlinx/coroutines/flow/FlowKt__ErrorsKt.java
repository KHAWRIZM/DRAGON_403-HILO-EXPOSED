...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> m٢٠٤catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        if (continuation instanceof FlowKt__ErrorsKt$catchImpl$1) {
            ...
            if ((i2 & Integer.MIN_VALUE) != 0) {
                ...
                if (i == 0) {
                    ...
                    try {
                        FlowKt__ErrorsKt$catchImpl$2 flowKt__ErrorsKt$catchImpl$2 = new FlowKt__ErrorsKt$catchImpl$2(flowCollector, objectRef2);
