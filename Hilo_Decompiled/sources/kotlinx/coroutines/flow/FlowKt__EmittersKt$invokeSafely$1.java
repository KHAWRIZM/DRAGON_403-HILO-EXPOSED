...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__EmittersKt", f = "Emitters.kt", i = {0}, l = {RoomEvent.ROOM_INVITE_USER_UP_MIC}, m = "invokeSafely$FlowKt__EmittersKt", n = {"cause"}, s = {"L$0"})
