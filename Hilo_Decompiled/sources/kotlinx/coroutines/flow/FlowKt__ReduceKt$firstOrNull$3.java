...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {UserProxyUtility.notification}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
