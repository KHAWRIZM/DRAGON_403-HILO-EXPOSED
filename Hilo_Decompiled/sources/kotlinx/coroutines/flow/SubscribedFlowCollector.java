        ...
        try {
            if (continuation instanceof SubscribedFlowCollector$onSubscription$1) {
                ...
                if ((i & Integer.MIN_VALUE) != 0) {
                    ...
                    safeCollector = subscribedFlowCollector$onSubscription$1.label;
                    if (safeCollector == 0) {
                        if (safeCollector != 1) {
                            if (safeCollector == 2) {
                        ...
                        safeCollector2 = (SafeCollector) subscribedFlowCollector$onSubscription$1.L$1;
                        subscribedFlowCollector = (SubscribedFlowCollector) subscribedFlowCollector$onSubscription$1.L$0;
                        ResultKt.throwOnFailure(obj);
                    } else {
                        ResultKt.throwOnFailure(obj);
                        safeCollector2 = new SafeCollector(this.collector, subscribedFlowCollector$onSubscription$1.getContext());
                    ...
                    safeCollector = flowCollector instanceof SubscribedFlowCollector;
                    if (safeCollector == 0) {
            ...
            safeCollector = flowCollector2 instanceof SubscribedFlowCollector;
            if (safeCollector == 0) {
            }
        } catch (Throwable th) {
