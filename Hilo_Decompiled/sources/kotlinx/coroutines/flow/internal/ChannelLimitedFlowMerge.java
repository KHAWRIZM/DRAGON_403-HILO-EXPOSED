...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        while (it.hasNext()) {
            BuildersKt.launch$default(producerScope, (CoroutineContext) null, (CoroutineStart) null, new ChannelLimitedFlowMerge$collectTo$2$1(it.next(), sendingCollector, null), 3, (Object) null);
        }
