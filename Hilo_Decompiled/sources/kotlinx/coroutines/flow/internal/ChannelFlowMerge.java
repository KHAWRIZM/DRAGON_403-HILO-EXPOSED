...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        Semaphore Semaphore$default = SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null);
        SendingCollector sendingCollector = new SendingCollector(producerScope);
        Object collect = this.flow.collect(new ChannelFlowMerge$collectTo$2(continuation.getContext().get(Job.Key), Semaphore$default, producerScope, sendingCollector), continuation);
