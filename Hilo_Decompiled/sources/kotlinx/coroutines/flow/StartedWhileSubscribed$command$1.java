...
@DebugMetadata(c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", f = "SharingStarted.kt", i = {1, 2, 3}, l = {174, UserProxyUtility.foodieHot, UserProxyUtility.rocketBanner, UserProxyUtility.notification, UserProxyUtility.hiloGameBetRank}, m = "invokeSuspend", n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, s = {"L$0", "L$0", "L$0"})
