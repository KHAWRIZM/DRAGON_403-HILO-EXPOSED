...
public final class DispatchedTaskKt {
    ...
    public static final <T> void dispatch(@NotNull DispatchedTask<? super T> dispatchedTask, int i10) {
        boolean z10;
        DispatchedContinuation delegate$kotlinx_coroutines_core = dispatchedTask.getDelegate$kotlinx_coroutines_core();
        if (i10 == 4) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (!z10 && (delegate$kotlinx_coroutines_core instanceof DispatchedContinuation) && isCancellableMode(i10) == isCancellableMode(dispatchedTask.resumeMode)) {
            CoroutineDispatcher coroutineDispatcher = delegate$kotlinx_coroutines_core.dispatcher;
    ...
    public static final <T> void resume(@NotNull DispatchedTask<? super T> dispatchedTask, @NotNull Continuation<? super T> continuation, boolean z10) {
        ...
        Object obj = Result.m٥٤٤constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z10) {
    ...
    public static final void resumeWithStackTrace(@NotNull Continuation<?> continuation, @NotNull Throwable th) {
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m٥٤٤constructorimpl(ResultKt.createFailure(th)));
    }
