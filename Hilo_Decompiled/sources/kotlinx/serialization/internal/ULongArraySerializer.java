...
public final class ULongArraySerializer extends PrimitiveArraySerializer<ULong, ULongArray, ULongArrayBuilder> implements KSerializer<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m٢٧٩collectionSizeQwZRm1k(((ULongArray) obj).unbox-impl());
    }

    /* renamed from: collectionSize-QwZRm1k, reason: not valid java name */
    protected int m٢٧٩collectionSizeQwZRm1k(@NotNull long[] jArr) {
    ...
    public /* bridge */ /* synthetic */ ULongArray empty() {
        return ULongArray.box-impl(m٢٨٠emptyY2RjT0g());
    }

    @NotNull
    /* renamed from: empty-Y2RjT0g, reason: not valid java name */
    protected long[] m٢٨٠emptyY2RjT0g() {
        return ULongArray.constructor-impl(0);
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m٢٨١toBuilderQwZRm1k(((ULongArray) obj).unbox-impl());
    }

    @NotNull
    /* renamed from: toBuilder-QwZRm1k, reason: not valid java name */
    protected ULongArrayBuilder m٢٨١toBuilderQwZRm1k(@NotNull long[] jArr) {
    ...
    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, ULongArray uLongArray, int i) {
        m٢٨٢writeContent0q3Fkuo(compositeEncoder, uLongArray.unbox-impl(), i);
    }

    /* renamed from: writeContent-0q3Fkuo, reason: not valid java name */
    protected void m٢٨٢writeContent0q3Fkuo(@NotNull CompositeEncoder encoder, @NotNull long[] content, int size) {
    ...
    public void readElement(@NotNull CompositeDecoder decoder, int index, @NotNull ULongArrayBuilder builder, boolean checkIndex) {
        ...
        builder.m٢٧٧appendVKZWuLQ$kotlinx_serialization_core(ULong.constructor-impl(decoder.decodeInlineElement(getDescriptor(), index).decodeLong()));
    }
}
