...
public abstract class PrimitiveArraySerializer<Element, Array, Builder extends PrimitiveArrayBuilder<Array>> extends CollectionLikeSerializer<Element, Array, Builder> {
    ...
    protected abstract void readElement(@NotNull CompositeDecoder decoder, int index, @NotNull Builder builder, boolean checkIndex);
    ...
    protected abstract void writeContent(@NotNull CompositeEncoder encoder, Array content, int size);
