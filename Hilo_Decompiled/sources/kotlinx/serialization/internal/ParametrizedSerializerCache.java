...
public interface ParametrizedSerializerCache<T> {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object m٢٦٠getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    list = CollectionsKt.emptyList();
                }
                return parametrizedSerializerCache.mo٢٥٩getgIAlus(kClass, list);
            }
    ...
    Object mo٢٥٩getgIAlus(@NotNull KClass<Object> key, @NotNull List<? extends KType> types);
}
