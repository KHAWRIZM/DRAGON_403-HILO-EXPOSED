...
public final class ULongArrayBuilder extends PrimitiveArrayBuilder<ULongArray> {
    ...
    public final void m٢٧٧appendVKZWuLQ$kotlinx_serialization_core(long c) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        long[] jArr = this.buffer;
        int position = getPosition();
        this.position = position + 1;
        ULongArray.set-k8EXiF4(jArr, position, c);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ ULongArray build$kotlinx_serialization_core() {
        return ULongArray.box-impl(m٢٧٨buildY2RjT0g$kotlinx_serialization_core());
    }

    @NotNull
    /* renamed from: build-Y2RjT0g$kotlinx_serialization_core, reason: not valid java name */
    public long[] m٢٧٨buildY2RjT0g$kotlinx_serialization_core() {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (ULongArray.getSize-impl(this.buffer) < requiredCapacity) {
            long[] jArr = this.buffer;
            long[] copyOf = Arrays.copyOf(jArr, RangesKt.coerceAtLeast(requiredCapacity, ULongArray.getSize-impl(jArr) * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
            this.buffer = ULongArray.constructor-impl(copyOf);
        }
    }
    ...
    private ULongArrayBuilder(long[] jArr) {
        ...
        this.buffer = jArr;
        this.position = ULongArray.getSize-impl(jArr);
