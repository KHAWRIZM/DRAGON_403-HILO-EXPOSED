...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.box-impl(m٢٧٥deserializeOGnWXxg(decoder));
    }

    /* renamed from: deserialize-OGnWXxg, reason: not valid java name */
    public int m٢٧٥deserializeOGnWXxg(@NotNull Decoder decoder) {
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m٢٧٦serializeQn1smSk(encoder, ((UInt) obj).unbox-impl());
    }

    /* renamed from: serialize-Qn1smSk, reason: not valid java name */
    public void m٢٧٦serializeQn1smSk(@NotNull Encoder encoder, int value) {
