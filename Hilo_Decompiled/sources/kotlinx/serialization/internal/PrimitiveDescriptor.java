...
public final class PrimitiveDescriptor implements SerialDescriptor {
    ...
    public PrimitiveDescriptor(@NotNull String str, @NotNull PrimitiveKind primitiveKind) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (Intrinsics.areEqual(getSerialName(), primitiveDescriptor.getSerialName()) && Intrinsics.areEqual(getKind(), primitiveDescriptor.getKind())) {
            return true;
        }
        return false;
    }
