...
public final class SerialDescriptorImpl implements SerialDescriptor, CachedNames {
    ...
    public SerialDescriptorImpl(@NotNull String str, @NotNull SerialKind serialKind, int i, @NotNull List<? extends SerialDescriptor> list, @NotNull ClassSerialDescriptorBuilder classSerialDescriptorBuilder) {
        ...
        this._hashCode = LazyKt.lazy(new Function0() { // from class: kotlinx.serialization.descriptors.a
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(RangesKt.until(0, getElementsCount()), ", ", getSerialName() + '(', ")", 0, (CharSequence) null, new Function1() { // from class: kotlinx.serialization.descriptors.b
