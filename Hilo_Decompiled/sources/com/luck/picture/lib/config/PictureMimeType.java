...
public final class PictureMimeType {
    ...
    public static boolean isHasAudio(String str) {
        if (str != null && str.startsWith(MIME_TYPE_PREFIX_AUDIO)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isHasGif(String str) {
        if (str != null && (str.equals(MIME_TYPE_GIF) || str.equals("image/GIF"))) {
            return true;
        }
        return false;
    }

    public static boolean isHasHeic(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
        return str.startsWith(ofHeic());
    }
    ...
    public static boolean isHasWebp(String str) {
        if (str != null && str.equalsIgnoreCase(MIME_TYPE_WEBP)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isUrlHasAudio(String str) {
        if (!str.toLowerCase().endsWith(AMR) && !str.toLowerCase().endsWith(MP3)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isUrlHasImage(String str) {
        if (!str.toLowerCase().endsWith(JPG) && !str.toLowerCase().endsWith(JPEG) && !str.toLowerCase().endsWith(".png") && !str.toLowerCase().endsWith(".heic")) {
            return false;
        }
        return true;
    }
