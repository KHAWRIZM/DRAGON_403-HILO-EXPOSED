...
public final class InjectResourceSource {
    ...
    public static int getLayoutResource(Context context, int i10, SelectorConfig selectorConfig) {
        ...
        if (selectorConfig != null && (onInjectLayoutResourceListener = selectorConfig.onLayoutResourceListener) != null) {
            return onInjectLayoutResourceListener.getLayoutResourceId(context, i10);
        }
        return 0;
    }
}
