...
public final class SelectorConfig {
    ...
    private void initDefaultValue() {
        ...
        this.cameraImageFormat = PictureMimeType.JPEG;
        ...
        this.queryOnlyAudioList = new ArrayList();
        ...
        if (this.chooseMode != SelectMimeType.ofAudio()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public String getResultFirstMimeType() {
        if (this.selectedResult.size() > 0) {
            return this.selectedResult.get(0).getMimeType();
        }
        return "";
    }
