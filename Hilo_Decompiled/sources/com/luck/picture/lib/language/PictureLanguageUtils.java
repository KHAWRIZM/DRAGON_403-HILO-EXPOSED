...
public class PictureLanguageUtils {
    ...
    public static void setAppLanguage(Context context, int i10, int i11) {
        if (i10 >= 0) {
            applyLanguage(context, LocaleTransform.getLanguage(i10));
        } else if (i11 >= 0) {
    ...
    private static void applyLanguage(Context context, Locale locale, boolean z10) {
        if (z10) {
