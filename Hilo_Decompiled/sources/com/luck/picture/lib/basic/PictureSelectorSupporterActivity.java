...
public class PictureSelectorSupporterActivity extends AppCompatActivity {
    ...
    public void initAppLanguage() {
        int i10;
        SelectorConfig selectorConfig = this.selectorConfig;
        if (selectorConfig != null && (i10 = selectorConfig.language) != -2 && !selectorConfig.isOnlyCamera) {
            PictureLanguageUtils.setAppLanguage(this, i10, selectorConfig.defaultLanguage);
        }
    }
