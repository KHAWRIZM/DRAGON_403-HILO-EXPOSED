...
public class PermissionChecker {
    ...
    public static boolean isCheckReadStorage(int i10, Context context) {
        if (SdkVersionUtils.isTIRAMISU()) {
            ...
            if (isCheckReadImages(context) && isCheckReadVideo(context)) {
                return true;
            }
            return false;
        }
    ...
    public void onRequestPermissionsResult(Context context, String[] strArr, int[] iArr, PermissionResultCallback permissionResultCallback) {
        ...
        for (String str : strArr) {
            SpUtils.putBoolean(context, str, b.j(activity, str));
        }
    ...
    private void requestPermissions(Fragment fragment, List<String[]> list, int i10, PermissionResultCallback permissionResultCallback) {
