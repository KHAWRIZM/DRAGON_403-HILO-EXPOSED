...
public abstract class Message<M extends Message<M, B>, B extends Builder<M, B>> implements Serializable {
    ...
    public static abstract class Builder<M extends Message<M, B>, B extends Builder<M, B>> {
        ...
        public final Builder<M, B> addUnknownField(int tag, @NotNull FieldEncoding fieldEncoding, @Nullable Object value) {
            ...
            rawProtoAdapter.encodeWithTag(unknownFieldsWriter, tag, (int) value);
            return this;
        }
        ...
        public final Builder<M, B> clearUnknownFields() {
            ...
            if (getUnknownFieldsBuffer() != null) {
                Buffer unknownFieldsBuffer = getUnknownFieldsBuffer();
    ...
    public Message(@NotNull ProtoAdapter<M> protoAdapter, @NotNull ByteString byteString) {
