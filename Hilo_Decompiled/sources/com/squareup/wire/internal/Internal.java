...
public final class Internal {
    ...
    public static final <T> List<T> m١١٧redactElements(@NotNull List<? extends T> list, @NotNull ProtoAdapter<T> protoAdapter) {
        return Internal__InternalKt.m١١٩redactElements(list, protoAdapter);
    }
    ...
    @NotNull
    /* renamed from: -redactElements, reason: not valid java name */
    public static final <K, V> Map<K, V> m١١٨redactElements(@NotNull Map<K, ? extends V> map, @NotNull ProtoAdapter<V> protoAdapter) {
        return Internal__InternalKt.m١٢٠redactElements(map, protoAdapter);
    }
