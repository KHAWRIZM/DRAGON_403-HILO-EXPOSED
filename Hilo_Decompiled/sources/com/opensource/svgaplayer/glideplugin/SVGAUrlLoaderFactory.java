...
public final class SVGAUrlLoaderFactory implements o {
    ...
    public SVGAUrlLoaderFactory(@NotNull String cachePath, @NotNull Function1<? super InputStream, ? extends e> obtainRewind) {
    ...
    public n build(@NotNull r multiFactory) {
        ...
        return new SVGAEntityUrlLoader(d10, this.cachePath, this.obtainRewind);
    }
