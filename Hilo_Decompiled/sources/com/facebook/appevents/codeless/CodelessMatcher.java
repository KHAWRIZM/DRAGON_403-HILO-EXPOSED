...
public final class CodelessMatcher {
    ...
    public static final class Companion {
        ...
        public final Bundle getParameters(@Nullable EventBinding mapping, @NotNull View rootView, @NotNull View hostView) {
            ...
            List<ParameterComponent> viewParameters = mapping.getViewParameters();
    ...
    public static final class ViewMatcher implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Runnable {
        ...
        public static final class Companion {
            ...
            /* JADX WARN: Code restructure failed: missing block: B:14:0x0062, code lost:
                ...
                if (kotlin.jvm.internal.Intrinsics.areEqual(r10.getClass().getSimpleName(), (java.lang.String) r12.get(r12.size() - 1)) == false) goto L١٥;
             */
            /*
            ...
            private final boolean isTheSameView(View targetView, PathComponent pathElement, int index) {
                ...
                if (!Intrinsics.areEqual(targetView.getClass().getCanonicalName(), pathElement.getClassName())) {
                    if (new Regex(".*android\\..*").matches(pathElement.getClassName())) {
                        List split$default = StringsKt.split$default((CharSequence) pathElement.getClassName(), new String[]{"."}, false, 0, 6, (Object) null);
                ...
                if ((pathElement.getMatchBitmask() & PathComponent.MatchBitmaskType.DESCRIPTION.getValue()) > 0) {
                    ...
                    if (targetView.getContentDescription() == null) {
                        ...
                        obj2 = targetView.getContentDescription().toString();
                    }
                    String coerceValueIfNullOrEmpty2 = Utility.coerceValueIfNullOrEmpty(Utility.sha256hash(obj2), "");
                    if (!Intrinsics.areEqual(description, obj2) && !Intrinsics.areEqual(description, coerceValueIfNullOrEmpty2)) {
                        return false;
                    }
                }
                ...
                if ((pathElement.getMatchBitmask() & PathComponent.MatchBitmaskType.TAG.getValue()) > 0) {
                    ...
                    if (targetView.getTag() == null) {
                        ...
                        obj = targetView.getTag().toString();
                    }
                    String coerceValueIfNullOrEmpty4 = Utility.coerceValueIfNullOrEmpty(Utility.sha256hash(obj), "");
                    if (!Intrinsics.areEqual(tag, obj) && !Intrinsics.areEqual(tag, coerceValueIfNullOrEmpty4)) {
                        return false;
                    }
                }
                return true;
        ...
        @JvmStatic
        @NotNull
        public static final List<MatchedView> findViewByPath(@Nullable EventBinding eventBinding, @Nullable View view, @NotNull List<PathComponent> list, int i10, int i11, @NotNull String str) {
            return INSTANCE.findViewByPath(eventBinding, view, list, i10, i11, str);
        }
            ...
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                ...
                this.uiThreadHandler.post(new Runnable() { // from class: com.facebook.appevents.codeless.d
                    ...
                    public final void run() {
                        CodelessMatcher.m٣٢٦startTracking$lambda1(CodelessMatcher.this);
                    }
                });
            }
        } catch (Throwable th) {
    ...
    public static final void m٣٢٦startTracking$lambda1(CodelessMatcher this$0) {
        if (CrashShieldHandler.isObjectCrashing(CodelessMatcher.class)) {
            return;
        }
        try {
