...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        public static final void m٣٢٩buildAppIndexingRequest$lambda0(GraphResponse it) {
        ...
        public final GraphRequest buildAppIndexingRequest(@Nullable String appIndex, @Nullable AccessToken accessToken, @Nullable String appId, @NotNull String requestType) {
            ...
            newPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.codeless.g
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    ViewIndexer.Companion.m٣٢٩buildAppIndexingRequest$lambda0(graphResponse);
                }
            });
    ...
    public static final void m٣٢٧schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
        ...
        try {
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.f
                ...
                public final void run() {
                    ViewIndexer.m٣٢٨sendToServer$lambda1(tree, this);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m٣٢٨sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
                    ...
                    try {
                        ...
                        if (activity != null && rootView != null) {
                            ...
                            try {
                                ...
                                Log.e(ViewIndexer.access$getTAG$cp(), "Failed to take screenshot.", e10);
                            }
                        ...
                        Log.e(ViewIndexer.access$getTAG$cp(), "UI Component tree indexing failure!", e11);
                    }
                }
            };
            try {
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.e
                    @Override // java.lang.Runnable
                    public final void run() {
                        ViewIndexer.m٣٢٧schedule$lambda0(ViewIndexer.this, timerTask);
                    }
                });
