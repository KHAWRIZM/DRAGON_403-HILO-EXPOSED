...
public final class AppEventQueue {
    ...
    @NotNull
    private static final Runnable flushRunnable = new Runnable() { // from class: com.facebook.appevents.e
        @Override // java.lang.Runnable
        public final void run() {
            AppEventQueue.m٣٠٤flushRunnable$lambda0();
        }
    };
    ...
    public static final void add(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull final AppEvent appEvent) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.f
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m٣٠١add$lambda3(AccessTokenAppIdPair.this, appEvent);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m٣٠١add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final GraphRequest buildRequestForSession(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull final SessionEventsState appEvents, boolean limitEventUsage, @NotNull final FlushStatistics flushState) {
        ...
        try {
            ...
            if (queryAppSettings != null) {
                z10 = queryAppSettings.getSupportsImplicitLogging();
            }
            int populateRequest = appEvents.populateRequest(newPostRequest, FacebookSdk.getApplicationContext(), z10, limitEventUsage);
            ...
            newPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.h
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m٣٠٢buildRequestForSession$lambda4(AccessTokenAppIdPair.this, newPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m٣٠٢buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(@NotNull final FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.c
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m٣٠٣flush$lambda2(FlushReason.this);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m٣٠٣flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            try {
                ...
                if (sendEventsToServer != null) {
                    ...
                    b3.a.b(FacebookSdk.getApplicationContext()).d(intent);
                }
            } catch (Exception e10) {
    ...
    public static final void m٣٠٤flushRunnable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            if (flushResult == flushResult2) {
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.g
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventQueue.m٣٠٥handleResponse$lambda5(AccessTokenAppIdPair.this, appEvents);
                    }
                });
            }
    ...
    public static final void m٣٠٥handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void persistToDisk() {
        ...
        try {
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.d
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m٣٠٦persistToDisk$lambda1();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m٣٠٦persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
