...
public final class InAppPurchaseSkuDetailsWrapper {
    ...
    public final Object getSkuDetailsParams(@Nullable String skuType, @Nullable List<String> skuIDs) {
        ...
        try {
            ...
            if (invokeMethod3 != null && (invokeMethod = InAppPurchaseUtils.invokeMethod(this.builderClazz, this.setTypeMethod, invokeMethod3, skuType)) != null && (invokeMethod2 = InAppPurchaseUtils.invokeMethod(this.builderClazz, this.setSkusListMethod, invokeMethod, skuIDs)) != null) {
