...
public final class AnalyticsUserIDStore {
    ...
    public static final void initStore() {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new Runnable() { // from class: com.facebook.appevents.b
            ...
            public final void run() {
                AnalyticsUserIDStore.m٢٩٩initStore$lambda0();
            }
        });
    }
    ...
    public static final void m٢٩٩initStore$lambda0() {
        INSTANCE.initAndWait();
    }
    ...
    public static final void setUserID(@Nullable final String id) {
        ...
        InternalAppEventsLogger.INSTANCE.getAnalyticsExecutor().execute(new Runnable() { // from class: com.facebook.appevents.a
            @Override // java.lang.Runnable
            public final void run() {
                AnalyticsUserIDStore.m٣٠٠setUserID$lambda1(id);
            }
        });
    }
    ...
    public static final void m٣٠٠setUserID$lambda1(String str) {
        ReentrantReadWriteLock reentrantReadWriteLock = lock;
        reentrantReadWriteLock.writeLock().lock();
        try {
            userID = str;
