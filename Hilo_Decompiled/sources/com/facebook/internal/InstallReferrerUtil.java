...
public final class InstallReferrerUtil {
    ...
    public interface Callback {
        void onReceiveReferrerUrl(@Nullable String s10);
    }
    ...
    private final void tryConnectReferrerInfo(final Callback callback) {
        final InstallReferrerClient a10 = InstallReferrerClient.b(FacebookSdk.getApplicationContext()).a();
        try {
            a10.c(new InstallReferrerStateListener() { // from class: com.facebook.internal.InstallReferrerUtil$tryConnectReferrerInfo$installReferrerStateListener$1
                ...
                public void onInstallReferrerSetupFinished(int responseCode) {
                    ...
                    try {
                        ...
                        try {
                            ReferrerDetails a11 = InstallReferrerClient.this.a();
                            Intrinsics.checkNotNullExpressionValue(a11, "{\n                      referrerClient.installReferrer\n                    }");
                            String a12 = a11.a();
                            if (a12 != null && (StringsKt.contains$default((CharSequence) a12, (CharSequence) "fb", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) a12, (CharSequence) AccessToken.DEFAULT_GRAPH_DOMAIN, false, 2, (Object) null))) {
                                callback.onReceiveReferrerUrl(a12);
                            }
                            InstallReferrerUtil.INSTANCE.updateReferrer();
