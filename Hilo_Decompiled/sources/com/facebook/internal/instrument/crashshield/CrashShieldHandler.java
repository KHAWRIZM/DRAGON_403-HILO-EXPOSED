...
public final class CrashShieldHandler {
    ...
    @JvmStatic
    public static final void handleThrowable(@Nullable Throwable e10, @NotNull Object o10) {
        ...
        if (FacebookSdk.getAutoLogAppEventsEnabled()) {
            ...
            InstrumentData.Builder.build(e10, InstrumentData.Type.CrashShield).save();
        }
        scheduleCrashInDebug(e10);
    }
    ...
    @JvmStatic
    public static final void methodFinished(@Nullable Object o10) {
    }
    ...
    @JvmStatic
    @VisibleForTesting
    public static final void scheduleCrashInDebug(@Nullable final Throwable e10) {
        if (isDebug()) {
