...
public final class ANRHandler {
    ...
    public static final void sendANRReports() {
        ...
        try {
            ...
            final List sortedWith = CollectionsKt.sortedWith(arrayList2, new Comparator() { // from class: k6.b
                @Override // java.util.Comparator
                public final int compare(Object obj2, Object obj3) {
                    int i10;
                    i10 = ANRHandler.m٣٩٩sendANRReports$lambda2((InstrumentData) obj2, (InstrumentData) obj3);
                    return i10;
                }
            });
            ...
            InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback() { // from class: k6.c
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    ANRHandler.m٤٠٠sendANRReports$lambda5(sortedWith, graphResponse);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ANRHandler.class);
    ...
    public static final int m٣٩٩sendANRReports$lambda2(InstrumentData instrumentData, InstrumentData o22) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return 0;
        }
        try {
    ...
    public static final void m٤٠٠sendANRReports$lambda5(List validReports, GraphResponse response) {
        Boolean valueOf;
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return;
        }
