...
public final class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static final class Companion {
        ...
        private final void sendExceptionReports() {
            ...
            final List sortedWith = CollectionsKt.sortedWith(arrayList2, new Comparator() { // from class: l6.a
                @Override // java.util.Comparator
                public final int compare(Object obj2, Object obj3) {
                    int i10;
                    i10 = CrashHandler.Companion.m٤٠١sendExceptionReports$lambda2((InstrumentData) obj2, (InstrumentData) obj3);
                    return i10;
                }
            });
            ...
            InstrumentUtility.sendReports("crash_reports", jSONArray, new GraphRequest.Callback() { // from class: l6.b
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    CrashHandler.Companion.m٤٠٢sendExceptionReports$lambda5(sortedWith, graphResponse);
                }
            });
        }
        ...
        public static final int m٤٠١sendExceptionReports$lambda2(InstrumentData instrumentData, InstrumentData o22) {
        ...
        public static final void m٤٠٢sendExceptionReports$lambda5(List validReports, GraphResponse response) {
            Boolean valueOf;
    ...
    public void uncaughtException(@NotNull Thread t10, @NotNull Throwable e10) {
        ...
        if (InstrumentUtility.isSDKRelatedException(e10)) {
            ExceptionAnalyzer.execute(e10);
            InstrumentData.Builder builder = InstrumentData.Builder.INSTANCE;
            InstrumentData.Builder.build(e10, InstrumentData.Type.CrashReport).save();
        }
