...
public final class AppCall {
    ...
    @JvmStatic
    @Nullable
    public static final synchronized AppCall finishPendingCall(@NotNull UUID uuid, int i10) {
        synchronized (AppCall.class) {
            if (CrashShieldHandler.isObjectCrashing(AppCall.class)) {
                return null;
            }
            try {
                return INSTANCE.finishPendingCall(uuid, i10);
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, AppCall.class);
                return null;
            }
    ...
    @JvmOverloads
    public AppCall(int i10, @NotNull UUID callId) {
        Intrinsics.checkNotNullParameter(callId, "callId");
        this.requestCode = i10;
        this.callId = callId;
    }
    ...
    */
    public /* synthetic */ AppCall(int i10, UUID uuid, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, uuid);
        if ((i11 & 2) != 0) {
