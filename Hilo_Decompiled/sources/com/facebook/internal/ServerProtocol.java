...
public final class ServerProtocol {
    ...
    public static final Bundle getQueryParamsForPlatformActivityIntentWebFallback(@NotNull String callId, int version, @Nullable Bundle methodArgs) {
        ...
        try {
            ...
            companion.log(loggingBehavior, 6, TAG2, Intrinsics.stringPlus("Error creating Url -- ", e10));
            return null;
            ...
            companion2.log(loggingBehavior2, 6, TAG3, Intrinsics.stringPlus("Error creating Url -- ", e11));
            return null;
        }
    }
}
