...
public final class FeatureManager {
    ...
    public enum Feature {
        ...
        Instrument(anetwork.channel.unified.e.MAX_RSP_BUFFER_LENGTH),
        CrashReport(131328),
        CrashShield(131329),
        ThreadCheck(131330),
        ErrorReport(131584),
        ...
        public final Feature getParent() {
            ...
            if ((i10 & KotlinVersion.MAX_COMPONENT_VALUE) > 0) {
                return INSTANCE.fromInt(i10 & (-256));
            }
            if ((65280 & i10) > 0) {
                return INSTANCE.fromInt(i10 & (-65536));
            }
            if ((16711680 & i10) > 0) {
                return INSTANCE.fromInt(i10 & (-16777216));
            }
