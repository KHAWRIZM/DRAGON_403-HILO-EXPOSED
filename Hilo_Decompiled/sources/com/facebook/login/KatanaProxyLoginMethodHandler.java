...
public final class KatanaProxyLoginMethodHandler extends NativeAppLoginMethodHandler {
    ...
    public int tryAuthorize(@NotNull LoginClient.Request request) {
        ...
        if (FacebookSdk.ignoreAppSwitchToLoggedOut && CustomTabUtils.getChromePackage() != null && loginBehavior.getAllowsCustomTabAuth()) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        List<Intent> createProxyAuthIntents = NativeProtocol.createProxyAuthIntents(activity, applicationId, permissions, e2e, isRerequest, hasPublishPermission, defaultAudience2, clientState, authType, z10, messengerPageId, resetMessengerState, isFamilyLogin, shouldSkipAccountDeduplication, nonce, codeChallenge, name);
