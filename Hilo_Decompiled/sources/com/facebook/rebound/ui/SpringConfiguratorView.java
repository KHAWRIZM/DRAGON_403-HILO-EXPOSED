...
public class SpringConfiguratorView extends FrameLayout {
    ...
    private class RevealerSpringListener implements SpringListener {
        ...
        public void onSpringUpdate(Spring spring) {
            ...
            float f10 = SpringConfiguratorView.this.mRevealPx;
            SpringConfiguratorView.this.setTranslationY((currentValue * (SpringConfiguratorView.this.mStashPx - f10)) + f10);
        }
    }
    ...
    private class SeekbarListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int i10, boolean z10) {
            if (seekBar == SpringConfiguratorView.this.mTensionSeekBar) {
                double d10 = ((i10 * SpringConfiguratorView.MAX_TENSION) / 100000.0f) + DownloadProgress.UNKNOWN_PROGRESS;
                SpringConfiguratorView.this.mSelectedSpringConfig.tension = OrigamiValueConverter.tensionFromOrigamiValue(d10);
                String format = SpringConfiguratorView.DECIMAL_FORMAT.format(d10);
                SpringConfiguratorView.this.mTensionLabel.setText("T:" + format);
            }
            if (seekBar == SpringConfiguratorView.this.mFrictionSeekBar) {
                double d11 = ((i10 * SpringConfiguratorView.MAX_FRICTION) / 100000.0f) + DownloadProgress.UNKNOWN_PROGRESS;
                SpringConfiguratorView.this.mSelectedSpringConfig.friction = OrigamiValueConverter.frictionFromOrigamiValue(d11);
                String format2 = SpringConfiguratorView.DECIMAL_FORMAT.format(d11);
    ...
    public class SpinnerAdapter extends BaseAdapter {
        ...
        public View getView(int i10, View view, ViewGroup viewGroup) {
            ...
            textView.setText(this.mStrings.get(i10));
            return textView;
        }
    }
    ...
    private class SpringSelectedListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i10, long j10) {
            ...
            springConfiguratorView.mSelectedSpringConfig = (SpringConfig) springConfiguratorView.mSpringConfigs.get(i10);
    ...
    public void updateSeekBarsForSpringConfig(SpringConfig springConfig) {
        int round = Math.round(((((float) OrigamiValueConverter.origamiValueFromTension(springConfig.tension)) - DownloadProgress.UNKNOWN_PROGRESS) * 100000.0f) / MAX_TENSION);
        int round2 = Math.round(((((float) OrigamiValueConverter.origamiValueFromFriction(springConfig.friction)) - DownloadProgress.UNKNOWN_PROGRESS) * 100000.0f) / MAX_FRICTION);
    ...
    public SpringConfiguratorView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.mTextColor = Color.argb(KotlinVersion.MAX_COMPONENT_VALUE, 225, 225, 225);
