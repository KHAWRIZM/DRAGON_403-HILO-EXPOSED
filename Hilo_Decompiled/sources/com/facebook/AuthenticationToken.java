...
public final class AuthenticationToken implements Parcelable {
    ...
    public AuthenticationToken(@NotNull String token, @NotNull String expectedNonce) {
        ...
        Validate.notEmpty(token, HeaderInterceptor.TOKEN);
        Validate.notEmpty(expectedNonce, "expectedNonce");
        List split$default = StringsKt.split$default((CharSequence) token, new String[]{InstructionFileId.DOT}, false, 0, 6, (Object) null);
    ...
    public AuthenticationToken(@NotNull Parcel parcel) {
        ...
        this.token = Validate.notNullOrEmpty(parcel.readString(), HeaderInterceptor.TOKEN);
