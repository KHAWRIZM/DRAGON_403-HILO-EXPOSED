...
public final class UserSettingsManager {
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\n\u0002\u0010\t\n\u0002\b\u000b\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0006\u0010\u0016\u001a\u00020\u0003R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u001a\u0010\u000f\u001a\u00020\u0010X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014R\u001e\u0010\u0015\u001a\u0004\u0018\u00010\u0003X\u0086\u000e¢\u0006\u0010\n\u0002\u0010\u001a\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019¨\u0006\u001b"}, d2 = {"Lcom/facebook/UserSettingsManager$UserSetting;", "", "defaultVal", "", TransferTable.COLUMN_KEY, "", "(ZLjava/lang/String;)V", "getDefaultVal", "()Z", "setDefaultVal", "(Z)V", "getKey", "()Ljava/lang/String;", "setKey", "(Ljava/lang/String;)V", "lastTS", "", "getLastTS", "()J", "setLastTS", "(J)V", "value", "getValue", "()Ljava/lang/Boolean;", "setValue", "(Ljava/lang/Boolean;)V", "Ljava/lang/Boolean;", "facebook-core_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes2.dex */
    public static final class UserSetting {
        ...
        public final boolean m٢٩٨getValue() {
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            ...
            return advertiserIDCollectionEnabled.m٢٩٨getValue();
        } catch (Throwable th) {
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m٢٩٨getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getAutoLogAppEventsEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoLogAppEventsEnabled.m٢٩٨getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m٢٩٨getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m٢٩٨getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.v
                ...
                public final void run() {
                    UserSettingsManager.m٢٩٧initializeCodelessSetupEnabledAsync$lambda0(currentTimeMillis);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m٢٩٧initializeCodelessSetupEnabledAsync$lambda0(long j10) {
        String str;
        if (CrashShieldHandler.isObjectCrashing(UserSettingsManager.class)) {
            return;
        }
        try {
            if (advertiserIDCollectionEnabled.m٢٩٨getValue()) {
    ...
    private final void initializeUserSetting(UserSetting... userSettings) {
        ...
        try {
            ...
            int i10 = 0;
            while (i10 < length) {
                UserSetting userSetting = userSettings[i10];
                i10++;
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            ...
            Context applicationContext = FacebookSdk.getApplicationContext();
            boolean z10 = autoInitEnabled.m٢٩٨getValue();
            int i12 = 0;
            int i13 = (z10 ? 1 : 0) | ((autoLogAppEventsEnabled.m٢٩٨getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m٢٩٨getValue() ? 1 : 0) << 2) | ((monitorEnabled.m٢٩٨getValue() ? 1 : 0) << 3);
