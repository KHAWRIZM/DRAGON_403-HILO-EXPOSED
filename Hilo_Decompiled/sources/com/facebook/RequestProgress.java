...
public final class RequestProgress {
    ...
    public static final void m٢٩٦reportProgress$lambda0(GraphRequest.Callback callback, long j10, long j11) {
        ((GraphRequest.OnProgressCallback) callback).onProgress(j10, j11);
    }

    public final void addProgress(long size) {
        long j10 = this.progress + size;
        this.progress = j10;
                ...
                if (handler == null) {
                    ...
                    valueOf = Boolean.valueOf(handler.post(new Runnable() { // from class: com.facebook.u
                        ...
                        public final void run() {
                            RequestProgress.m٢٩٦reportProgress$lambda0(GraphRequest.Callback.this, j11, j10);
                        }
                    }));
                }
                if (valueOf == null) {
