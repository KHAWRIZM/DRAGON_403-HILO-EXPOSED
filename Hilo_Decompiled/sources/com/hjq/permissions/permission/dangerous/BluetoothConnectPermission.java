...
public final class BluetoothConnectPermission extends DangerousPermission {
    public static final Parcelable.Creator<BluetoothConnectPermission> CREATOR = new a();
    ...
    class a implements Parcelable.Creator {
        ...
        public BluetoothConnectPermission createFromParcel(Parcel parcel) {
            return new BluetoothConnectPermission(parcel, null);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public BluetoothConnectPermission[] newArray(int i10) {
            return new BluetoothConnectPermission[i10];
        }
    }

    /* synthetic */ BluetoothConnectPermission(Parcel parcel, a aVar) {
        this(parcel);
    }
    ...
    public void g(Activity activity, List list, da.a aVar, List list2, f fVar) {
        ...
        if (h(activity) > BasePermission.B(activity, aVar)) {
            BasePermission.f(list2, "android.permission.BLUETOOTH", 30);
        }
    }
    ...
    private BluetoothConnectPermission(Parcel parcel) {
        super(parcel);
    }
}
