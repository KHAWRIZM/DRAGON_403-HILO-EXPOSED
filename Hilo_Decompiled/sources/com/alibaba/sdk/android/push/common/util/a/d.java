...
public enum d {
    ...
    UNBIND_TAG_TO_DEVICE(RtcEngineEvent.EvtType.EVT_TRANSPORT_QUALITY, "Unbind tag from device"),
    UNBIND_TAG_TO_ACCOUNT(1102, "Unbind tag from account"),
    UNBIND_TAG_TO_ALIAS(1103, "Unbind tag from alias"),
    UNBIND_ALIAS(RtcEngineEvent.EvtType.EVT_MEDIA_ENGINE_EVENT, "Remove alias"),
