...
public class SendService {
    ...
    public Boolean sendRequest(String str, long j10, String str2, int i10, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        String str3;
        if (canSend().booleanValue()) {
            ...
            return Boolean.valueOf(f.a(this, this.appKey, this.context, str3, j10, str2, i10, obj, obj2, obj3, map));
        }
        return Boolean.FALSE;
    }

    public void sendRequestAsyn(String str, long j10, String str2, int i10, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        String str3;
        if (canSend().booleanValue()) {
            if (str == null) {
                String str4 = this.host;
            ...
            this.sendAsyncExecutor.a(new RestThread(this, "rest thread", this.appKey, this.context, str3, j10, str2, i10, obj, obj2, obj3, map, Boolean.FALSE));
        }
    }

    public void sendRequestAsynByAppkeyAndUrl(String str, String str2, long j10, String str3, int i10, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        String str4;
        if (canSend().booleanValue()) {
            if (str == null) {
            ...
            this.sendAsyncExecutor.a(new RestThread(this, "rest thread", str4, this.context, str, j10, str3, i10, obj, obj2, obj3, map, Boolean.TRUE));
        }
    }

    @Deprecated
    public String sendRequestByUrl(String str, long j10, String str2, int i10, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        if (canSend().booleanValue()) {
            return f.a(this, str, this.appKey, this.context, j10, str2, i10, obj, obj2, obj3, map);
        }
        return null;
    }
    ...
    public static class RestThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                LogUtil.e("send log asyn error ", e10);
            }
        }

        public RestThread(SendService sendService, String str, String str2, Context context, String str3, long j10, String str4, int i10, Object obj, Object obj2, Object obj3, Map<String, String> map, Boolean bool) {
            this.context = context;
