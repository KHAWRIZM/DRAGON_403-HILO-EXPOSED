...
public final class TUIConstants {
    ...
    public static final class TUICalling {
        ...
        public static final int ERROR_INVALID_PARAM = -1001;
        public static final int ERROR_MIC_PERMISSION_REFUSED = -1004;
        public static final int ERROR_NONE = 0;
        public static final int ERROR_NO_MESSAGE_TO_RECORD = -2004;
        public static final int ERROR_PATH_FORMAT_NOT_SUPPORT = -2002;
        public static final int ERROR_RECORD_FAILED = -2003;
        public static final int ERROR_RECORD_INIT_FAILED = -2001;
        public static final int ERROR_REQUEST_AUDIO_FOCUS_FAILED = -1005;
        public static final int ERROR_SIGNATURE_ERROR = -3001;
        public static final int ERROR_SIGNATURE_EXPIRED = -3002;
        public static final int ERROR_STATUS_IN_CALL = -1002;
        public static final int ERROR_STATUS_IS_AUDIO_RECORDING = -1003;
        ...
        public static final String SERVICE_NAME_AUDIO_RECORD = "TUIAudioMessageRecordService";
    ...
    public static final class TUICommunity {
        ...
        public static final String SERVICE_NAME = "TUICommunityService";
