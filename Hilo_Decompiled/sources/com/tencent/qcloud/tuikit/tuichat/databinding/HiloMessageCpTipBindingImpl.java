...
public class HiloMessageCpTipBindingImpl extends HiloMessageCpTipBinding {
    ...
    public HiloMessageCpTipBindingImpl(f fVar, View view) {
    ...
    private HiloMessageCpTipBindingImpl(f fVar, View view, Object[] objArr) {
