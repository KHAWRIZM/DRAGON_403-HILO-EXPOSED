...
public class HiloMessageCpInviteBindingImpl extends HiloMessageCpInviteBinding {
    ...
    public HiloMessageCpInviteBindingImpl(f fVar, View view) {
    ...
    private HiloMessageCpInviteBindingImpl(f fVar, View view, Object[] objArr) {
