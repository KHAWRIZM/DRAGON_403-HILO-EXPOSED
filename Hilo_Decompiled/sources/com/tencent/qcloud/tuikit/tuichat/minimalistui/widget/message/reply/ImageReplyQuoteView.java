                ...
                synchronized (this.downloadEles) {
                    try {
                        if (!this.downloadEles.contains(imageBean.getUUID())) {
                            ...
                            imageBean.downloadImage(generateImagePath, new ImageMessageBean.ImageBean.ImageDownloadCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.widget.message.reply.ImageReplyQuoteView.1
                                ...
                                public void onSuccess() {
                                    ...
                                    GlideEngine.loadCornerImageWithoutPlaceHolder(ImageReplyQuoteView.this.imageMsgIv, imageMessageBean.getDataPath(), new g() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.widget.message.reply.ImageReplyQuoteView.1.1
