package com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera;
...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.minimalist_activity_camera);
        ...
        this.jCameraView.setErrorLisenter(new ErrorListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.CameraActivity.1
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.ErrorListener
        ...
        this.jCameraView.setJCameraLisenter(new JCameraListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.CameraActivity.2
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.JCameraListener
        ...
        this.jCameraView.setLeftClickListener(new ClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.CameraActivity.3
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.ClickListener
            public void onClick() {
                CameraActivity.this.finish();
            }
        });
        this.jCameraView.setRightClickListener(new ClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.CameraActivity.4
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.ClickListener
            public void onClick() {
