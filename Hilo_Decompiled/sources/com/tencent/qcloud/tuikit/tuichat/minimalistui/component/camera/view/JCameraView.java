...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder.Callback, CameraView {
    ...
    private void initView() {
        ...
        View inflate = LayoutInflater.from(this.mContext).inflate(R.layout.chat_minimalist_input_camera_view, this);
        ...
        this.mSwitchCamera.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                JCameraView.this.machine.swtich(JCameraView.this.mVideoView.getHolder(), JCameraView.this.screenProp);
            }
        });
        this.mCaptureLayout.setCaptureLisenter(new CaptureListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.2
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.CaptureListener
            ...
            public void recordShort(final long j) {
                ...
                JCameraView.this.postDelayed(new Runnable() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.2.1
        ...
        this.mCaptureLayout.setTypeLisenter(new TypeListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.3
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.TypeListener
            public void cancel() {
        ...
        this.mCaptureLayout.setLeftClickListener(new ClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.4
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.ClickListener
            public void onClick() {
        ...
        this.mCaptureLayout.setRightClickListener(new ClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.5
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.listener.ClickListener
            public void onClick() {
    ...
    private void setFocusViewWidthAnimation(float f, float f2) {
        this.machine.foucs(f, f2, new CameraInterface.FocusCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.7
            @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CameraInterface.FocusCallback
    ...
    @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CameraInterface.CameraOpenOverCallback
    public void cameraHasOpened() {
        CameraInterface.getInstance().doStartPreview(this.mVideoView.getHolder(), this.screenProp);
    }

    @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CameraView
    ...
    public void playVideo(Bitmap bitmap, String str) {
        ...
        try {
            ...
            this.mMediaPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.8
            ...
            this.mMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.9
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        new Thread() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.JCameraView.6
