...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attributeSet) {
        ...
        setOrientation(0);
        this.mMaxHeight = (int) ScreenUtil.dp2px(this.mHeight, getResources().getDisplayMetrics());
    ...
    public void playBy(int i, int i2) {
        ...
        if (z) {
            ...
            ofFloat.addListener(new Animator.AnimatorListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.EmojiIndicatorView.1
