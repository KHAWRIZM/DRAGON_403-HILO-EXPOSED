...
public class ChatLayoutSetting {
    ...
    public void customizeChatLayout(ChatView chatView) {
        ...
        InputMoreActionUnit inputMoreActionUnit = new InputMoreActionUnit() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.setting.ChatLayoutSetting.1
        };
        inputMoreActionUnit.setIconResId(R.drawable.chat_minimalist_more_action_custom_icon);
        ...
        inputMoreActionUnit.setOnClickListener(new InputMoreActionUnit.OnActionClickListener(inputMoreActionUnit, chatView) { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.setting.ChatLayoutSetting.2
