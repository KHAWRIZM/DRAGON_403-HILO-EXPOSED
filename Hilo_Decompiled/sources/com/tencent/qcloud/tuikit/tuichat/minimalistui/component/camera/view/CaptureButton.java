...
public class CaptureButton extends View {
    ...
    private void startCaptureAnimation(float f) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CaptureButton.1
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CaptureButton.2
    ...
    public void startRecordAnimation(float f, float f2, float f3, float f4) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CaptureButton.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CaptureButton.4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                CaptureButton.this.button_inside_radius = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                CaptureButton.this.invalidate();
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.camera.view.CaptureButton.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            TUIChatLog.i(TAG, "state = " + this.state);
    ...
    public CaptureButton(Context context, int i) {
        ...
        this.min_duration = RoomEvent.ROOM_ACTIVITY_DETAIL;
