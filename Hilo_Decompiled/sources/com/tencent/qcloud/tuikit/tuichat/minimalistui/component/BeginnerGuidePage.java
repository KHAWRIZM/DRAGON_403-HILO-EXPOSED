...
public class BeginnerGuidePage {
    ...
    class GuideAdapter extends RecyclerView.Adapter<GuideViewHolder> {
        ...
        public void onBindViewHolder(final GuideViewHolder guideViewHolder, int i) {
            ...
            ((RecyclerView.ViewHolder) guideViewHolder).itemView.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.BeginnerGuidePage.GuideAdapter.1
    ...
    public BeginnerGuidePage(final Activity activity) {
        ...
        PopupWindow popupWindow = new PopupWindow(inflate, -1, -1, true) { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.BeginnerGuidePage.1
    ...
    public static void showBeginnerGuideThen(View view, final Runnable runnable) {
        if (SPUtils.getInstance(TUIChatConstants.CHAT_SETTINGS_SP_NAME).getBoolean(TUIChatConstants.CHAT_REPLY_GUIDE_SHOW_SP_KEY, true)) {
            ...
            beginnerGuidePage.setOnFinishListener(new OnFinishListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.BeginnerGuidePage.3
                @Override // com.tencent.qcloud.tuikit.tuichat.minimalistui.component.BeginnerGuidePage.OnFinishListener
    ...
    public void startAnimation(final Window window, boolean z) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tencent.qcloud.tuikit.tuichat.minimalistui.component.BeginnerGuidePage.2
