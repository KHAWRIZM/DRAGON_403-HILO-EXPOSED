...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u0007\u001a\u00020\u0002H\u0016J\u001a\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0016¨\u0006\u000e"}, d2 = {"Lcom/tencent/qcloud/tuikit/tuichat/hilo/viewHolder/group/RoomGlobalGiftHolder;", "Lcom/tencent/qcloud/tuikit/tuichat/hilo/viewHolder/group/RoomEmptyBaseHolder;", "Lcom/tencent/qcloud/tuikit/tuichat/databinding/HiloRoomGlobalGiftBinding;", "itemView", "Landroid/view/View;", "<init>", "(Landroid/view/View;)V", "inflateViewBinding", "layoutViews", "", "msg", "Lcom/tencent/qcloud/tuikit/tuichat/bean/message/TUIMessageBean;", "position", "", "tuichat_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nRoomGlobalGiftHolder.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RoomGlobalGiftHolder.kt\ncom/tencent/qcloud/tuikit/tuichat/hilo/viewHolder/group/RoomGlobalGiftHolder\n+ 2 ViewKtx.kt\ncom/oudi/utils/ktx/ViewKtxKt\n*L\n1#1,41:1\n61#2,9:42\n*S KotlinDebug\n*F\n+ 1 RoomGlobalGiftHolder.kt\ncom/tencent/qcloud/tuikit/tuichat/hilo/viewHolder/group/RoomGlobalGiftHolder\n*L\n36#1:42,9\n*E\n"})
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes5.dex */
public final class RoomGlobalGiftHolder extends RoomEmptyBaseHolder<HiloRoomGlobalGiftBinding> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomGlobalGiftHolder(@NotNull View view) {
        super(view);
    ...
    public void layoutViews(@Nullable final TUIMessageBean msg, int position) {
        ...
        if (!(msg instanceof RoomGlobalGiftBean)) {
            return;
        }
        HiloRoomGlobalGiftBinding binding = getBinding();
        if (binding != null && (textView = binding.giftTipText) != null) {
            String stringById = ResourcesKtxKt.getStringById(this, R.string.global_group_send_gift_1);
            RoomGlobalGiftBean roomGlobalGiftBean = (RoomGlobalGiftBean) msg;
            GroupRoomImCustomBean data = roomGlobalGiftBean.getData();
            String str3 = null;
            if (data != null) {
                str = data.getOperatorNick();
            } else {
                str = null;
            }
            GroupRoomImCustomBean data2 = roomGlobalGiftBean.getData();
            if (data2 != null) {
                str3 = data2.getNick();
            }
            GroupRoomImCustomBean data3 = roomGlobalGiftBean.getData();
            if (data3 == null || (str2 = data3.getGiftName()) == null) {
                str2 = "";
            }
            String format = String.format(stringById, Arrays.copyOf(new Object[]{str, str3, str2}, 3));
        ...
        if (binding2 != null && (root = binding2.getRoot()) != null) {
            final long j = 800;
            root.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.hilo.viewHolder.group.RoomGlobalGiftHolder$layoutViews$$inlined$singleClick$default$1
                ...
                public final void onClick(View view) {
                    ...
                    if (currentTimeMillis - ViewKtxKt.getLastClickTime(root) > j || (root instanceof Checkable)) {
                        ...
                        GroupRoomImCustomBean data4 = ((RoomGlobalGiftBean) msg).getData();
                        if (data4 == null || (str4 = data4.getGroupId()) == null) {
                            str4 = "";
                        }
                        baseControlUtils.openRoom(str4);
                    }
                }
            });
        }
