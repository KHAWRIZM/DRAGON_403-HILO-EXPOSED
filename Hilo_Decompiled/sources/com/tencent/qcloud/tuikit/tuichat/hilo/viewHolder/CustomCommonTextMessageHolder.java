...
public final class CustomCommonTextMessageHolder extends MessageEmptyBaseHolder<HiloMessageCommonTextBinding> {
    ...
    public void layoutViews(@Nullable TUIMessageBean msg, int position) {
        ...
        HiloMessageCommonTextBinding binding = getBinding();
        if (binding != null && (textView7 = binding.messageContainer) != null) {
            if (msg != null) {
                str = msg.getExtra();
            } else {
                str = null;
        ...
        if (checkStrange()) {
            ...
            if (binding4 != null && (textView4 = binding4.messageContainer) != null) {
                textView4.setTextColor(androidx.core.content.a.getColor(((RecyclerView.ViewHolder) this).itemView.getContext(), R.color.configColor80White));
                return;
            }
            return;
        }
        ...
        if (binding5 != null && (textView3 = binding5.messageContainer) != null) {
            textView3.setTextColor(androidx.core.content.a.getColor(((RecyclerView.ViewHolder) this).itemView.getContext(), R.color.color_666666));
        }
