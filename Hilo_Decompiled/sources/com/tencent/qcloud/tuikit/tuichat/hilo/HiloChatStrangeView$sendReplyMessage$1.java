...
@Metadata(d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0002H\u0016J \u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\bH\u0016¨\u0006\f"}, d2 = {"com/tencent/qcloud/tuikit/tuichat/hilo/HiloChatStrangeView$sendReplyMessage$1", "Lcom/tencent/qcloud/tuicore/component/interfaces/IUIKitCallback;", "Lcom/tencent/qcloud/tuikit/tuichat/bean/message/TUIMessageBean;", "onSuccess", "", "data", "onError", "module", "", "errCode", "", "errMsg", "tuichat_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes5.dex */
public final class HiloChatStrangeView$sendReplyMessage$1 extends IUIKitCallback<TUIMessageBean> {
    final /* synthetic */ TUIMessageBean $msg;
    final /* synthetic */ HiloChatStrangeView this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public HiloChatStrangeView$sendReplyMessage$1(HiloChatStrangeView hiloChatStrangeView, TUIMessageBean tUIMessageBean) {
    ...
    public void onError(String module, int errCode, String errMsg) {
        ...
        if (errCode == 7013 && this.$msg.isNeedReadReceipt()) {
    ...
    public void onSuccess(final TUIMessageBean data) {
        ...
        backgroundTasks.runOnUiThread(new Runnable() { // from class: com.tencent.qcloud.tuikit.tuichat.hilo.w
            @Override // java.lang.Runnable
            public final void run() {
                HiloChatStrangeView$sendReplyMessage$1.onSuccess$lambda$0(HiloChatStrangeView.this, data);
            }
        });
        chatPresenter = this.this$0.presenter;
        if (chatPresenter != null) {
            Intrinsics.checkNotNull(data, "null cannot be cast to non-null type com.tencent.qcloud.tuikit.tuichat.bean.message.ReplyMessageBean");
            chatPresenter.modifyRootMessageToAddReplyInfo((ReplyMessageBean) data, new IUIKitCallback<Void>() { // from class: com.tencent.qcloud.tuikit.tuichat.hilo.HiloChatStrangeView$sendReplyMessage$1$onSuccess$2
                @Override // com.tencent.qcloud.tuicore.component.interfaces.IUIKitCallback
                public void onError(String module, int errCode, String errMsg) {
                    Intrinsics.checkNotNullParameter(module, "module");
                    Intrinsics.checkNotNullParameter(errMsg, "errMsg");
