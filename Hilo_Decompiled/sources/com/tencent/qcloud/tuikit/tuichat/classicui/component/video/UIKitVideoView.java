...
public class UIKitVideoView extends TextureView {
    ...
    public UIKitVideoView(Context context) {
        ...
        this.mOnPreparedListener = new IPlayer.OnPreparedListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.1
        ...
        this.mOnErrorListener = new IPlayer.OnErrorListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.2
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.video.proxy.IPlayer.OnErrorListener
        ...
        this.mOnInfoListener = new IPlayer.OnInfoListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.3
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.video.proxy.IPlayer.OnInfoListener
        ...
        this.mOnCompletionListener = new IPlayer.OnCompletionListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.4
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.video.proxy.IPlayer.OnCompletionListener
        ...
        this.mOnVideoSizeChangedListener = new IPlayer.OnVideoSizeChangedListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.5
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.video.proxy.IPlayer.OnVideoSizeChangedListener
            public void onVideoSizeChanged(IPlayer iPlayer, int i, int i2) {
            }
        };
        this.onSeekCompleteListener = new IPlayer.OnSeekCompleteListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.6
        ...
        this.mSurfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.video.UIKitVideoView.7
