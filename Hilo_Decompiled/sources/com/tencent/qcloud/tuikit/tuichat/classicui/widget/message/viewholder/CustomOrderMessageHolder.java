...
public class CustomOrderMessageHolder extends MessageContentHolder {
    ...
    public void layoutVariableViews(TUIMessageBean tUIMessageBean, int i) {
        ...
        GlideEngine.loadCornerImageWithoutPlaceHolder(this.imageView, str2, new g() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.CustomOrderMessageHolder.1
        ...
        this.msgContentFrame.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.CustomOrderMessageHolder.2
