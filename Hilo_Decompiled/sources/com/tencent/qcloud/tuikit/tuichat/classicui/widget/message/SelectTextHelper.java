...
public class SelectTextHelper {
    ...
    private final Runnable mShowSelectViewRunnable = new Runnable() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.2
    ...
    private void init() {
        ...
        this.mTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.l
        ...
        this.mTextView.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.m
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SelectTextHelper.this.lambda$init$1(view);
            }
        });
        this.mTextView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.1
            private void onLongTextViewClick() {
                SelectTextHelper.this.mTextView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.1.1
                ...
                SelectTextHelper.this.mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.1.2
                ...
                SelectTextHelper.this.mRootTouchListener = new View.OnTouchListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.1.3
                    @Override // android.view.View.OnTouchListener
                ...
                SelectTextHelper.this.mOnScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.SelectTextHelper.1.4
