...
public class QuoteMessageHolder extends TextMessageHolder {
                            ...
                            if (!this.downloadEles.contains(imageBean.getUUID())) {
                                ...
                                imageBean.downloadImage(generateImagePath, new ImageMessageBean.ImageBean.ImageDownloadCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.QuoteMessageHolder.3
                                    ...
                                    public void onSuccess() {
                                        ...
                                        GlideEngine.loadCornerImageWithoutPlaceHolder(QuoteMessageHolder.this.imageIv, imageMessageBean.getDataPath(), new g() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.QuoteMessageHolder.3.1
    ...
    public void layoutVariableViews(TUIMessageBean tUIMessageBean, final int i) {
        ...
        this.msgArea.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.QuoteMessageHolder.1
        ...
        this.quoteContentFrameLayout.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.viewholder.QuoteMessageHolder.2
