...
class PreviewState implements State {
    ...
    @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.state.State
    ...
    @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.state.State
    public void capture() {
        CameraInterface.getInstance().takePicture(new CameraInterface.TakePictureCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.state.PreviewState.1
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.view.CameraInterface.TakePictureCallback
    ...
    public void stopRecord(final boolean z, long j) {
        CameraInterface.getInstance().stopRecord(z, new CameraInterface.StopRecordCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.state.PreviewState.2
            @Override // com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.view.CameraInterface.StopRecordCallback
