...
public class VideoReplyQuoteView extends ImageReplyQuoteView {
    ...
    @Override // com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.reply.ImageReplyQuoteView, com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.reply.TUIReplyQuoteView
    public void onDrawReplyQuote(TUIReplyQuoteBean tUIReplyQuoteBean) {
        ...
        videoMessageBean.downloadSnapshot(str, new VideoMessageBean.VideoDownloadCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.widget.message.reply.VideoReplyQuoteView.1
