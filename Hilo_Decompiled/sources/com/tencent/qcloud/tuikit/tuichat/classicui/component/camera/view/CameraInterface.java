...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.view.CameraInterface.1
    ...
    public void handleFocus(final Context context, final float f, final float f2, final FocusCallback focusCallback) {
        ...
        if (parameters.getMaxNumFocusAreas() > 0) {
            ...
            try {
                ...
                this.mCamera.autoFocus(new Camera.AutoFocusCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.view.CameraInterface.3
    ...
    public void takePicture(final TakePictureCallback takePictureCallback) {
        ...
        this.mCamera.takePicture(null, null, new Camera.PictureCallback() { // from class: com.tencent.qcloud.tuikit.tuichat.classicui.component.camera.view.CameraInterface.2
