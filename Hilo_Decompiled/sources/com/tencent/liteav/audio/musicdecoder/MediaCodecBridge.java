    ...
    public ByteBuffer processFrame() {
        ...
        try {
            ...
            if (i <= 0) {
                ...
                this.mRawDataSize += i;
                this.mMediaCodec.queueInputBuffer(dequeueInputBuffer, 0, i, this.mMediaExtractor.getSampleTime(), 0);
    ...
    public void setMusicTrack(int i) {
        ...
        try {
            ...
            try {
                ...
                Log.e(TAG, "Failed to stop media codec: " + th2.getMessage(), th2);
            }
        } catch (Throwable th3) {
            Log.e(TAG, "Failed to unselect track: " + th3.getMessage(), th3);
        }
    }
