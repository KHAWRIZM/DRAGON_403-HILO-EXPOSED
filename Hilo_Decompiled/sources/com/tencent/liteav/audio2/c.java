...
public final class c extends AudioManager.AudioPlaybackCallback {
    ...
    public c() {
        ...
        if (LiteavSystemInfo.getSystemOSVersionInt() >= 26 && (audioManager = (AudioManager) ContextUtils.getApplicationContext().getSystemService(TUIConstants.TUICalling.TYPE_AUDIO)) != null) {
            try {
