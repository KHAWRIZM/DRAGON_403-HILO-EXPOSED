...
public enum f {
    ...
    STATUS_VIDEO_RENDER_RESOLUTION(RoomEvent.ROOM_BACK_GROUP_UPDATE),
    STATUS_VIDEO_CONSUMER_RECEIVE_FPS(RoomEvent.ROOM_MUSIC_ADD),
    ...
    STATUS_VIDEO_PREPROCESS_TIME(HonorResultCode.ADVANCED_RECORD_SUCCESS),
    STATUS_VIDEO_PREPROCESS_BEAUTY_SETTINGS(2001),
    STATUS_VIDEO_CUSTOM_PREPROCESS_AVERAGE_COST(2002),
    STATUS_VIDEO_ENCODER_TYPE(HonorResultCode.AUDIO_PLAY_SERVICE_SUCCESS),
