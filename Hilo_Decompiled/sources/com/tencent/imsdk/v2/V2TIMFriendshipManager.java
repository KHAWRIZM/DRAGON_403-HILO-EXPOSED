...
public abstract class V2TIMFriendshipManager {
    ...
    public abstract void acceptFriendApplication(V2TIMFriendApplication v2TIMFriendApplication, int i, String str, V2TIMValueCallback<V2TIMFriendOperationResult> v2TIMValueCallback);
    ...
    public abstract void checkFollowType(List<String> list, V2TIMValueCallback<List<V2TIMFollowTypeCheckResult>> v2TIMValueCallback);

    public abstract void checkFriend(List<String> list, int i, V2TIMValueCallback<List<V2TIMFriendCheckResult>> v2TIMValueCallback);
    ...
    public abstract void followUser(List<String> list, V2TIMValueCallback<List<V2TIMFollowOperationResult>> v2TIMValueCallback);
    ...
    public abstract void getMutualFollowersList(String str, V2TIMValueCallback<V2TIMUserInfoResult> v2TIMValueCallback);

    public abstract void getMyFollowersList(String str, V2TIMValueCallback<V2TIMUserInfoResult> v2TIMValueCallback);

    public abstract void getMyFollowingList(String str, V2TIMValueCallback<V2TIMUserInfoResult> v2TIMValueCallback);

    public abstract void getOfficialAccountsInfo(List<String> list, V2TIMValueCallback<List<V2TIMOfficialAccountInfoResult>> v2TIMValueCallback);

    public abstract void getUserFollowInfo(List<String> list, V2TIMValueCallback<List<V2TIMFollowInfo>> v2TIMValueCallback);
    ...
    public abstract void subscribeOfficialAccount(String str, V2TIMCallback v2TIMCallback);

    public abstract void unfollowUser(List<String> list, V2TIMValueCallback<List<V2TIMFollowOperationResult>> v2TIMValueCallback);

    public abstract void unsubscribeOfficialAccount(String str, V2TIMCallback v2TIMCallback);
}
