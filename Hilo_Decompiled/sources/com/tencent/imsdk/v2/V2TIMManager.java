...
public abstract class V2TIMManager {
    ...
    public static V2TIMCommunityManager getCommunityManager() {
        return V2TIMCommunityManager.getInstance();
    }
    ...
    public abstract void addGroupListener(V2TIMGroupListener v2TIMGroupListener);

    public abstract void addIMSDKListener(V2TIMSDKListener v2TIMSDKListener);

    public abstract void addSimpleMsgListener(V2TIMSimpleMsgListener v2TIMSimpleMsgListener);

    public abstract void callExperimentalAPI(String str, Object obj, V2TIMValueCallback<Object> v2TIMValueCallback);
    ...
    public abstract void removeGroupListener(V2TIMGroupListener v2TIMGroupListener);

    public abstract void removeIMSDKListener(V2TIMSDKListener v2TIMSDKListener);
    ...
    public abstract void setSelfStatus(V2TIMUserStatus v2TIMUserStatus, V2TIMCallback v2TIMCallback);

    public abstract void subscribeUserInfo(List<String> list, V2TIMCallback v2TIMCallback);

    public abstract void subscribeUserStatus(List<String> list, V2TIMCallback v2TIMCallback);

    public abstract void unInitSDK();

    public abstract void unsubscribeUserInfo(List<String> list, V2TIMCallback v2TIMCallback);
