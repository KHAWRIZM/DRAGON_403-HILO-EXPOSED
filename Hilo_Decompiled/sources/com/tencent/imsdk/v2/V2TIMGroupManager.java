...
public abstract class V2TIMGroupManager {
    ...
    public abstract void decreaseGroupCounter(String str, String str2, long j, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
    ...
    public abstract void getGroupCounters(String str, List<String> list, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
    ...
    public abstract void increaseGroupCounter(String str, String str2, long j, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
    ...
    public abstract void kickGroupMember(String str, List<String> list, String str2, int i, V2TIMValueCallback<List<V2TIMGroupMemberOperationResult>> v2TIMValueCallback);
    ...
    public abstract void markGroupMemberList(String str, List<String> list, int i, boolean z, V2TIMCallback v2TIMCallback);

    public abstract void muteAllGroupMembers(String str, boolean z, V2TIMCallback v2TIMCallback);
    ...
    public abstract void setGroupCounters(String str, HashMap<String, Long> hashMap, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
