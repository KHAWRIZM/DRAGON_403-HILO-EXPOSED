...
public class GroupTipsElement extends MessageBaseElement {
    ...
    public static final int GROUP_TIPS_TYPE_PINNED_MESSAGE_ADDED = 16;
    public static final int GROUP_TIPS_TYPE_PINNED_MESSAGE_DELETED = 17;
    public static final int GROUP_TIPS_TYPE_QUIT = 2;
    public static final int GROUP_TIPS_TYPE_REVOKE_ADMINISTRATOR = 5;
    public static final int GROUP_TIPS_TYPE_TOPIC_INFO_CHANGE = 8;
    private String groupID;
    private int groupJoinType;
    ...
    public int getGroupJoinType() {
        return this.groupJoinType;
    }
