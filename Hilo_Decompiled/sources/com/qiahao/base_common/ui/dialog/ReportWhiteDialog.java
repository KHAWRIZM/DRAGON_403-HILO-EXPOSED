...
public final class ReportWhiteDialog extends BaseBindingDialog<DialogWhiteReportBinding> {
    ...
    public int getLayoutResId() {
        return R.layout.dialog_white_report;
    }
    ...
    public void onInitialize() {
        super.onInitialize();
        getBinding().cancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.base_common.ui.dialog.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ReportWhiteDialog.this.dismiss();
            }
        });
        getBinding().confirmReportButton.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.base_common.ui.dialog.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ReportWhiteDialog.this.confirmButtonPressed();
            }
        });
    }

    @NotNull
    public final ReportWhiteDialog setListener(@NotNull ReportDialogListener reportDialogListener) {
