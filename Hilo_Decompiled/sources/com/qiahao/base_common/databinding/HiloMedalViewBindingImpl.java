...
public class HiloMedalViewBindingImpl extends HiloMedalViewBinding {
    ...
    public HiloMedalViewBindingImpl(f fVar, View view) {
    ...
    private HiloMedalViewBindingImpl(f fVar, View view, Object[] objArr) {
