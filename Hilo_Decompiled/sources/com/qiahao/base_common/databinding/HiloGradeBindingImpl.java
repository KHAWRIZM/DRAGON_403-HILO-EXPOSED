...
public class HiloGradeBindingImpl extends HiloGradeBinding {
    ...
    public HiloGradeBindingImpl(f fVar, View view) {
    ...
    private HiloGradeBindingImpl(f fVar, View view, Object[] objArr) {
