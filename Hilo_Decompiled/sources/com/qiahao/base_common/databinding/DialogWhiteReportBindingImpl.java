...
public class DialogWhiteReportBindingImpl extends DialogWhiteReportBinding {
    ...
    public DialogWhiteReportBindingImpl(f fVar, View view) {
    ...
    private DialogWhiteReportBindingImpl(f fVar, View view, Object[] objArr) {
