...
public class HiloMedalItemBindingImpl extends HiloMedalItemBinding {
    ...
    public HiloMedalItemBindingImpl(f fVar, View view) {
    ...
    private HiloMedalItemBindingImpl(f fVar, View view, Object[] objArr) {
