...
public class RoomCustomGiftBindingImpl extends RoomCustomGiftBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.receiver_user_name, 5);
        sparseIntArray.put(R.id.gift_pic, 6);
        sparseIntArray.put(R.id.text1, 7);
        sparseIntArray.put(R.id.gift_number, 8);
        sparseIntArray.put(R.id.stateLayout, 9);
        sparseIntArray.put(R.id.progress, 10);
        sparseIntArray.put(R.id.statusImg, 11);
    }

    public RoomCustomGiftBindingImpl(f fVar, View view) {
    ...
    private RoomCustomGiftBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (TextView) objArr[8], (ImageView) objArr[6], (ConstraintLayout) objArr[3], (ProgressBar) objArr[10], (TextView) objArr[5], (TextView) objArr[4], (ConstraintLayout) objArr[9], (ImageView) objArr[11], (TextView) objArr[7], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
