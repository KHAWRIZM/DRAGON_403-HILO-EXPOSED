...
public class RoomCustomCreateSudGameBindingImpl extends RoomCustomCreateSudGameBinding {
    ...
    public RoomCustomCreateSudGameBindingImpl(f fVar, View view) {
    ...
    private RoomCustomCreateSudGameBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (TextView) objArr[4], (ImageView) objArr[5], (ConstraintLayout) objArr[3], (ProgressBar) objArr[7], (ConstraintLayout) objArr[6], (ImageView) objArr[8], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
