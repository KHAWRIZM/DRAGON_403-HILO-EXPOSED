...
public class RoomCustomEnvolopeGetBindingImpl extends RoomCustomEnvolopeGetBinding {
    ...
    public RoomCustomEnvolopeGetBindingImpl(f fVar, View view) {
    ...
    private RoomCustomEnvolopeGetBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (ConstraintLayout) objArr[3], (ProgressBar) objArr[6], (ConstraintLayout) objArr[5], (ImageView) objArr[7], (TextView) objArr[4], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
