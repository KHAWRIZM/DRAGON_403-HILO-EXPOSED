...
public class RoomCustomRolledBindingImpl extends RoomCustomRolledBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tip_roller, 4);
        sparseIntArray.put(R.id.roller_number, 5);
        sparseIntArray.put(R.id.stateLayout, 6);
        sparseIntArray.put(R.id.progress, 7);
        sparseIntArray.put(R.id.statusImg, 8);
    }

    public RoomCustomRolledBindingImpl(f fVar, View view) {
    ...
    private RoomCustomRolledBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (ConstraintLayout) objArr[3], (ProgressBar) objArr[7], (LinearLayout) objArr[5], (ConstraintLayout) objArr[6], (ImageView) objArr[8], (TextView) objArr[4], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
