...
public class RoomCustomActivityBindingImpl extends RoomCustomActivityBinding {
    ...
    public RoomCustomActivityBindingImpl(f fVar, View view) {
    ...
    private RoomCustomActivityBindingImpl(f fVar, View view, Object[] objArr) {
