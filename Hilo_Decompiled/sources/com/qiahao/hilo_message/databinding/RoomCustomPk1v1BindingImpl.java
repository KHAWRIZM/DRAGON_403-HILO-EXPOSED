...
public class RoomCustomPk1v1BindingImpl extends RoomCustomPk1v1Binding {
    ...
    public RoomCustomPk1v1BindingImpl(f fVar, View view) {
    ...
    private RoomCustomPk1v1BindingImpl(f fVar, View view, Object[] objArr) {
