...
public class RoomMessageTextBindingImpl extends RoomMessageTextBinding {
    ...
    public RoomMessageTextBindingImpl(f fVar, View view) {
    ...
    private RoomMessageTextBindingImpl(f fVar, View view, Object[] objArr) {
