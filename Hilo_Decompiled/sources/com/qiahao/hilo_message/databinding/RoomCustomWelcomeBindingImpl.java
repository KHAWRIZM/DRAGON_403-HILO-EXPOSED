...
public class RoomCustomWelcomeBindingImpl extends RoomCustomWelcomeBinding {
    ...
    public RoomCustomWelcomeBindingImpl(f fVar, View view) {
    ...
    private RoomCustomWelcomeBindingImpl(f fVar, View view, Object[] objArr) {
