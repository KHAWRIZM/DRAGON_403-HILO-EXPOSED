...
public class RoomCustomMatchGameBindingImpl extends RoomCustomMatchGameBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.gameImage, 4);
    ...
    public RoomCustomMatchGameBindingImpl(f fVar, View view) {
    ...
    private RoomCustomMatchGameBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (TextView) objArr[5], (ImageView) objArr[4], (ImageView) objArr[6], (ConstraintLayout) objArr[3], (ProgressBar) objArr[8], (ConstraintLayout) objArr[7], (ImageView) objArr[9], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
