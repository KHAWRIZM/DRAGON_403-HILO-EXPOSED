...
public class RoomCustomTipBindingImpl extends RoomCustomTipBinding {
    ...
    public RoomCustomTipBindingImpl(f fVar, View view) {
    ...
    private RoomCustomTipBindingImpl(f fVar, View view, Object[] objArr) {
