...
public class RoomCustomReceiveEnvolopeBindingImpl extends RoomCustomReceiveEnvolopeBinding {
    ...
    public RoomCustomReceiveEnvolopeBindingImpl(f fVar, View view) {
    ...
    private RoomCustomReceiveEnvolopeBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (QMUIRadiusImageView) objArr[2], (ImageView) objArr[4], (ConstraintLayout) objArr[3], (ProgressBar) objArr[7], (ConstraintLayout) objArr[6], (ImageView) objArr[8], (TextView) objArr[5], (IncludeMessageTitleBinding) objArr[1]);
        this.mDirtyFlags = -1L;
