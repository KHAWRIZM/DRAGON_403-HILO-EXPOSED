...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0015\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u0018\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\u001a\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0012\u001a\u0004\u0018\u00010\u000bH\u0016J\u001a\u0010\u0013\u001a\u00020\u00112\u0006\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0012\u001a\u0004\u0018\u00010\u000bH\u0016R \u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\u0006¨\u0006\u0014"}, d2 = {"Lcom/qiahao/nextvideo/room/adapter/RoomInfoDialogTabLayoutAdapter;", "Lcom/oudi/widget/ViewPage2TabLayout$CustomTabAdapter;", "list", "", "", "<init>", "(Ljava/util/List;)V", "getList", "()Ljava/util/List;", "setList", "getTabView", "Landroid/view/View;", "context", "Landroid/content/Context;", "position", "", "onTabSelected", "", "tabView", "onTabUnselected", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nRoomInfoDialogTabLayoutAdapter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RoomInfoDialogTabLayoutAdapter.kt\ncom/qiahao/nextvideo/room/adapter/RoomInfoDialogTabLayoutAdapter\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,53:1\n1#2:54\n*E\n"})
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class RoomInfoDialogTabLayoutAdapter implements ViewPage2TabLayout.CustomTabAdapter {

    @NotNull
    private List<String> list;

    public RoomInfoDialogTabLayoutAdapter(@NotNull List<String> list) {
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        if (tabView != null && (textView = (TextView) tabView.findViewById(2131365073)) != null) {
            ...
            if (currentActivity != null) {
                textView.setTextColor(ResourcesKtxKt.getColorById(currentActivity, 2131101214));
            }
        }
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        if (tabView != null && (textView = (TextView) tabView.findViewById(2131365073)) != null) {
            ...
            Activity currentActivity = ActivityLifecycleManager.INSTANCE.currentActivity();
            if (currentActivity != null) {
                textView.setTextColor(ResourcesKtxKt.getColorById(currentActivity, 2131099906));
            }
        }
    }
