...
import com.qiahao.nextvideo.databinding.DialogCreateNuoBinding;
...
public final class CreateUnoDialog extends BaseBindingDialog<DialogCreateNuoBinding> {
    ...
    public /* synthetic */ CreateUnoDialog(Context context, CreateSudData createSudData, String str, GameConfigLudo gameConfigLudo, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void checkDiamond() {
        ...
        if (i2 == 0) {
            ImageView imageView = ((DialogCreateNuoBinding) getBinding()).minus;
            ...
            if (i2 != i - 1) {
                str = "minus";
                ImageView imageView2 = ((DialogCreateNuoBinding) getBinding()).minus;
                ...
                ImageView imageView3 = ((DialogCreateNuoBinding) getBinding()).add;
                ...
                ImageView imageView4 = ((DialogCreateNuoBinding) getBinding()).add;
        ...
        if (!this.isCreateGem) {
            ImageView imageView5 = ((DialogCreateNuoBinding) getBinding()).minus;
            ...
            ImageView imageView6 = ((DialogCreateNuoBinding) getBinding()).add;
        ...
        TextView textView = ((DialogCreateNuoBinding) getBinding()).diamondText;
    ...
    private final void confirmCreate() {
        ...
        ArrayList<Integer> diamond;
        Integer num;
        if (((DialogCreateNuoBinding) getBinding()).autoMatch.isSelected()) {
        ...
        RxUtilsKt.addTo(RxUtilsKt.observeOnMainThread$default(apis.editSud(j, i, i2, i3, i4, i5, str), new Function1() { // from class: com.qiahao.nextvideo.room.game.w
            public final Object invoke(Object obj) {
                Unit confirmCreate$lambda$4;
                confirmCreate$lambda$4 = CreateUnoDialog.confirmCreate$lambda$4(CreateUnoDialog.this, (ApiResponse) obj);
                return confirmCreate$lambda$4;
            }
        }, new Function1() { // from class: com.qiahao.nextvideo.room.game.x
            public final Object invoke(Object obj) {
                Unit confirmCreate$lambda$5;
                confirmCreate$lambda$5 = CreateUnoDialog.confirmCreate$lambda$5(CreateUnoDialog.this, (Throwable) obj);
    ...
    public static final Unit confirmCreate$lambda$4(CreateUnoDialog createUnoDialog, ApiResponse apiResponse) {
    ...
    public static final Unit confirmCreate$lambda$5(CreateUnoDialog createUnoDialog, Throwable th) {
        String str;
        Intrinsics.checkNotNullParameter(th, "it");
        if (th instanceof HiloException) {
            HiloToasty.Companion companion = HiloToasty.Companion;
            Context context = createUnoDialog.getContext();
            String errorMessage = ((HiloException) th).getErrorMessage();
            if (errorMessage == null) {
                str = ResourcesKtxKt.getStringById(createUnoDialog, 2131952667);
            } else {
                str = errorMessage;
            }
            ...
            Toast normal$default2 = HiloToasty.Companion.normal$default(HiloToasty.Companion, createUnoDialog.getContext(), ResourcesKtxKt.getStringById(createUnoDialog, 2131952667), false, 4, (Object) null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onInitialize$lambda$0(CreateUnoDialog createUnoDialog, View view) {
        int i;
        ArrayList<Integer> diamond;
        ArrayList<Integer> diamond2;
        int i2 = 0;
        switch (view.getId()) {
            case 2131361922:
                if (!createUnoDialog.isCreateGem) {
                    return;
                }
                int i3 = createUnoDialog.mPosition;
                GameConfigLudo gameConfigLudo = createUnoDialog.gameConfig;
                ...
                if (i3 >= i - 1) {
                    GameConfigLudo gameConfigLudo2 = createUnoDialog.gameConfig;
                    if (gameConfigLudo2 != null && (diamond = gameConfigLudo2.getDiamond()) != null) {
                        i2 = diamond.size();
                    }
                    createUnoDialog.mPosition = i2 - 1;
                } else {
                    createUnoDialog.mPosition++;
                }
                createUnoDialog.checkDiamond();
                return;
            case R.id.autoMatch /* 2131362008 */:
            case R.id.autoText /* 2131362009 */:
                ((DialogCreateNuoBinding) createUnoDialog.getBinding()).autoMatch.setSelected(!((DialogCreateNuoBinding) createUnoDialog.getBinding()).autoMatch.isSelected());
                return;
            ...
            case R.id.createButton /* 2131362560 */:
                createUnoDialog.confirmCreate();
                return;
            case R.id.minus /* 2131363910 */:
                if (!createUnoDialog.isCreateGem) {
                    return;
                }
                int i4 = createUnoDialog.mPosition;
                if (i4 <= 0) {
                    createUnoDialog.mPosition = 0;
                } else {
                    createUnoDialog.mPosition = i4 - 1;
                }
                createUnoDialog.checkDiamond();
                return;
            default:
    ...
    protected int getLayoutResId() {
        return R.layout.dialog_create_nuo;
    }
    ...
    public void onInitialize() {
        ...
        ((DialogCreateNuoBinding) getBinding()).setClick(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.game.v
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CreateUnoDialog.onInitialize$lambda$0(CreateUnoDialog.this, view);
            }
        });
        ConstraintLayout constraintLayout = ((DialogCreateNuoBinding) getBinding()).moneyLayout;
        GameConfigLudo gameConfigLudo = this.gameConfig;
        int i2 = 0;
        ...
        TextView textView = ((DialogCreateNuoBinding) getBinding()).bet;
        GameConfigLudo gameConfigLudo2 = this.gameConfig;
        ...
        if (this.createLudoData == null) {
            this.createLudoData = new CreateSudData(2, 0, 0, 0, 0, 0, MeetingRoomManager.INSTANCE.getMGroupId(), null, UserProxyUtility.roomLeave, null);
            this.isCreateGem = true;
            ((DialogCreateNuoBinding) getBinding()).createButton.setText(ResourcesKtxKt.getStringById(this, 2131952331));
        }
        CreateSudData createSudData = this.createLudoData;
        if (createSudData != null) {
            ImageView imageView = ((DialogCreateNuoBinding) getBinding()).autoMatch;
    ...
    public CreateUnoDialog(@NotNull Context context, @Nullable CreateSudData createSudData, @Nullable String str, @Nullable GameConfigLudo gameConfigLudo) {
        super(context);
