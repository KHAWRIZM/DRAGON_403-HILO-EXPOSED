...
@DebugMetadata(c = "com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initObserve$3", f = "GameRoomFragmentHelp.kt", i = {}, l = {1189}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class GameRoomFragmentHelp$initObserve$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    ...
    @DebugMetadata(c = "com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initObserve$3$1", f = "GameRoomFragmentHelp.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initObserve$3$1, reason: invalid class name */
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
    ...
    public GameRoomFragmentHelp$initObserve$3(GameRoomFragmentHelp gameRoomFragmentHelp, Continuation<? super GameRoomFragmentHelp$initObserve$3> continuation) {
        super(2, continuation);
        this.this$0 = gameRoomFragmentHelp;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GameRoomFragmentHelp$initObserve$3(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            Flow flow = FlowKt.m١٩٠catch(FlowKt.sample(FlowKt.conflate(MeetingRoomManager.INSTANCE.getWsFlowGift()), 5L), new AnonymousClass1(null));
            final GameRoomFragmentHelp gameRoomFragmentHelp = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initObserve$3.2
                ...
                public final Object emit(RoomEvent roomEvent, Continuation<? super Unit> continuation) {
                    ...
                    if (mEventId != 602) {
                        if (mEventId == 603 && (roomEvent.getEventData() instanceof MeetingRoomReceiveGiftCustomContent)) {
                            ...
                            GameRoomFragmentHelp.this.getMGiftSourceBeanList().add(meetingRoomReceiveGiftCustomContent);
                            if (!GameRoomFragmentHelp.this.getMIsGiftTraverseing()) {
                                GameRoomFragmentHelp.this.setMIsGiftTraverseing(true);
                                Handler mHandler = GameRoomFragmentHelp.this.getMHandler();
                                if (mHandler != null) {
                        ...
                        MeetingRoomReceiveGiftCustomContent meetingRoomReceiveGiftCustomContent2 = (MeetingRoomReceiveGiftCustomContent) new com.google.gson.d().j(roomEvent.getMGiftContent(), MeetingRoomReceiveGiftCustomContent.class);
                        ...
                        GameRoomFragmentHelp.this.getMGiftSourceBeanList().add(meetingRoomReceiveGiftCustomContent2);
                        if (!GameRoomFragmentHelp.this.getMIsGiftTraverseing()) {
                            GameRoomFragmentHelp.this.setMIsGiftTraverseing(true);
                            Handler mHandler2 = GameRoomFragmentHelp.this.getMHandler();
                            if (mHandler2 != null) {
