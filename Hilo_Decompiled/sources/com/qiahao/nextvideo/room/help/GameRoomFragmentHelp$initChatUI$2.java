...
@Metadata(d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0000\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016J\u0012\u0010\u0006\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016J\u001a\u0010\u0007\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0016¨\u0006\f"}, d2 = {"com/qiahao/nextvideo/room/help/GameRoomFragmentHelp$initChatUI$2", "Lcom/qiahao/hilo_message/listener/RoomMessageItemListener;", "onUserIconClick", "", "messageInfo", "Lcom/qiahao/hilo_message/data/RoomMessageMulti;", "onResendMessage", "onType", "type", "", "data", "", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class GameRoomFragmentHelp$initChatUI$2 implements RoomMessageItemListener {
    final /* synthetic */ GameRoomFragmentHelp this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public GameRoomFragmentHelp$initChatUI$2(GameRoomFragmentHelp gameRoomFragmentHelp) {
        this.this$0 = gameRoomFragmentHelp;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onType$lambda$1(GameRoomFragmentHelp gameRoomFragmentHelp, GameRoomFragmentHelp$initChatUI$2 gameRoomFragmentHelp$initChatUI$2, Throwable th) {
        Intrinsics.checkNotNullParameter(th, "it");
        if (th instanceof HiloException) {
            HiloToasty.Companion companion = HiloToasty.Companion;
            Context context = gameRoomFragmentHelp.getFragment().getContext();
            String errorMessage = ((HiloException) th).getErrorMessage();
            if (errorMessage == null) {
                errorMessage = ResourcesKtxKt.getStringById(gameRoomFragmentHelp$initChatUI$2, 2131952667);
            }
    ...
    public void onResendMessage(final RoomMessageMulti messageInfo) {
        ...
        if (context != null) {
            ...
            new RoomTipDialog(context).setTipContent(ResourcesKtxKt.getStringById(this, 2131953917)).setDialogListener(new OnCommonDialogListener() { // from class: com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1
                public void cancel() {
                ...
                public void confirm() {
                    Integer num;
                    final GameRoomFragmentHelp gameRoomFragmentHelp2 = gameRoomFragmentHelp;
                    VideoUploadManager.UploadCallback uploadCallback = new VideoUploadManager.UploadCallback() { // from class: com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1$confirm$listener$1
                        ...
                        public Object addMessageLocal(RoomMessageMulti roomMessageMulti, Continuation<? super Unit> continuation) {
                            return BuildersKt.withContext(Dispatchers.getMain(), new GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1$confirm$listener$1$addMessageLocal$2(GameRoomFragmentHelp.this, roomMessageMulti, null), continuation);
                        }
                        ...
                        public Object refreshLocalMessage(RoomMessageMulti roomMessageMulti, Continuation<? super Unit> continuation) {
                            return BuildersKt.withContext(Dispatchers.getMain(), new GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1$confirm$listener$1$refreshLocalMessage$2(GameRoomFragmentHelp.this, roomMessageMulti, null), continuation);
                        }

                        @Override // com.qiahao.nextvideo.room.help.VideoUploadManager.UploadCallback
                        public Object onUploadFailed(RoomMessageMulti roomMessageMulti, Exception exc, Continuation<? super Unit> continuation) {
                            return BuildersKt.withContext(Dispatchers.getMain(), new GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1$confirm$listener$1$onUploadFailed$2(GameRoomFragmentHelp.this, roomMessageMulti, null), continuation);
                        }
                        ...
                        public Object onUploadSuccess(RoomMessage.GroupMessageSend groupMessageSend, boolean z, Continuation<? super Unit> continuation) {
                            Object withContext = BuildersKt.withContext(Dispatchers.getMain(), new GameRoomFragmentHelp$initChatUI$2$onResendMessage$1$1$confirm$listener$1$onUploadSuccess$2(GameRoomFragmentHelp.this, groupMessageSend, z, null), continuation);
                    ...
                    if (num != null && num.intValue() == 1) {
                        ...
                        RoomMessageView mChatLayout = gameRoomFragmentHelp.getFragment().getMChatLayout();
                        if (mChatLayout != null) {
                            mChatLayout.refreshMessageStatus(messageInfo);
                        }
                        RoomMessageUtil.INSTANCE.sendMessage(gameRoomFragmentHelp.getFragment().getMChatLayout(), BuildMessageUtilsKt.toGroupMessageSend(messageInfo), false);
                        return;
                    }
    ...
    public void onType(int type, final Object data) {
        ...
        if (type != 3) {
            if (type != 5) {
                if (type == 6 && (data instanceof Long)) {
                    ...
                    final GameRoomFragmentHelp gameRoomFragmentHelp = this.this$0;
                    mViewModel.getEnvelopeInfo(longValue, new Function1() { // from class: com.qiahao.nextvideo.room.help.i6
                        public final Object invoke(Object obj) {
                            Unit onType$lambda$1;
                            onType$lambda$1 = GameRoomFragmentHelp$initChatUI$2.onType$lambda$1(GameRoomFragmentHelp.this, this, (Throwable) obj);
            ...
            if ((data instanceof String) && (mGameHelp = this.this$0.getFragment().getMGameHelp()) != null) {
                String str = (String) data;
                mGameHelp.showUserInfoDialog(str, MeetingRoomManager.INSTANCE.findMicPositionFromExtraId(str));
                return;
            }
            return;
        }
        ...
        if (activity != null) {
            ...
            if (!activity.isFinishing() && !activity.isDestroyed()) {
                ...
                iMMessageClickBottomDialog.setClickListener(new IMMessageListener() { // from class: com.qiahao.nextvideo.room.help.GameRoomFragmentHelp$initChatUI$2$onType$2$2
    ...
    public void onUserIconClick(RoomMessageMulti messageInfo) {
        ...
        if (mGameHelp != null) {
            ...
            mGameHelp.showUserInfoDialog(str, meetingRoomManager.findMicPositionFromExtraId(str2));
        }
    }
