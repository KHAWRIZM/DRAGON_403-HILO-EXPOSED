...
import com.qiahao.nextvideo.databinding.ItemSmallMicroViewBinding;
...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0002\u0018\u0000 \u001c2\u00020\u0001:\u0001\u001cB\u0011\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005B\u001b\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007¢\u0006\u0004\b\u0004\u0010\bJ\b\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0011\u001a\u00020\u0010H\u0016J\b\u0010\u0012\u001a\u00020\u0010H\u0016J\b\u0010\u0013\u001a\u00020\u0010H\u0016J\u0010\u0010\u0014\u001a\u00020\u00102\u0006\u0010\u0015\u001a\u00020\u0016H\u0002J\u0010\u0010\u0017\u001a\u00020\u00102\u0006\u0010\u0015\u001a\u00020\u0016H\u0002J\b\u0010\u0018\u001a\u00020\u0010H\u0016J\u0010\u0010\u0019\u001a\u00020\u00102\u0006\u0010\u001a\u001a\u00020\u001bH\u0016R\u001a\u0010\t\u001a\u00020\nX\u0086.¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000e¨\u0006\u001d"}, d2 = {"Lcom/qiahao/nextvideo/room/view/micro/SmallItemMicroView;", "Lcom/qiahao/nextvideo/room/view/micro/BaseItemMicroView;", "context", "Landroid/content/Context;", "<init>", "(Landroid/content/Context;)V", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "mDataBinding", "Lcom/qiahao/nextvideo/databinding/ItemSmallMicroViewBinding;", "getMDataBinding", "()Lcom/qiahao/nextvideo/databinding/ItemSmallMicroViewBinding;", "setMDataBinding", "(Lcom/qiahao/nextvideo/databinding/ItemSmallMicroViewBinding;)V", "initView", "", "updateView", "stopMicSVGA", "recoverMicSVGA", "playSvga", "micBean", "Lcom/qiahao/nextvideo/data/model/MicroBean;", "playCpSvga", "showMicSpeakWaveAnim", "showFaceSvga", "faceSVGAUrl", "", "Companion", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nSmallItemMicroView.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SmallItemMicroView.kt\ncom/qiahao/nextvideo/room/view/micro/SmallItemMicroView\n+ 2 View.kt\nandroidx/core/view/ViewKt\n*L\n1#1,412:1\n255#2:413\n*S KotlinDebug\n*F\n+ 1 SmallItemMicroView.kt\ncom/qiahao/nextvideo/room/view/micro/SmallItemMicroView\n*L\n118#1:413\n*E\n"})
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class SmallItemMicroView extends BaseItemMicroView {

    @NotNull
    private static final String TAG = "MiddleItemMicroView";
    public ItemSmallMicroViewBinding mDataBinding;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SmallItemMicroView(@NotNull Context context) {
        this(context, null);
    ...
    private final void playCpSvga(final MicroBean micBean) {
        ...
        try {
            ...
            shareParser.decodeFromURL(new URL(str2 + "?raw=true"), new SVGAParser.ParseCompletion() { // from class: com.qiahao.nextvideo.room.view.micro.SmallItemMicroView$playCpSvga$1
                public void onComplete(SVGAVideoEntity videoItem) {
                    String str3;
                    Intrinsics.checkNotNullParameter(videoItem, "videoItem");
                    SVGAImageView sVGAImageView = SmallItemMicroView.this.getMDataBinding().cpSvga;
                    ...
                    SmallItemMicroView.this.getMDataBinding().cpSvga.stopAnimation(true);
                    SmallItemMicroView.this.getMDataBinding().cpSvga.setImageDrawable(new SVGADrawable(videoItem));
                    SmallItemMicroView.this.getMDataBinding().cpSvga.startAnimation();
                }
    ...
    private final void playSvga(final MicroBean micBean) {
        ...
        try {
            SVGAParser.Companion.shareParser().decodeFromURL(new URL(micBean.getEffectUrl()), new SVGAParser.ParseCompletion() { // from class: com.qiahao.nextvideo.room.view.micro.SmallItemMicroView$playSvga$1
                public void onComplete(SVGAVideoEntity videoItem) {
                    String headwearIcon;
                    String str;
                    Intrinsics.checkNotNullParameter(videoItem, "videoItem");
                    SmallItemMicroView.this.getMDataBinding().micUserHeadSvga.setTag(micBean.getEffectUrl());
                    ...
                    SmallItemMicroView.this.getMDataBinding().micUserHeadSvga.stopAnimation(true);
                    SmallItemMicroView.this.getMDataBinding().micUserHeadSvga.setImageDrawable(new SVGADrawable(videoItem, sVGADynamicEntity));
                    SmallItemMicroView.this.getMDataBinding().micUserHeadSvga.startAnimation();
                }
    ...
    public static final void updateView$lambda$0(SmallItemMicroView smallItemMicroView, View view) {
        OnMicroItemClickListener mOnMicroItemClickListener = smallItemMicroView.getMOnMicroItemClickListener();
        if (mOnMicroItemClickListener != null) {
            mOnMicroItemClickListener.onMicroClick(smallItemMicroView.getMPosition(), smallItemMicroView.getMMicBean());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateView$lambda$1(SmallItemMicroView smallItemMicroView, View view) {
        OnMicroItemClickListener mOnMicroItemClickListener = smallItemMicroView.getMOnMicroItemClickListener();
        if (mOnMicroItemClickListener != null) {
            mOnMicroItemClickListener.onMicroClick(smallItemMicroView.getMPosition(), smallItemMicroView.getMMicBean());
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateView$lambda$10$lambda$9(SmallItemMicroView smallItemMicroView, SvipData svipData) {
        NickTextView nickTextView = smallItemMicroView.getMDataBinding().userName;
        String format = String.format(ResourcesKtxKt.getStringById(smallItemMicroView, 2131953504), Arrays.copyOf(new Object[]{svipData.mysteryNumber()}, 1));
        Intrinsics.checkNotNullExpressionValue(format, "format(...)");
        nickTextView.setText(format);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateView$lambda$2(SmallItemMicroView smallItemMicroView, View view) {
        OnMicroItemClickListener mOnMicroItemClickListener = smallItemMicroView.getMOnMicroItemClickListener();
        if (mOnMicroItemClickListener != null) {
            mOnMicroItemClickListener.onUnLockMic(smallItemMicroView.getMPosition(), smallItemMicroView.getMMicBean());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateView$lambda$4(SmallItemMicroView smallItemMicroView, View view) {
        OnMicroItemClickListener mOnMicroItemClickListener = smallItemMicroView.getMOnMicroItemClickListener();
        if (mOnMicroItemClickListener != null) {
            mOnMicroItemClickListener.onUnMuteAvatarClick(smallItemMicroView.getMPosition(), smallItemMicroView.getMMicBean());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateView$lambda$5(SmallItemMicroView smallItemMicroView, View view) {
        OnMicroItemClickListener mOnMicroItemClickListener = smallItemMicroView.getMOnMicroItemClickListener();
        if (mOnMicroItemClickListener != null) {
            mOnMicroItemClickListener.onAvatarBtnClick(smallItemMicroView.getMPosition(), smallItemMicroView.getMMicBean());
        }
    }

    @NotNull
    public final ItemSmallMicroViewBinding getMDataBinding() {
        ItemSmallMicroViewBinding itemSmallMicroViewBinding = this.mDataBinding;
        if (itemSmallMicroViewBinding != null) {
            return itemSmallMicroViewBinding;
        }
    ...
    public void initView() {
        setMDataBinding((ItemSmallMicroViewBinding) androidx.databinding.g.h(LayoutInflater.from(getContext()), R.layout.item_small_micro_view, this, true));
    }
    ...
    public final void setMDataBinding(@NotNull ItemSmallMicroViewBinding itemSmallMicroViewBinding) {
        Intrinsics.checkNotNullParameter(itemSmallMicroViewBinding, "<set-?>");
        this.mDataBinding = itemSmallMicroViewBinding;
    }
    ...
    public void showFaceSvga(@NotNull String faceSVGAUrl) {
        ...
        try {
            SVGAParser.Companion.shareParser().decodeFromURL(new URL(faceSVGAUrl + "?raw=true"), new SVGAParser.ParseCompletion() { // from class: com.qiahao.nextvideo.room.view.micro.SmallItemMicroView$showFaceSvga$1
                public void onComplete(SVGAVideoEntity videoItem) {
                    Intrinsics.checkNotNullParameter(videoItem, "videoItem");
                    SmallItemMicroView.this.getMDataBinding().faceSvga.setVideoItem(videoItem);
                    SmallItemMicroView.this.getMDataBinding().faceSvga.startAnimation();
                }

                public void onError() {
                    Log.d("MiddleItemMicroView", "onError: ----------");
                }
            });
        } catch (Exception e) {
    ...
    */
    public void updateView() {
        ...
        if (getMMicBean() == null) {
            ...
            getMDataBinding().baseMicro.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.view.micro.c0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SmallItemMicroView.updateView$lambda$0(SmallItemMicroView.this, view);
                }
            });
            return;
        }
        ...
        getMDataBinding().userMute.setVisibility(8);
        getMDataBinding().baseMicro.setVisibility(0);
        getMDataBinding().baseMicro.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.view.micro.d0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SmallItemMicroView.updateView$lambda$1(SmallItemMicroView.this, view);
            }
        });
        ...
        if (mMicBean8 != null && mMicBean8.getLock()) {
            ...
            getMDataBinding().lockMicro.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.view.micro.e0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SmallItemMicroView.updateView$lambda$2(SmallItemMicroView.this, view);
                }
            });
            getMDataBinding().userInfoLinearLayout.setVisibility(0);
            getMDataBinding().userTag.setVisibility(8);
        ...
        if ((mMicBean9 != null ? mMicBean9.getUser() : null) != null) {
            ...
            String nick = (mMicBean11 == null || (user15 = mMicBean11.getUser()) == null) ? null : user15.getNick();
            ...
            nickTextView2.setSVipAndNoble(nick, svipLevel, (mMicBean13 == null || (user13 = mMicBean13.getUser()) == null) ? 0 : user13.getNoble());
            ...
            if (mMicBean19 != null ? Intrinsics.areEqual(mMicBean19.getForbid(), Boolean.TRUE) : false) {
                ...
                if (Intrinsics.areEqual(externalId2, user20 != null ? user20.getExternalId() : null)) {
                    ...
                    getMDataBinding().userMute.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.view.micro.f0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            SmallItemMicroView.updateView$lambda$4(SmallItemMicroView.this, view);
                        }
                    });
                    ...
                    getMDataBinding().userAvatar.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.room.view.micro.g0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            SmallItemMicroView.updateView$lambda$5(SmallItemMicroView.this, view);
                        }
                    });
                    ...
                    if (mMicBean3 != null && (user3 = mMicBean3.getUser()) != null && (svip = user3.getSvip()) != null && svip.isMystery()) {
                        ...
                        getMDataBinding().userName.postDelayed(new Runnable() { // from class: com.qiahao.nextvideo.room.view.micro.h0
                            @Override // java.lang.Runnable
                            public final void run() {
                                SmallItemMicroView.updateView$lambda$10$lambda$9(SmallItemMicroView.this, svip);
                            }
                        }, 100L);
                        getMDataBinding().micUserHeadSvga.setVisibility(8);
                        getMDataBinding().micUserHeadImg.setVisibility(8);
    ...
    public SmallItemMicroView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
