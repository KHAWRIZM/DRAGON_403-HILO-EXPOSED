...
public final class RoomRecordTitleAdapter implements ViewPage2TabLayout.CustomTabAdapter {
    ...
    public static final ArrayList tabList_delegate$lambda$1() {
        ...
        arrayList.add(companion.initRoomRecord(ResourcesKtxKt.getStringById(arrayList, 2131953180)));
        arrayList.add(companion.initRoomRecord(ResourcesKtxKt.getStringById(arrayList, 2131953181)));
        return arrayList;
    }
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new RoomRecordView(context, getTabList().get(position));
    }
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.room.record.RoomRecordView");
        ((RoomRecordView) tabView).setSelected(true);
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.room.record.RoomRecordView");
        ((RoomRecordView) tabView).setSelected(false);
    }
}
