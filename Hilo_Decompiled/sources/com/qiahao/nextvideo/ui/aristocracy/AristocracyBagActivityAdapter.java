...
import com.qiahao.nextvideo.ui.task.TaskBagView;
...
public final class AristocracyBagActivityAdapter implements ViewPage2TabLayout.CustomTabAdapter {
    ...
    public static final ArrayList tabList_delegate$lambda$1() {
        ...
        arrayList.add(companion.initVip(ResourcesKtxKt.getStringById(arrayList, 2131954448)));
        arrayList.add(companion.initVip(ResourcesKtxKt.getStringById(arrayList, 2131954447)));
        return arrayList;
    }
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new TaskBagView(context, getTabList().get(position));
    }
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.task.TaskBagView");
        ((TaskBagView) tabView).setSelected(true);
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.task.TaskBagView");
        ((TaskBagView) tabView).setSelected(false);
    }
}
