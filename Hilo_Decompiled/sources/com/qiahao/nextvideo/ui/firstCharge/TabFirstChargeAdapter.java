...
public final class TabFirstChargeAdapter implements ViewPage2TabLayout.CustomTabAdapter {
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new FirstChargeTabView(context, this.tabList.get(position));
    }
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.firstCharge.FirstChargeTabView");
        ((FirstChargeTabView) tabView).setSelected(true);
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.firstCharge.FirstChargeTabView");
        ((FirstChargeTabView) tabView).setSelected(false);
    }
}
