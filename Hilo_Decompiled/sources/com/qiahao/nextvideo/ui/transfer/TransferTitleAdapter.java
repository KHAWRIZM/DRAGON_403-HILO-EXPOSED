...
public final class TransferTitleAdapter implements ViewPage2TabLayout.CustomTabAdapter {
    ...
    public static final ArrayList tabList_delegate$lambda$1() {
        ...
        arrayList.add(companion.initTransfer(ResourcesKtxKt.getStringById(arrayList, 2131952567)));
        arrayList.add(companion.initTransfer(ResourcesKtxKt.getStringById(arrayList, 2131952860)));
        return arrayList;
    }
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new TransferTitleView(context, getTabList().get(position));
    }
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.transfer.TransferTitleView");
        ((TransferTitleView) tabView).setSelected(true);
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.transfer.TransferTitleView");
        ((TransferTitleView) tabView).setSelected(false);
    }
}
