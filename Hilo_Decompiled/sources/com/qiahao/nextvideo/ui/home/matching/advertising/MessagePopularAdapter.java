...
public final class MessagePopularAdapter extends e {
    ...
    public int getLayoutId(int viewType) {
        return R.layout.item_message_popular;
    }
    ...
    public void bindData(@NotNull f holder, @NotNull final VideoBaseData data, int position, int pageSize) {
        ...
        RoundedImageView findViewById = ((RecyclerView.ViewHolder) holder).itemView.findViewById(R.id.imgPic);
        ...
        final long j = 800;
        view.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.ui.home.matching.advertising.MessagePopularAdapter$bindData$$inlined$singleClick$default$1
