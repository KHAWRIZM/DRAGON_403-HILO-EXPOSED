...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0010\u0000\n\u0000\u0018\u00002\u0014\u0012\u0004\u0012\u00020\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0001B\u0007¢\u0006\u0004\b\u0005\u0010\u0006J\u001e\u0010\u0007\u001a\u00020\b2\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\u0006\u0010\n\u001a\u00020\u0002H\u0014J,\u0010\u0007\u001a\u00020\b2\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\u0006\u0010\n\u001a\u00020\u00022\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\r0\fH\u0014¨\u0006\u000e"}, d2 = {"Lcom/qiahao/nextvideo/ui/home/onlinefeed/GoddessAdapter;", "Lcom/chad/library/adapter/base/BaseQuickAdapter;", "Lcom/qiahao/nextvideo/data/model/VideoBaseData;", "Lcom/chad/library/adapter/base/viewholder/BaseDataBindingHolder;", "Lcom/qiahao/nextvideo/databinding/ItemVideoBinding;", "<init>", "()V", "convert", "", "holder", "item", "payloads", "", "", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nGoddessAdapter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GoddessAdapter.kt\ncom/qiahao/nextvideo/ui/home/onlinefeed/GoddessAdapter\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,80:1\n1869#2,2:81\n*S KotlinDebug\n*F\n+ 1 GoddessAdapter.kt\ncom/qiahao/nextvideo/ui/home/onlinefeed/GoddessAdapter\n*L\n66#1:81,2\n*E\n"})
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class GoddessAdapter extends BaseQuickAdapter<VideoBaseData, BaseDataBindingHolder<ItemVideoBinding>> {
    ...
    public void convert(@NotNull BaseDataBindingHolder<ItemVideoBinding> holder, @NotNull VideoBaseData item) {
        ...
        if (itemVideoBinding6 != null && (appCompatImageView5 = itemVideoBinding6.fromCountryImageView) != null) {
            ImageKtxKt.loadImage$default(appCompatImageView5, ImageSizeKt.image100(item.getCountryIcon()), (Uri) null, (File) null, (Integer) null, (Bitmap) null, (ImageView.ScaleType) null, false, 0, false, (o4.j) null, (Integer) null, (Integer) null, (Boolean) null, (Integer) null, (Integer) null, (c5.g) null, 65534, (Object) null);
        }
        ...
        if (itemVideoBinding11 != null && (appCompatImageView4 = itemVideoBinding11.likeImageView) != null) {
        ...
        if (Intrinsics.areEqual(item.isLike(), bool) && Intrinsics.areEqual(item.isLikeMe(), bool)) {
            ...
            if (itemVideoBinding12 == null || (appCompatImageView3 = itemVideoBinding12.likeImageView) == null) {
                return;
            }
        ...
        if (Intrinsics.areEqual(item.isLike(), bool) && Intrinsics.areEqual(item.isLikeMe(), Boolean.FALSE)) {
            ...
            if (itemVideoBinding13 == null || (appCompatImageView2 = itemVideoBinding13.likeImageView) == null) {
                return;
            }
        ...
        ItemVideoBinding itemVideoBinding14 = (ItemVideoBinding) holder.getDataBinding();
        if (itemVideoBinding14 == null || (appCompatImageView = itemVideoBinding14.likeImageView) == null) {
            return;
        }
