...
public final /* data */ class LikeMeCellUIModel extends CellUIModel {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/qiahao/nextvideo/ui/commonlist/interactivetracking/LikeMeCellUIModel$Companion;", "", "<init>", "()V", "init", "Lcom/qiahao/nextvideo/ui/commonlist/interactivetracking/LikeMeCellUIModel;", "it", "Lcom/qiahao/nextvideo/data/model/LikeMeGuyItem;", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
    public static final class Companion {
        ...
        @NotNull
        public final LikeMeCellUIModel init(@NotNull LikeMeGuyItem it) {
            int i;
            int i2;
            ...
            ImageUIModel displayUserAvatarImage = companion2.displayUserAvatarImage(avatar, lfit);
            ...
            if (sex != code && sex == Sex.BOY.getCode()) {
                i3 = R.drawable.icon_boy;
            }
            String convert = DateTimeUtilityKt.convert(date, date2);
            String name = it.getUser().getCountryInfo().getName();
            ImageUIModel countryTag = companion2.countryTag(it.getUser().getCountryInfo().getIcon());
            if (it.getUser().getSex() == 1) {
                i = R.drawable.bg_age_male;
            } else {
                i = R.drawable.bg_age_female;
            }
            LikeMeCellUIModel likeMeCellUIModel = new LikeMeCellUIModel(displayUserAvatarImage, null, nick, age, Integer.valueOf(i3), null, convert, name, null, null, countryTag, Integer.valueOf(i), null, null, init, externalId, InteractiveTrackingType.Follow, it.getUser().isVip(), it.getUser().getNoble(), 13090, null);
            likeMeCellUIModel.setHasRead(it.getHasRead());
            ProfileDetailUIModel nextUIModel = likeMeCellUIModel.getNextUIModel();
            if (nextUIModel != null) {
                i2 = nextUIModel.getHeartPer();
            } else {
                i2 = -1;
            }
            likeMeCellUIModel.setHeartPer(i2);
            return likeMeCellUIModel;
        }
    ...
    public /* synthetic */ LikeMeCellUIModel(ImageUIModel imageUIModel, String str, String str2, String str3, Integer num, Integer num2, String str4, String str5, String str6, ImageUIModel imageUIModel2, ImageUIModel imageUIModel3, Integer num3, String str7, Integer num4, ProfileDetailUIModel profileDetailUIModel, String str8, InteractiveTrackingType interactiveTrackingType, boolean z, NobleInfo nobleInfo, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : imageUIModel, (i & 2) != 0 ? null : str, (i & 4) != 0 ? null : str2, (i & 8) != 0 ? null : str3, (i & 16) != 0 ? null : num, (i & 32) != 0 ? null : num2, (i & 64) != 0 ? null : str4, (i & 128) != 0 ? null : str5, (i & 256) != 0 ? null : str6, (i & 512) != 0 ? null : imageUIModel2, (i & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 ? null : imageUIModel3, (i & 2048) != 0 ? null : num3, (i & 4096) != 0 ? null : str7, (i & 8192) != 0 ? null : num4, (i & 16384) != 0 ? null : profileDetailUIModel, str8, interactiveTrackingType, (131072 & i) != 0 ? false : z, (i & 262144) != 0 ? null : nobleInfo);
    }
    ...
    @NotNull
    public final LikeMeCellUIModel copy(@Nullable ImageUIModel iconCircleDisplayImageUIModel, @Nullable String iconCircleR2TTagText, @Nullable String title, @Nullable String titleRightTagText, @Nullable Integer titleRightTagDrawable, @Nullable Integer titleDrawableStart, @Nullable String endTopText, @Nullable String subtitle, @Nullable String endText, @Nullable ImageUIModel endIconDisplayImageUIModel, @Nullable ImageUIModel subtitleLeftIconImageUIModel, @Nullable Integer titleRightTagBackgroundResID, @Nullable String endIconClickTag, @Nullable Integer endTextSize, @Nullable ProfileDetailUIModel nextUIModel, @NotNull String itemId, @NotNull InteractiveTrackingType interactiveTrackingType, boolean isVip, @Nullable NobleInfo noble) {
        Intrinsics.checkNotNullParameter(itemId, "itemId");
        Intrinsics.checkNotNullParameter(interactiveTrackingType, "interactiveTrackingType");
        return new LikeMeCellUIModel(iconCircleDisplayImageUIModel, iconCircleR2TTagText, title, titleRightTagText, titleRightTagDrawable, titleDrawableStart, endTopText, subtitle, endText, endIconDisplayImageUIModel, subtitleLeftIconImageUIModel, titleRightTagBackgroundResID, endIconClickTag, endTextSize, nextUIModel, itemId, interactiveTrackingType, isVip, noble);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof LikeMeCellUIModel)) {
            return false;
        }
        LikeMeCellUIModel likeMeCellUIModel = (LikeMeCellUIModel) other;
        return Intrinsics.areEqual(this.iconCircleDisplayImageUIModel, likeMeCellUIModel.iconCircleDisplayImageUIModel) && Intrinsics.areEqual(this.iconCircleR2TTagText, likeMeCellUIModel.iconCircleR2TTagText) && Intrinsics.areEqual(this.title, likeMeCellUIModel.title) && Intrinsics.areEqual(this.titleRightTagText, likeMeCellUIModel.titleRightTagText) && Intrinsics.areEqual(this.titleRightTagDrawable, likeMeCellUIModel.titleRightTagDrawable) && Intrinsics.areEqual(this.titleDrawableStart, likeMeCellUIModel.titleDrawableStart) && Intrinsics.areEqual(this.endTopText, likeMeCellUIModel.endTopText) && Intrinsics.areEqual(this.subtitle, likeMeCellUIModel.subtitle) && Intrinsics.areEqual(this.endText, likeMeCellUIModel.endText) && Intrinsics.areEqual(this.endIconDisplayImageUIModel, likeMeCellUIModel.endIconDisplayImageUIModel) && Intrinsics.areEqual(this.subtitleLeftIconImageUIModel, likeMeCellUIModel.subtitleLeftIconImageUIModel) && Intrinsics.areEqual(this.titleRightTagBackgroundResID, likeMeCellUIModel.titleRightTagBackgroundResID) && Intrinsics.areEqual(this.endIconClickTag, likeMeCellUIModel.endIconClickTag) && Intrinsics.areEqual(this.endTextSize, likeMeCellUIModel.endTextSize) && Intrinsics.areEqual(this.nextUIModel, likeMeCellUIModel.nextUIModel) && Intrinsics.areEqual(this.itemId, likeMeCellUIModel.itemId) && this.interactiveTrackingType == likeMeCellUIModel.interactiveTrackingType && this.isVip == likeMeCellUIModel.isVip && Intrinsics.areEqual(this.noble, likeMeCellUIModel.noble);
    }
    ...
    public String toString() {
        return "LikeMeCellUIModel(iconCircleDisplayImageUIModel=" + this.iconCircleDisplayImageUIModel + ", iconCircleR2TTagText=" + this.iconCircleR2TTagText + ", title=" + this.title + ", titleRightTagText=" + this.titleRightTagText + ", titleRightTagDrawable=" + this.titleRightTagDrawable + ", titleDrawableStart=" + this.titleDrawableStart + ", endTopText=" + this.endTopText + ", subtitle=" + this.subtitle + ", endText=" + this.endText + ", endIconDisplayImageUIModel=" + this.endIconDisplayImageUIModel + ", subtitleLeftIconImageUIModel=" + this.subtitleLeftIconImageUIModel + ", titleRightTagBackgroundResID=" + this.titleRightTagBackgroundResID + ", endIconClickTag=" + this.endIconClickTag + ", endTextSize=" + this.endTextSize + ", nextUIModel=" + this.nextUIModel + ", itemId=" + this.itemId + ", interactiveTrackingType=" + this.interactiveTrackingType + ", isVip=" + this.isVip + ", noble=" + this.noble + ")";
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LikeMeCellUIModel(@Nullable ImageUIModel imageUIModel, @Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable Integer num, @Nullable Integer num2, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable ImageUIModel imageUIModel2, @Nullable ImageUIModel imageUIModel3, @Nullable Integer num3, @Nullable String str7, @Nullable Integer num4, @Nullable ProfileDetailUIModel profileDetailUIModel, @NotNull String str8, @NotNull InteractiveTrackingType interactiveTrackingType, boolean z, @Nullable NobleInfo nobleInfo) {
