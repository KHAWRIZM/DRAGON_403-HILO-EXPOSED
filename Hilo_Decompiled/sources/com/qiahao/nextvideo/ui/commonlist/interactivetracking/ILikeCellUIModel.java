...
public final /* data */ class ILikeCellUIModel extends CellUIModel {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/qiahao/nextvideo/ui/commonlist/interactivetracking/ILikeCellUIModel$Companion;", "", "<init>", "()V", "init", "Lcom/qiahao/nextvideo/ui/commonlist/interactivetracking/ILikeCellUIModel;", "it", "Lcom/qiahao/nextvideo/data/model/ILikeGuyItem;", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
    public static final class Companion {
        ...
        @NotNull
        public final ILikeCellUIModel init(@NotNull ILikeGuyItem it) {
            int i;
            int i2;
            ...
            ILikeCellUIModel iLikeCellUIModel = new ILikeCellUIModel(displayUserAvatarImage, null, nick, age, Integer.valueOf(i3), null, convert, name, null, null, countryTag, Integer.valueOf(i), null, null, init, externalId, null, it.getUser().isVip(), it.getUser().getNoble(), 78626, null);
            iLikeCellUIModel.setHasRead(true);
            ProfileDetailUIModel nextUIModel = iLikeCellUIModel.getNextUIModel();
            if (nextUIModel != null) {
                i2 = nextUIModel.getHeartPer();
            } else {
                i2 = -1;
            }
            iLikeCellUIModel.setHeartPer(i2);
            return iLikeCellUIModel;
        }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof ILikeCellUIModel)) {
            return false;
        }
        ILikeCellUIModel iLikeCellUIModel = (ILikeCellUIModel) other;
        return Intrinsics.areEqual(this.iconCircleDisplayImageUIModel, iLikeCellUIModel.iconCircleDisplayImageUIModel) && Intrinsics.areEqual(this.iconCircleR2TTagText, iLikeCellUIModel.iconCircleR2TTagText) && Intrinsics.areEqual(this.title, iLikeCellUIModel.title) && Intrinsics.areEqual(this.titleRightTagText, iLikeCellUIModel.titleRightTagText) && Intrinsics.areEqual(this.titleRightTagDrawable, iLikeCellUIModel.titleRightTagDrawable) && Intrinsics.areEqual(this.titleDrawableStart, iLikeCellUIModel.titleDrawableStart) && Intrinsics.areEqual(this.endTopText, iLikeCellUIModel.endTopText) && Intrinsics.areEqual(this.subtitle, iLikeCellUIModel.subtitle) && Intrinsics.areEqual(this.endText, iLikeCellUIModel.endText) && Intrinsics.areEqual(this.endIconDisplayImageUIModel, iLikeCellUIModel.endIconDisplayImageUIModel) && Intrinsics.areEqual(this.subtitleLeftIconImageUIModel, iLikeCellUIModel.subtitleLeftIconImageUIModel) && Intrinsics.areEqual(this.titleRightTagBackgroundResID, iLikeCellUIModel.titleRightTagBackgroundResID) && Intrinsics.areEqual(this.endIconClickTag, iLikeCellUIModel.endIconClickTag) && Intrinsics.areEqual(this.endTextSize, iLikeCellUIModel.endTextSize) && Intrinsics.areEqual(this.nextUIModel, iLikeCellUIModel.nextUIModel) && Intrinsics.areEqual(this.itemId, iLikeCellUIModel.itemId) && this.interactiveTrackingType == iLikeCellUIModel.interactiveTrackingType && this.isVip == iLikeCellUIModel.isVip && Intrinsics.areEqual(this.noble, iLikeCellUIModel.noble);
    }
