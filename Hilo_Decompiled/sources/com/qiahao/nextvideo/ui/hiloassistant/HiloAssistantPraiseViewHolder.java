...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0018\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\rR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000e"}, d2 = {"Lcom/qiahao/nextvideo/ui/hiloassistant/HiloAssistantPraiseViewHolder;", "Lcom/qiahao/nextvideo/ui/hiloassistant/BaseLogicViewHolder;", "binding", "Lcom/qiahao/nextvideo/databinding/CellHiloAssistantPraiseBinding;", "<init>", "(Lcom/qiahao/nextvideo/databinding/CellHiloAssistantPraiseBinding;)V", "getBinding", "()Lcom/qiahao/nextvideo/databinding/CellHiloAssistantPraiseBinding;", VerificationCodeFragment.TYPE_BIND, "", "item", "Lcom/qiahao/nextvideo/ui/hiloassistant/HiloAssistantCellUIModel;", "clickListener", "Lcom/qiahao/nextvideo/ui/hiloassistant/ClickListener;", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class HiloAssistantPraiseViewHolder extends BaseLogicViewHolder {

    @NotNull
    private final CellHiloAssistantPraiseBinding binding;

    /* JADX WARN: Illegal instructions before constructor call */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public HiloAssistantPraiseViewHolder(@NotNull CellHiloAssistantPraiseBinding cellHiloAssistantPraiseBinding) {
        super(r0);
        Intrinsics.checkNotNullParameter(cellHiloAssistantPraiseBinding, "binding");
        View root = cellHiloAssistantPraiseBinding.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        this.binding = cellHiloAssistantPraiseBinding;
    }
    ...
    public final void bind(@NotNull final HiloAssistantCellUIModel item, @Nullable final ClickListener clickListener) {
        ...
        if (clickListener != null) {
            this.binding.messageContainer.setOnClickListener(new View.OnClickListener() { // from class: com.qiahao.nextvideo.ui.hiloassistant.f
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    HiloAssistantPraiseViewHolder.this.onItemClick(item, clickListener);
                }
            });
        }
        CellHiloAssistantPraiseBinding cellHiloAssistantPraiseBinding = this.binding;
        LinearLayout linearLayout = cellHiloAssistantPraiseBinding.messageContainer;
        Context context = cellHiloAssistantPraiseBinding.getRoot().getContext();
    ...
    @NotNull
    public final CellHiloAssistantPraiseBinding getBinding() {
        return this.binding;
    }
}
