...
public final class TaskBagView extends FrameLayout {
    ...
    public TaskBagView(@NotNull Context context, @Nullable MainTabData mainTabData) {
        super(context);
    ...
    public /* synthetic */ TaskBagView(Context context, MainTabData mainTabData, int i, DefaultConstructorMarker defaultConstructorMarker) {
