...
import com.qiahao.nextvideo.view.RoomAndPersonalTaskTabView;
...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u001a\u0010\f\u001a\u0004\u0018\u00010\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016J\u001a\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0014\u001a\u0004\u0018\u00010\rH\u0016J\u001a\u0010\u0015\u001a\u00020\u00132\u0006\u0010\u0010\u001a\u00020\u00112\b\u0010\u0014\u001a\u0004\u0018\u00010\rH\u0016R+\u0010\u0004\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\b\u0010\t¨\u0006\u0016"}, d2 = {"Lcom/qiahao/nextvideo/ui/task/RoomAndPersonalTaskTabAdapter;", "Lcom/oudi/widget/ViewPage2TabLayout$CustomTabAdapter;", "<init>", "()V", "tabList", "Ljava/util/ArrayList;", "Lcom/qiahao/nextvideo/ui/home/community/CommunityTabData;", "Lkotlin/collections/ArrayList;", "getTabList", "()Ljava/util/ArrayList;", "tabList$delegate", "Lkotlin/Lazy;", "getTabView", "Landroid/view/View;", "context", "Landroid/content/Context;", "position", "", "onTabSelected", "", "tabView", "onTabUnselected", "app_googleRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes4.dex */
public final class RoomAndPersonalTaskTabAdapter implements ViewPage2TabLayout.CustomTabAdapter {

    /* renamed from: tabList$delegate, reason: from kotlin metadata */
    @NotNull
    private final Lazy tabList = LazyKt.lazy(new Function0() { // from class: com.qiahao.nextvideo.ui.task.w0
        public final Object invoke() {
            ArrayList tabList_delegate$lambda$1;
            tabList_delegate$lambda$1 = RoomAndPersonalTaskTabAdapter.tabList_delegate$lambda$1();
    ...
    public static final ArrayList tabList_delegate$lambda$1() {
        ...
        arrayList.add(new CommunityTabData(ResourcesKtxKt.getStringById(arrayList, 2131953623), "#FFFFFF", "#AAAABD"));
        arrayList.add(new CommunityTabData(ResourcesKtxKt.getStringById(arrayList, 2131953077), "#FFFFFF", "#AAAABD"));
        return arrayList;
    }
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new RoomAndPersonalTaskTabView(context, communityTabData);
    }

    public void onTabSelected(int position, @Nullable View tabView) {
        RoomAndPersonalTaskTabView roomAndPersonalTaskTabView;
        ViewPage2TabLayout.CustomTabAdapter.DefaultImpls.onTabSelected(this, position, tabView);
        if (tabView instanceof RoomAndPersonalTaskTabView) {
            roomAndPersonalTaskTabView = (RoomAndPersonalTaskTabView) tabView;
        } else {
            roomAndPersonalTaskTabView = null;
        }
        if (roomAndPersonalTaskTabView != null) {
            roomAndPersonalTaskTabView.setSelected(true);
        }
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        if (roomAndPersonalTaskTabView != null) {
            roomAndPersonalTaskTabView.setSelected(false);
        }
    }
}
