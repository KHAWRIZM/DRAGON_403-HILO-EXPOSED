...
public final class TaskActivityView extends FrameLayout {
    ...
    public TaskActivityView(@NotNull Context context, @Nullable MainTabData mainTabData) {
        super(context);
    ...
    public void setSelected(boolean selected) {
        ...
        if (taskTabActivityItemBinding != null && (view = taskTabActivityItemBinding.bg) != null) {
            view.setVisibility(8);
        }
        TaskTabActivityItemBinding taskTabActivityItemBinding2 = this.binding;
        if (taskTabActivityItemBinding2 != null && (textView3 = taskTabActivityItemBinding2.title) != null) {
    ...
    public /* synthetic */ TaskActivityView(Context context, MainTabData mainTabData, int i, DefaultConstructorMarker defaultConstructorMarker) {
