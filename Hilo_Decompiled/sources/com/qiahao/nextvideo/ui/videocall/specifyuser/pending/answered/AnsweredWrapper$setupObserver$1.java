...
final class AnsweredWrapper$setupObserver$1<T> implements pd.g {
    final /* synthetic */ Function2<String, Throwable, Unit> $disposalError;
    final /* synthetic */ AnsweredWrapper this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public AnsweredWrapper$setupObserver$1(AnsweredWrapper answeredWrapper, Function2<? super String, ? super Throwable, Unit> function2) {
        this.this$0 = answeredWrapper;
    ...
    public final void accept(Integer num) {
        ...
        try {
            if (1048577 == num.intValue()) {
                ...
                if (preloadModel != null) {
                    ...
                    if (answeredPreloadModel != null) {
                        ...
                        if (agoraVideoCallConfig != null) {
                            ...
                            Function1 function1 = new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.answered.n
                                public final Object invoke(Object obj) {
                                    Unit accept$lambda$0;
                                    accept$lambda$0 = AnsweredWrapper$setupObserver$1.accept$lambda$0(function2, (ApiResponse) obj);
                                    return accept$lambda$0;
                                }
                            };
                            final Function2<String, Throwable, Unit> function22 = this.$disposalError;
                            RxUtilsKt.addTo(RxUtilsKt.observeOnMainThread$default(videoCallReady, function1, new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.answered.o
                                public final Object invoke(Object obj) {
                                    Unit accept$lambda$1;
                                    accept$lambda$1 = AnsweredWrapper$setupObserver$1.accept$lambda$1(function22, (Throwable) obj);
                ...
                Function1 function12 = new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.answered.n
                    public final Object invoke(Object obj) {
                        Unit accept$lambda$0;
                        accept$lambda$0 = AnsweredWrapper$setupObserver$1.accept$lambda$0(function23, (ApiResponse) obj);
                        return accept$lambda$0;
                    }
                };
                final Function2 function222 = this.$disposalError;
                RxUtilsKt.addTo(RxUtilsKt.observeOnMainThread$default(videoCallReady2, function12, new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.answered.o
                    public final Object invoke(Object obj) {
                        Unit accept$lambda$1;
                        accept$lambda$1 = AnsweredWrapper$setupObserver$1.accept$lambda$1(function222, (Throwable) obj);
                        return accept$lambda$1;
                    }
                }, (Function0) null, false, 12, (Object) null), this.this$0.getCompositeDisposable());
            }
