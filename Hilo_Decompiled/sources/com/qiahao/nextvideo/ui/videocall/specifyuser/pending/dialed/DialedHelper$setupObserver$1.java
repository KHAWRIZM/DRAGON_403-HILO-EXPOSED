...
final class DialedHelper$setupObserver$1<T> implements pd.g {
    final /* synthetic */ Function2<String, Throwable, Unit> $disposalError;
    final /* synthetic */ DialedHelper this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public DialedHelper$setupObserver$1(DialedHelper dialedHelper, Function2<? super String, ? super Throwable, Unit> function2) {
        this.this$0 = dialedHelper;
        ...
        try {
            if (1048577 == num.intValue()) {
                ...
                if (preloadModel != null) {
                    DialedPreloadModel dialedPreloadModel = preloadModel.getDialedPreloadModel();
                    if (dialedPreloadModel != null) {
                        AgoraVideoCallConfig agoraVideoCallConfig = dialedPreloadModel.getAgoraVideoCallConfig();
                        if (agoraVideoCallConfig != null) {
                            ...
                            Function1 function1 = new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.dialed.c
                                public final Object invoke(Object obj) {
                                    Unit accept$lambda$0;
                                    accept$lambda$0 = DialedHelper$setupObserver$1.accept$lambda$0(function2, (ApiResponse) obj);
                                    return accept$lambda$0;
                                }
                            };
                            final Function2<String, Throwable, Unit> function22 = this.$disposalError;
                            RxUtilsKt.addTo(RxUtilsKt.observeOnMainThread$default(videoCallReady, function1, new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.dialed.d
                                public final Object invoke(Object obj) {
                                    Unit accept$lambda$1;
                                    accept$lambda$1 = DialedHelper$setupObserver$1.accept$lambda$1(function22, (Throwable) obj);
                ...
                Function1 function12 = new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.dialed.c
                    public final Object invoke(Object obj) {
                        Unit accept$lambda$0;
                        accept$lambda$0 = DialedHelper$setupObserver$1.accept$lambda$0(function23, (ApiResponse) obj);
                        return accept$lambda$0;
                    }
                };
                final Function2 function222 = this.$disposalError;
                RxUtilsKt.addTo(RxUtilsKt.observeOnMainThread$default(videoCallReady2, function12, new Function1() { // from class: com.qiahao.nextvideo.ui.videocall.specifyuser.pending.dialed.d
                    public final Object invoke(Object obj) {
                        Unit accept$lambda$1;
                        accept$lambda$1 = DialedHelper$setupObserver$1.accept$lambda$1(function222, (Throwable) obj);
                        return accept$lambda$1;
                    }
                }, (Function0) null, false, 12, (Object) null), this.this$0.getCompositeDisposable());
            }
