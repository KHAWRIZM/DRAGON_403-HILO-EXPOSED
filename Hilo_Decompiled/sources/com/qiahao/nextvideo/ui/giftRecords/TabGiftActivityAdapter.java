...
public final class TabGiftActivityAdapter implements ViewPage2TabLayout.CustomTabAdapter {
    ...
    public static final ArrayList tabList_delegate$lambda$1() {
        ...
        arrayList.add(companion.initGiftRecord(ResourcesKtxKt.getStringById(arrayList, 2131953848)));
        arrayList.add(companion.initGiftRecord(ResourcesKtxKt.getStringById(arrayList, 2131954035)));
        return arrayList;
    }
    ...
    public View getTabView(@NotNull Context context, int position) {
        ...
        return new GiftActivityView(context, getTabList().get(position));
    }
    ...
    public void onTabSelected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.giftRecords.GiftActivityView");
        ((GiftActivityView) tabView).setSelected(true);
    }
    ...
    public void onTabUnselected(int position, @Nullable View tabView) {
        ...
        Intrinsics.checkNotNull(tabView, "null cannot be cast to non-null type com.qiahao.nextvideo.ui.giftRecords.GiftActivityView");
        ((GiftActivityView) tabView).setSelected(false);
    }
}
