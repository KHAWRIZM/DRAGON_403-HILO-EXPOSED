...
public final class IrregularImageView extends AppCompatImageView {
    ...
    public IrregularImageView(@NotNull Context context) {
        this(context, null);
    ...
    private final void createMaskCanvas(int width, int height, int oldw, int oldh) {
        ...
        if (width > 0 && height > 0) {
            if (this.maskCanvas == null || z) {
                ...
                paintMaskCanvas(canvas2, paint2, width, height);
                ...
                try {
                    if (this.invalidated && (drawable = getDrawable()) != null) {
                        ...
                        if (this.mBorderWidth > 0) {
                            Paint paint4 = this.storePaint;
                            Intrinsics.checkNotNull(paint4);
                            paint4.reset();
                            Paint paint5 = this.storePaint;
                            Intrinsics.checkNotNull(paint5);
                            paint5.setColor(this.mBorderColor);
                            Paint paint6 = this.storePaint;
                            Intrinsics.checkNotNull(paint6);
                            paint6.setStrokeWidth(this.mBorderWidth);
                            Paint paint7 = this.storePaint;
                            Intrinsics.checkNotNull(paint7);
                            paint7.setStyle(Paint.Style.STROKE);
                            Paint paint8 = this.storePaint;
                            Intrinsics.checkNotNull(paint8);
                            paint8.setStrokeJoin(Paint.Join.MITER);
                            if (this.cornerPathEffect != null) {
                                Paint paint9 = this.storePaint;
                                Intrinsics.checkNotNull(paint9);
                                paint9.setPathEffect(this.cornerPathEffect);
                            }
                            Path path = this.storePath;
                            if (path != null) {
                                Canvas canvas10 = this.drawableCanvas;
                                Intrinsics.checkNotNull(canvas10);
                                Paint paint10 = this.storePaint;
                                Intrinsics.checkNotNull(paint10);
                                canvas10.drawPath(path, paint10);
                                Canvas canvas11 = this.drawableCanvas;
                    ...
                    if (!this.invalidated) {
                        Paint paint11 = this.drawablePaint;
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public IrregularImageView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IrregularImageView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
