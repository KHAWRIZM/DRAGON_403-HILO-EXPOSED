...
public final class CustomFooter extends SimpleComponent implements tc.c {
    ...
    public CustomFooter(@NotNull View view) {
        super(view);
    ...
    public CustomFooter(@Nullable Context context) {
        super(context, null, 0);
        initView();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomFooter(@NotNull View view, @Nullable tc.a aVar) {
        super(view, aVar);
        Intrinsics.checkNotNullParameter(view, "wrappedView");
        initView();
    }

    public CustomFooter(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
