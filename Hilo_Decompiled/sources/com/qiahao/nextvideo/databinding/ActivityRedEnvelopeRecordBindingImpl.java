...
public class ActivityRedEnvelopeRecordBindingImpl extends ActivityRedEnvelopeRecordBinding {
    ...
    public ActivityRedEnvelopeRecordBindingImpl(f fVar, View view) {
    ...
    private ActivityRedEnvelopeRecordBindingImpl(f fVar, View view, Object[] objArr) {
