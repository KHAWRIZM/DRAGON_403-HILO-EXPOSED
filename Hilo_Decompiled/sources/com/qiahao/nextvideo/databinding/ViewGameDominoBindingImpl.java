...
public class ViewGameDominoBindingImpl extends ViewGameDominoBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.dominoGameLayout, 15);
        ...
        sparseIntArray.put(R.id.pieces, 21);
        sparseIntArray.put(R.id.change, 22);
        sparseIntArray.put(R.id.waitLayout, 23);
        sparseIntArray.put(R.id.waitText, 24);
        sparseIntArray.put(R.id.button, 25);
    }

    public ViewGameDominoBindingImpl(f fVar, View view) {
    ...
    private ViewGameDominoBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 4, (ImageView) objArr[11], (TextView) objArr[20], (LinearLayout) objArr[19], (TextView) objArr[25], (ImageView) objArr[22], (ImageView) objArr[12], (ImageView) objArr[9], (TextView) objArr[10], (ImageView) objArr[8], (FrameLayout) objArr[15], (IncludeLudoItemBinding) objArr[5], (SVGAImageView) objArr[17], (ConstraintLayout) objArr[6], (ImageView) objArr[13], (ConstraintLayout) objArr[7], (IncludeLudoItemBinding) objArr[2], (TextView) objArr[21], (ConstraintLayout) objArr[16], (ConstraintLayout) objArr[18], (ImageView) objArr[14], (IncludeLudoItemBinding) objArr[4], (IncludeLudoItemBinding) objArr[3], (LinearLayoutCompat) objArr[1], (ConstraintLayout) objArr[23], (TextView) objArr[24]);
        this.mDirtyFlags = -1L;
