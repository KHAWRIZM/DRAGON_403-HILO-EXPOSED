...
public class ActivityTaskBindingImpl extends ActivityTaskBinding {
    ...
    public ActivityTaskBindingImpl(f fVar, View view) {
    ...
    private ActivityTaskBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (FrameLayout) objArr[0], (AppCompatImageView) objArr[2], (ViewPage2TabLayout) objArr[3], (View) objArr[1], (ViewPager2) objArr[4]);
        this.mDirtyFlags = -1L;
