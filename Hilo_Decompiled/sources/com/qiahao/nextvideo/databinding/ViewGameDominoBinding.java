...
public abstract class ViewGameDominoBinding extends ViewDataBinding {
    ...
    public final FrameLayout dominoGameLayout;
    ...
    public ViewGameDominoBinding(Object obj, View view, int i, ImageView imageView, TextView textView, LinearLayout linearLayout, TextView textView2, ImageView imageView2, ImageView imageView3, ImageView imageView4, TextView textView3, ImageView imageView5, FrameLayout frameLayout, IncludeLudoItemBinding includeLudoItemBinding, SVGAImageView sVGAImageView, ConstraintLayout constraintLayout, ImageView imageView6, ConstraintLayout constraintLayout2, IncludeLudoItemBinding includeLudoItemBinding2, TextView textView4, ConstraintLayout constraintLayout3, ConstraintLayout constraintLayout4, ImageView imageView7, IncludeLudoItemBinding includeLudoItemBinding3, IncludeLudoItemBinding includeLudoItemBinding4, LinearLayoutCompat linearLayoutCompat, ConstraintLayout constraintLayout5, TextView textView5) {
        ...
        this.dominoGameLayout = frameLayout;
    ...
    public static ViewGameDominoBinding bind(View view) {
        g.g();
        return bind(view, null);
    }

    public static ViewGameDominoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        g.g();
        return inflate(layoutInflater, viewGroup, z, null);
    }

    @Deprecated
    public static ViewGameDominoBinding bind(View view, Object obj) {
        return (ViewGameDominoBinding) ViewDataBinding.bind(obj, view, R.layout.view_game_domino);
    }

    @Deprecated
    public static ViewGameDominoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ViewGameDominoBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_game_domino, viewGroup, z, obj);
    }

    public static ViewGameDominoBinding inflate(LayoutInflater layoutInflater) {
        g.g();
        return inflate(layoutInflater, null);
    }

    @Deprecated
    public static ViewGameDominoBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ViewGameDominoBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.view_game_domino, (ViewGroup) null, false, obj);
    }
}
