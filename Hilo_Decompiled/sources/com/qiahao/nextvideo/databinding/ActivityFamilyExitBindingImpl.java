...
public class ActivityFamilyExitBindingImpl extends ActivityFamilyExitBinding {
    ...
    public ActivityFamilyExitBindingImpl(f fVar, View view) {
    ...
    private ActivityFamilyExitBindingImpl(f fVar, View view, Object[] objArr) {
