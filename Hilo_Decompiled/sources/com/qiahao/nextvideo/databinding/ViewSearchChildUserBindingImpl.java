...
public class ViewSearchChildUserBindingImpl extends ViewSearchChildUserBinding {
    ...
    public ViewSearchChildUserBindingImpl(f fVar, View view) {
    ...
    private ViewSearchChildUserBindingImpl(f fVar, View view, Object[] objArr) {
