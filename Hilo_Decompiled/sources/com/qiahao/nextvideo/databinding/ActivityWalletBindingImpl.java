...
public class ActivityWalletBindingImpl extends ActivityWalletBinding {
    ...
    public ActivityWalletBindingImpl(f fVar, View view) {
    ...
    private ActivityWalletBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (FrameLayout) objArr[0], (AppCompatImageView) objArr[4], (View) objArr[3], (LinearLayout) objArr[1], (AppCompatImageView) objArr[6], (LinearLayoutCompat) objArr[2], (ViewPage2TabLayout) objArr[5], (ViewPager2) objArr[7]);
        this.mDirtyFlags = -1L;
