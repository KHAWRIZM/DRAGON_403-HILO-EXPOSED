...
public class ActivityFamilyRecordingBindingImpl extends ActivityFamilyRecordingBinding {
    ...
    public ActivityFamilyRecordingBindingImpl(f fVar, View view) {
    ...
    private ActivityFamilyRecordingBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (FrameLayout) objArr[0], (LinearLayout) objArr[3], (BackgroundTabLayout) objArr[4], (IncludeTitleBinding) objArr[2], (ViewPager2) objArr[5]);
        this.mDirtyFlags = -1L;
