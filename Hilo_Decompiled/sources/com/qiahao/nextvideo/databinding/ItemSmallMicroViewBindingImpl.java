...
public class ItemSmallMicroViewBindingImpl extends ItemSmallMicroViewBinding {
    ...
    public ItemSmallMicroViewBindingImpl(f fVar, View view) {
    ...
    private ItemSmallMicroViewBindingImpl(f fVar, View view, Object[] objArr) {
