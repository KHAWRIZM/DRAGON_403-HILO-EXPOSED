...
public class ItemMyOrJoinGroupBindingImpl extends ItemMyOrJoinGroupBinding {
    ...
    public ItemMyOrJoinGroupBindingImpl(f fVar, View view) {
    ...
    private ItemMyOrJoinGroupBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (ConstraintLayout) objArr[0], (ImageView) objArr[17], (TextView) objArr[14], (TextView) objArr[5], (ImageView) objArr[4], (LinearLayout) objArr[15], (LinearLayout) objArr[6], (TextView) objArr[13], (TextView) objArr[16], (ImageView) objArr[7], (ImageView) objArr[8], (ImageView) objArr[9], (ImageView) objArr[10], (ImageView) objArr[11], (RoundedImageView) objArr[1], (SVGAImageView) objArr[3], (SVGAImageView) objArr[2], (LinearLayout) objArr[12]);
        this.mDirtyFlags = -1L;
