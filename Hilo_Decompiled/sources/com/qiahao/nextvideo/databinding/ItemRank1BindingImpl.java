...
public class ItemRank1BindingImpl extends ItemRank1Binding {
    ...
    public ItemRank1BindingImpl(f fVar, View view) {
    ...
    private ItemRank1BindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (GenderAgeTextView) objArr[7], (HiloGradeView) objArr[9], (TextView) objArr[13], (ImageView) objArr[4], (ImageView) objArr[3], (View) objArr[14], (TextView) objArr[1], (LinearLayout) objArr[12], (MedalGridLayout) objArr[11], (ImageView) objArr[5], (HiloImageView) objArr[2], (CountryIDView) objArr[10], (NickTextView) objArr[6], (HiloGradeView) objArr[8]);
        this.mDirtyFlags = -1L;
