...
public final class ViewRoomMicroStyle6Binding implements a {
    ...
    public static ViewRoomMicroStyle6Binding bind(View view) {
                    ...
                    if (middleItemMicroView4 != null) {
                        ...
                        if (middleItemMicroView5 != null) {
                            ...
                            if (middleItemMicroView6 != null) {
                                return new ViewRoomMicroStyle6Binding((ConstraintLayout) view, middleItemMicroView, middleItemMicroView2, middleItemMicroView3, middleItemMicroView4, middleItemMicroView5, middleItemMicroView6);
                            }
                        }
                    }
                }
    ...
    public static ViewRoomMicroStyle6Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ViewRoomMicroStyle6Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_room_micro_style_6, viewGroup, false);
        if (z) {
