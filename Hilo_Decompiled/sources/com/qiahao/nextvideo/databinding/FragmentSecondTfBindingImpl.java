...
public class FragmentSecondTfBindingImpl extends FragmentSecondTfBinding {
    ...
    public FragmentSecondTfBindingImpl(f fVar, View view) {
    ...
    private FragmentSecondTfBindingImpl(f fVar, View view, Object[] objArr) {
