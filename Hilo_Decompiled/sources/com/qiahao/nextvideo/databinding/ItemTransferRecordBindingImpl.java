...
public class ItemTransferRecordBindingImpl extends ItemTransferRecordBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.promoterIcon, 3);
        sparseIntArray.put(R.id.promoterId, 4);
    ...
    private ItemTransferRecordBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (TextView) objArr[5], (View) objArr[6], (ImageView) objArr[3], (TextView) objArr[4], (TextView) objArr[2], (TextView) objArr[1]);
        this.mDirtyFlags = -1L;
