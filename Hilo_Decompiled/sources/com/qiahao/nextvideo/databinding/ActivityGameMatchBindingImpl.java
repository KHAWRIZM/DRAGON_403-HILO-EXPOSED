...
public class ActivityGameMatchBindingImpl extends ActivityGameMatchBinding {
    ...
    public ActivityGameMatchBindingImpl(f fVar, View view) {
    ...
    private ActivityGameMatchBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (QMUIRadiusImageView) objArr[11], (QMUIRadiusImageView) objArr[5], (ImageView) objArr[16], (RatioConstraintLayout) objArr[9], (SheepFightBtn) objArr[14], (ImageView) objArr[13], (TextView) objArr[12], (TextView) objArr[8], (View) objArr[10], (View) objArr[4], (ImageView) objArr[7], (RatioConstraintLayout) objArr[3], (SVGAImageView) objArr[6], (BaseWebView) objArr[15]);
        this.mDirtyFlags = -1L;
