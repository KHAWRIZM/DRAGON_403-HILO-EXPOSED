...
public final class ViewRoomMicroStyle7Binding implements a {
    ...
    public static ViewRoomMicroStyle7Binding bind(View view) {
                        ...
                        if (middleItemMicroView5 != null) {
                            ...
                            if (middleItemMicroView6 != null) {
                                ...
                                if (middleItemMicroView7 != null) {
                                    return new ViewRoomMicroStyle7Binding((ConstraintLayout) view, middleItemMicroView, middleItemMicroView2, middleItemMicroView3, middleItemMicroView4, middleItemMicroView5, middleItemMicroView6, middleItemMicroView7);
                                }
                            }
                        }
                    }
    ...
    public static ViewRoomMicroStyle7Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ViewRoomMicroStyle7Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_room_micro_style_7, viewGroup, false);
        if (z) {
