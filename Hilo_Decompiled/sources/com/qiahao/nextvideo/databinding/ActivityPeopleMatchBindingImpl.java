...
public class ActivityPeopleMatchBindingImpl extends ActivityPeopleMatchBinding {
    ...
    public ActivityPeopleMatchBindingImpl(f fVar, View view) {
    ...
    private ActivityPeopleMatchBindingImpl(f fVar, View view, Object[] objArr) {
