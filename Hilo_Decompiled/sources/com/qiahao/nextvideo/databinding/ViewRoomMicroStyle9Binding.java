...
public final class ViewRoomMicroStyle9Binding implements a {
    ...
    private ViewRoomMicroStyle9Binding(ConstraintLayout constraintLayout, MiddleItemMicroView middleItemMicroView, MiddleItemMicroView middleItemMicroView2, MiddleItemMicroView middleItemMicroView3, MiddleItemMicroView middleItemMicroView4, MiddleItemMicroView middleItemMicroView5, MiddleItemMicroView middleItemMicroView6, MiddleItemMicroView middleItemMicroView7, MiddleItemMicroView middleItemMicroView8, MiddleItemMicroView middleItemMicroView9) {
        ...
        this.microView9 = middleItemMicroView9;
    }

    public static ViewRoomMicroStyle9Binding bind(View view) {
                            ...
                            if (middleItemMicroView6 != null) {
                                ...
                                if (middleItemMicroView7 != null) {
                                    ...
                                    if (middleItemMicroView8 != null) {
                                        i = R.id.micro_view9;
                                        MiddleItemMicroView middleItemMicroView9 = (MiddleItemMicroView) b.a(view, R.id.micro_view9);
                                        if (middleItemMicroView9 != null) {
                                            return new ViewRoomMicroStyle9Binding((ConstraintLayout) view, middleItemMicroView, middleItemMicroView2, middleItemMicroView3, middleItemMicroView4, middleItemMicroView5, middleItemMicroView6, middleItemMicroView7, middleItemMicroView8, middleItemMicroView9);
                                        }
                                    }
                                }
                            }
    ...
    public static ViewRoomMicroStyle9Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ViewRoomMicroStyle9Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.view_room_micro_style_9, viewGroup, false);
        if (z) {
