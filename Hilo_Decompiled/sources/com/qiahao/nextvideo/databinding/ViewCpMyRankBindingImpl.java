...
public class ViewCpMyRankBindingImpl extends ViewCpMyRankBinding {
    ...
    public ViewCpMyRankBindingImpl(f fVar, View view) {
    ...
    private ViewCpMyRankBindingImpl(f fVar, View view, Object[] objArr) {
