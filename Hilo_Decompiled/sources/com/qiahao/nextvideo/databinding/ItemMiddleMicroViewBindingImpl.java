...
public class ItemMiddleMicroViewBindingImpl extends ItemMiddleMicroViewBinding {
    ...
    public ItemMiddleMicroViewBindingImpl(f fVar, View view) {
    ...
    private ItemMiddleMicroViewBindingImpl(f fVar, View view, Object[] objArr) {
