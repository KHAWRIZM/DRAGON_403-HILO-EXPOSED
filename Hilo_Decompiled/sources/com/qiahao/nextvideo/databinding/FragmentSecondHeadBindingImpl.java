...
public class FragmentSecondHeadBindingImpl extends FragmentSecondHeadBinding {
    ...
    public FragmentSecondHeadBindingImpl(f fVar, View view) {
    ...
    private FragmentSecondHeadBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 3, (IncludeTransferTextBinding) objArr[3], (View) objArr[9], (View) objArr[8], (IncludeTransferTextBinding) objArr[2], (View) objArr[11], (AppCompatTextView) objArr[12], (IncludeTransferTextBinding) objArr[1], (View) objArr[4], (TextView) objArr[7], (ImageView) objArr[6], (TextView) objArr[5], (View) objArr[10]);
        this.mDirtyFlags = -1L;
