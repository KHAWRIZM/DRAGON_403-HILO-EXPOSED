...
public abstract class ItemSmallMicroViewBinding extends ViewDataBinding {
    ...
    public static ItemSmallMicroViewBinding bind(View view) {
        g.g();
        return bind(view, null);
    }

    public static ItemSmallMicroViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        g.g();
        return inflate(layoutInflater, viewGroup, z, null);
    }

    @Deprecated
    public static ItemSmallMicroViewBinding bind(View view, Object obj) {
        return (ItemSmallMicroViewBinding) ViewDataBinding.bind(obj, view, R.layout.item_small_micro_view);
    }

    @Deprecated
    public static ItemSmallMicroViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ItemSmallMicroViewBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.item_small_micro_view, viewGroup, z, obj);
    }

    public static ItemSmallMicroViewBinding inflate(LayoutInflater layoutInflater) {
        g.g();
        return inflate(layoutInflater, null);
    }

    @Deprecated
    public static ItemSmallMicroViewBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ItemSmallMicroViewBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.item_small_micro_view, (ViewGroup) null, false, obj);
    }
}
