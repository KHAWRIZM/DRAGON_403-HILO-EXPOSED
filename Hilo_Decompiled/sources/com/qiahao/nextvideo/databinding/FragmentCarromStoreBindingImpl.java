...
public class FragmentCarromStoreBindingImpl extends FragmentCarromStoreBinding {
    ...
    public FragmentCarromStoreBindingImpl(f fVar, View view) {
    ...
    private FragmentCarromStoreBindingImpl(f fVar, View view, Object[] objArr) {
