...
public abstract class ItemMiddleMicroViewBinding extends ViewDataBinding {
    ...
    public static ItemMiddleMicroViewBinding bind(View view) {
        g.g();
        return bind(view, null);
    }

    public static ItemMiddleMicroViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        g.g();
        return inflate(layoutInflater, viewGroup, z, null);
    }

    @Deprecated
    public static ItemMiddleMicroViewBinding bind(View view, Object obj) {
        return (ItemMiddleMicroViewBinding) ViewDataBinding.bind(obj, view, R.layout.item_middle_micro_view);
    }

    @Deprecated
    public static ItemMiddleMicroViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (ItemMiddleMicroViewBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.item_middle_micro_view, viewGroup, z, obj);
    }

    public static ItemMiddleMicroViewBinding inflate(LayoutInflater layoutInflater) {
        g.g();
        return inflate(layoutInflater, null);
    }

    @Deprecated
    public static ItemMiddleMicroViewBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (ItemMiddleMicroViewBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.item_middle_micro_view, (ViewGroup) null, false, obj);
    }
}
