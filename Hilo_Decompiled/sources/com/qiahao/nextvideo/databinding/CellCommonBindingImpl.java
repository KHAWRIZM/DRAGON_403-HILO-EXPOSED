...
public class CellCommonBindingImpl extends CellCommonBinding {
    ...
    public CellCommonBindingImpl(f fVar, View view) {
    ...
    private CellCommonBindingImpl(f fVar, View view, Object[] objArr) {
