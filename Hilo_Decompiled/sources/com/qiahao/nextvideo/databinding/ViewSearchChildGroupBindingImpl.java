...
public class ViewSearchChildGroupBindingImpl extends ViewSearchChildGroupBinding {
    ...
    public ViewSearchChildGroupBindingImpl(f fVar, View view) {
    ...
    private ViewSearchChildGroupBindingImpl(f fVar, View view, Object[] objArr) {
