...
public class ActivityGiftRecordBindingImpl extends ActivityGiftRecordBinding {
    ...
    public ActivityGiftRecordBindingImpl(f fVar, View view) {
    ...
    private ActivityGiftRecordBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (FrameLayout) objArr[0], (View) objArr[6], (LinearLayout) objArr[3], (ViewPage2TabLayout) objArr[4], (IncludeTitleBinding) objArr[2], (ViewPager2) objArr[5]);
        this.mDirtyFlags = -1L;
