...
public class FragmentVerificationCodeBindingImpl extends FragmentVerificationCodeBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.verificationCode, 8);
        sparseIntArray.put(R.id.sendButton, 9);
        sparseIntArray.put(R.id.passwordLayout, 10);
        sparseIntArray.put(R.id.password, 11);
        sparseIntArray.put(R.id.viewPassword, 12);
        sparseIntArray.put(R.id.confirmButton, 13);
    }

    public FragmentVerificationCodeBindingImpl(f fVar, View view) {
    ...
    private FragmentVerificationCodeBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (Button) objArr[13], (QMUIRadiusImageView2) objArr[4], (TextView) objArr[5], (View) objArr[7], (AppCompatEditText) objArr[11], (ConstraintLayout) objArr[10], (AppCompatEditText) objArr[6], (LinearLayout) objArr[3], (TextView) objArr[9], (TextView) objArr[2], (IncludeTitleBinding) objArr[1], (AppCompatEditText) objArr[8], (ImageView) objArr[12]);
        this.mDirtyFlags = -1L;
