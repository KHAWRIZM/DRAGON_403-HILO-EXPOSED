...
public class ViewGameJackaroBindingImpl extends ViewGameJackaroBinding {
    ...
    static {
        ...
        sIncludes = iVar;
        iVar.a(1, new String[]{"include_jackaro_item", "include_jackaro_item", "include_jackaro_item", "include_jackaro_item"}, new int[]{2, 3, 4, 5}, new int[]{R.layout.include_jackaro_item, R.layout.include_jackaro_item, R.layout.include_jackaro_item, R.layout.include_jackaro_item});
        ...
        sparseIntArray.put(R.id.jackaroGameLayout, 15);
    ...
    public ViewGameJackaroBindingImpl(f fVar, View view) {
        this(fVar, view, ViewDataBinding.mapBindings(fVar, view, 27, sIncludes, sViewsWithIds));
    }

    private boolean onChangeFourUser(IncludeJackaroItemBinding includeJackaroItemBinding, int i) {
        if (i == 0) {
            synchronized (this) {
                this.mDirtyFlags |= 2;
            }
    ...
    private boolean onChangeThreeUser(IncludeJackaroItemBinding includeJackaroItemBinding, int i) {
        if (i == 0) {
            synchronized (this) {
                this.mDirtyFlags |= 4;
            }
    ...
    protected boolean onFieldChange(int i, Object obj, int i2) {
        if (i != 0) {
            if (i != 1) {
                ...
                return onChangeThreeUser((IncludeJackaroItemBinding) obj, i2);
            }
            return onChangeFourUser((IncludeJackaroItemBinding) obj, i2);
        }
    ...
    private ViewGameJackaroBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 4, (ImageView) objArr[11], (TextView) objArr[20], (LinearLayout) objArr[19], (TextView) objArr[26], (ImageView) objArr[22], (ImageView) objArr[12], (ImageView) objArr[9], (TextView) objArr[10], (ImageView) objArr[8], (IncludeJackaroItemBinding) objArr[5], (SVGAImageView) objArr[17], (ConstraintLayout) objArr[6], (ImageView) objArr[13], (FrameLayout) objArr[15], (ConstraintLayout) objArr[7], (IncludeJackaroItemBinding) objArr[2], (ConstraintLayout) objArr[16], (ConstraintLayout) objArr[18], (TextView) objArr[21], (ImageView) objArr[14], (IncludeJackaroItemBinding) objArr[4], (IncludeJackaroItemBinding) objArr[3], (LinearLayoutCompat) objArr[1], (ImageView) objArr[23], (ConstraintLayout) objArr[24], (TextView) objArr[25]);
        this.mDirtyFlags = -1L;
