...
public class ActivityGroupAllRankBindingImpl extends ActivityGroupAllRankBinding {
    ...
    public ActivityGroupAllRankBindingImpl(f fVar, View view) {
    ...
    private ActivityGroupAllRankBindingImpl(f fVar, View view, Object[] objArr) {
