...
public class ItemHiloGameMicBindingImpl extends ItemHiloGameMicBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.userTagLayout, 13);
        sparseIntArray.put(2131364298, 14);
        sparseIntArray.put(R.id.userTag, 15);
        sparseIntArray.put(R.id.micIcon, 16);
    }

    public ItemHiloGameMicBindingImpl(f fVar, View view) {
    ...
    private ItemHiloGameMicBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (ConstraintLayout) objArr[3], (ImageView) objArr[4], (SVGAImageView) objArr[5], (SVGAImageView) objArr[10], (View) objArr[2], (ImageView) objArr[6], (ImageView) objArr[16], (AppCompatImageView) objArr[12], (ImageView) objArr[9], (AppCompatImageView) objArr[11], (TextView) objArr[14], (PortraitAnimationView) objArr[1], (CircleImageView) objArr[7], (ImageView) objArr[8], (ImageView) objArr[15], (ConstraintLayout) objArr[13]);
        this.mDirtyFlags = -1L;
