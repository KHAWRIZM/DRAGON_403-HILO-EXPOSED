...
public class ItemMicroGameViewBindingImpl extends ItemMicroGameViewBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.face_svga, 15);
        sparseIntArray.put(R.id.personMicOff, 16);
        sparseIntArray.put(R.id.micOff, 17);
        sparseIntArray.put(R.id.musicSvga, 18);
    }

    public ItemMicroGameViewBindingImpl(f fVar, View view) {
    ...
    private ItemMicroGameViewBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (ConstraintLayout) objArr[3], (SVGAImageView) objArr[10], (ImageView) objArr[4], (SVGAImageView) objArr[5], (SVGAImageView) objArr[15], (ImageView) objArr[13], (ImageView) objArr[14], (View) objArr[2], (ImageView) objArr[6], (AppCompatImageView) objArr[17], (ImageView) objArr[11], (SVGAImageView) objArr[9], (SVGAImageView) objArr[18], (AppCompatImageView) objArr[16], (PortraitAnimationView) objArr[1], (CircleImageView) objArr[7], (ImageView) objArr[8], (ImageView) objArr[12]);
        this.mDirtyFlags = -1L;
