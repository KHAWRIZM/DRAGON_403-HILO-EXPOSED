...
public class ActivityMedalBindingImpl extends ActivityMedalBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.myMedal, 6);
    }

    public ActivityMedalBindingImpl(f fVar, View view) {
    ...
    private ActivityMedalBindingImpl(f fVar, View view, Object[] objArr) {
        super(fVar, view, 1, (FrameLayout) objArr[0], (TextView) objArr[6], (LinearLayout) objArr[3], (BackgroundTabLayout) objArr[4], (IncludeTitleWriteBinding) objArr[2], (ViewPager2) objArr[5]);
        this.mDirtyFlags = -1L;
