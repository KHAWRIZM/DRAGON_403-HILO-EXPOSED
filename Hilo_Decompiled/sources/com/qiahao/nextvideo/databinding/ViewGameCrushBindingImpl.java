...
public class ViewGameCrushBindingImpl extends ViewGameCrushBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.crushGameLayout, 15);
    ...
    public ViewGameCrushBindingImpl(f fVar, View view) {
