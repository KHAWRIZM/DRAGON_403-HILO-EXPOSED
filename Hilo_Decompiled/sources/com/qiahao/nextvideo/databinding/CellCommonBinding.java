...
public abstract class CellCommonBinding extends ViewDataBinding {
    ...
    public CellCommonBinding(Object obj, View view, int i, AppCompatImageView appCompatImageView, AppCompatTextView appCompatTextView, AppCompatTextView appCompatTextView2, CorneredImageView corneredImageView, AppCompatImageView appCompatImageView2, AppCompatTextView appCompatTextView3, AppCompatImageView appCompatImageView3, AppCompatTextView appCompatTextView4, GenderAgeTextView genderAgeTextView, AppCompatTextView appCompatTextView5) {
        super(obj, view, i);
    ...
    public static CellCommonBinding bind(View view) {
        g.g();
        return bind(view, null);
    }

    public static CellCommonBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        g.g();
        return inflate(layoutInflater, viewGroup, z, null);
    }

    @Deprecated
    public static CellCommonBinding bind(View view, Object obj) {
        return (CellCommonBinding) ViewDataBinding.bind(obj, view, R.layout.cell_common);
    }

    @Deprecated
    public static CellCommonBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (CellCommonBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.cell_common, viewGroup, z, obj);
    }

    public static CellCommonBinding inflate(LayoutInflater layoutInflater) {
        g.g();
        return inflate(layoutInflater, null);
    }

    @Deprecated
    public static CellCommonBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (CellCommonBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.cell_common, (ViewGroup) null, false, obj);
    }
}
