...
public class HiloCommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    private boolean A;
    private int B;
    private int C;
    private float D;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (HiloCommonTabLayout.this.d != intValue) {
                HiloCommonTabLayout.this.setCurrentTab(intValue);
                if (HiloCommonTabLayout.this.b0 != null) {
                    HiloCommonTabLayout.this.b0.onTabSelect(intValue);
                    return;
                }
                return;
            }
            if (HiloCommonTabLayout.this.b0 != null) {
                HiloCommonTabLayout.this.b0.onTabReselect(intValue);
            }
        }
    }
    ...
    public HiloCommonTabLayout(Context context) {
        this(context, null, 0);
    }
    ...
    private void c(int i, View view) {
        ...
        if (((o6.a) this.b.get(i)).getTabUnselectedIcon() != 0) {
            imageView.setImageDrawable(androidx.core.content.a.getDrawable(imageView.getContext(), ((o6.a) this.b.get(i)).getTabUnselectedIcon()));
        }
    ...
    private void j(int i) {
        ...
        for (int i3 = 0; i3 < this.f; i3++) {
            ...
            if (tabUnselectedIcon != 0) {
                imageView.setImageDrawable(androidx.core.content.a.getDrawable(imageView.getContext(), tabUnselectedIcon));
            }
            if (this.L == 1) {
                if (z) {
    ...
    public HiloCommonTabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public HiloCommonTabLayout(Context context, AttributeSet attributeSet, int i) {
