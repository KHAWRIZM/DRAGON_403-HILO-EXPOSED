...
public class Constants {
    ...
    public static final String DB_NAME = "emas_accs.db";
    ...
    public static final String KEY_ERROR_OBJ = "errorObj";
    ...
    public static final int SDK_VERSION_CODE = 222;
    public static final String SEND_TYPE_RES = "res";
    public static final String SHARED_FOLDER = "emas_accs";
    public static final String SHARED_MESSAGE_ID_FILE = "message";
    public static final String SP_APPKEY_FILE_NAME = "EMAS_ACCS_SDK_APPKEY";
    public static final String SP_APP_SECRET = "app_sercet";
    public static final String SP_CHANNEL_FILE_NAME = "EMAS_ACCS_SDK_CHANNEL";
    public static final String SP_COOKIE_FILE_NAME = "EMAS_ACCS_COOKIE";
    public static final String SP_FILE_NAME = "EMAS_ACCS_SDK";
    public static final String SP_KEY_APPKEY = "appkey";
    public static final String SP_KEY_BIND_SERVICE_ENABLE = "bind_service_enable";
    public static final String SP_KEY_CHANNEL_INIT = "channel_init";
    ...
    public static final String SP_KEY_ENABLE_CHANNEL_PROCESS = "enable_channel_process";
    ...
    public static final String SP_KEY_UTDID_LIST = "utdid_list";
    public static final String SP_KEY_VERSION = "version";
    public static final String SP_LOAD_SO_FILE_NAME = "EMAS_ACCS_LOAD_SO";
    ...
    public static ErrorCode getErrorCode(Intent intent) {
        if (intent.hasExtra(KEY_ERROR_OBJ)) {
            return intent.getSerializableExtra(KEY_ERROR_OBJ);
        }
        int intExtra = intent.getIntExtra(KEY_ERROR_CODE, 0);
        String stringExtra = intent.getStringExtra(KEY_ERROR_DETAIL);
        if (intExtra == 0) {
            return AccsErrorCode.SUCCESS;
        }
        return AccsErrorCode.convertNetworkSdkError(intExtra, stringExtra).detail(AccsErrorCode.getAllDetails(null)).build();
    }
}
