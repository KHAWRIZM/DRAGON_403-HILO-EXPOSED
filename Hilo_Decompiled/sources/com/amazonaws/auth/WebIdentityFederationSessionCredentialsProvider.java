...
public class WebIdentityFederationSessionCredentialsProvider implements AWSCredentialsProvider {
    ...
    public WebIdentityFederationSessionCredentialsProvider withRefreshThreshold(int i10) {
        setRefreshThreshold(i10);
        return this;
    }

    public WebIdentityFederationSessionCredentialsProvider withSessionDuration(int i10) {
