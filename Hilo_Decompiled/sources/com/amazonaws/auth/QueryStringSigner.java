...
public class QueryStringSigner extends AbstractAWSSigner implements Signer {
    ...
    private String getCanonicalizedResourcePath(com.amazonaws.Request<?> request) {
        String str = "";
    ...
    private String getFormattedTimestamp(int i10) {
        ...
        return simpleDateFormat.format(getSignatureDate(i10));
    }
    ...
    public void sign(com.amazonaws.Request<?> request, AWSCredentials aWSCredentials) {
        sign(request, SignatureVersion.V2, SigningAlgorithm.HmacSHA256, aWSCredentials);
    }

    public void sign(com.amazonaws.Request<?> request, SignatureVersion signatureVersion, SigningAlgorithm signingAlgorithm, AWSCredentials aWSCredentials) {
