...
public final class AwsChunkedEncodingInputStream extends SdkInputStream {
    ...
    public static long calculateStreamContentLength(long j10) {
        ...
        if (j10 >= 0) {
            ...
            long calculateSignedChunkLength = j12 * calculateSignedChunkLength(PlaybackStateCompat.ACTION_PREPARE_FROM_URI);
            if (j13 > 0) {
                j11 = calculateSignedChunkLength(j13);
            } else {
                j11 = 0;
            }
            return calculateSignedChunkLength + j11 + calculateSignedChunkLength(0L);
        }
    ...
    public int read(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int read = this.currentChunkIterator.read(bArr, i10, i11);
        if (read > 0) {
