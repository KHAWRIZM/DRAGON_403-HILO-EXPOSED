...
public class AWSCredentialsProviderChain implements AWSCredentialsProvider {
    ...
    public AWSCredentials getCredentials() {
        ...
        for (AWSCredentialsProvider aWSCredentialsProvider2 : this.credentialsProviders) {
            try {
                ...
                log.debug("Unable to load credentials from " + aWSCredentialsProvider2.toString() + ": " + e10.getMessage());
            }
        }
    ...
    public void setReuseLastProvider(boolean z10) {
        this.reuseLastProvider = z10;
    }
}
