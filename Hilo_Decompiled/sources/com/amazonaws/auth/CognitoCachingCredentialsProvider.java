...
public class CognitoCachingCredentialsProvider extends CognitoCredentialsProvider {
    ...
    private void saveCredentials(AWSSessionCredentials aWSSessionCredentials, long j10) {
        ...
        if (aWSSessionCredentials != null) {
            ...
            this.awsKeyValueStore.put(namespace(EXP_KEY), String.valueOf(j10));
        }
    }
    ...
    public AWSSessionCredentials getCredentials() {
        ...
        try {
            try {
                ...
                LOG.error("Failure to get credentials", e10);
                if (getLogins() != null) {
