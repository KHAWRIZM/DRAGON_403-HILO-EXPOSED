...
public abstract class AmazonWebServiceClient {
    ...
    private String computeServiceName() {
        ...
        if (indexOf2 < indexOf) {
            return StringUtils.lowerCase(simpleName.substring(indexOf2 + i10, indexOf));
        }
        throw new IllegalStateException("Unrecognized AWS http client class name " + simpleName);
    }

    private Signer computeSignerByServiceRegion(String str, String str2, String str3, boolean z10) {
    ...
    private Signer computeSignerByURI(URI uri, String str, boolean z10) {
        if (uri != null) {
            String serviceNameIntern = getServiceNameIntern();
            return computeSignerByServiceRegion(serviceNameIntern, AwsHostNameUtils.parseRegionName(uri.getHost(), serviceNameIntern), str, z10);
        }
    ...
    private URI toURI(String str) {
        if (!str.contains(HttpConstant.SCHEME_SPLIT)) {
            str = this.clientConfiguration.getProtocol().toString() + HttpConstant.SCHEME_SPLIT + str;
        }
        try {
            return new URI(str);
    ...
    public AmazonWebServiceClient withTimeOffset(int i10) {
        setTimeOffset(i10);
        return this;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Deprecated
    public final void endClientExecution(AWSRequestMetrics aWSRequestMetrics, Request<?> request, Response<?> response, boolean z10) {
        if (request != null) {
