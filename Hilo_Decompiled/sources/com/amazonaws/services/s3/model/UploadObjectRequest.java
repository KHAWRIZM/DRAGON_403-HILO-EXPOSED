...
public class UploadObjectRequest extends AbstractPutObjectRequest implements MaterialsDescriptionProvider, Serializable {
    ...
    public UploadObjectRequest withDiskLimit(long j10) {
        this.diskLimit = j10;
        return this;
    }
    ...
    public UploadObjectRequest withPartSize(long j10) {
        if (j10 >= 5242880) {
            this.partSize = j10;
            return this;
        }
    ...
    /* renamed from: clone */
    public UploadObjectRequest mo٢٦٩clone() {
        UploadObjectRequest uploadObjectRequest = (UploadObjectRequest) super.mo٢٦٩clone();
