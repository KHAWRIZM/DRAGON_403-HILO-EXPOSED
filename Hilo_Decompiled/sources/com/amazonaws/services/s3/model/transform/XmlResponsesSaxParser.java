...
public class XmlResponsesSaxParser {
    ...
    public static class CopyObjectResultHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3RequesterChargedResult, S3VersionResult {
        ...
        @Override // com.amazonaws.services.s3.internal.S3RequesterChargedResult
        public void setRequesterCharged(boolean z10) {
            this.result.setRequesterCharged(z10);
        }
    ...
    public static class ListBucketHandler extends AbstractHandler {
        ...
        public ListBucketHandler(boolean z10) {
            this.shouldSDKDecodeResponse = z10;
        }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("ListBucketResult")) {
                ...
                if (str2.equals("IsTruncated")) {
                    ...
                    if (lowerCase.startsWith(RequestConstant.FALSE)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static String decodeIfSpecified(String str, boolean z10) {
        if (z10) {
            return S3HttpUtils.urlDecode(str);
        }
        return str;
    }
    ...
    public static int parseInt(String str) {
        try {
            ...
            log.error("Unable to parse integer value '" + str + "'", e10);
            return -1;
        }
    }
    ...
    public static long parseLong(String str) {
        try {
            ...
            log.error("Unable to parse long value '" + str + "'", e10);
            return -1L;
        }
    }
