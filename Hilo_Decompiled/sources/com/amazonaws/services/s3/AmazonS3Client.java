...
public class AmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
    ...
    static {
        ...
        bucketRegionCache = Collections.synchronizedMap(new LinkedHashMap<String, String>(BUCKET_REGION_CACHE_SIZE, 1.1f, true) { // from class: com.amazonaws.services.s3.AmazonS3Client.1
            private static final long serialVersionUID = 23453;

            @Override // java.util.LinkedHashMap
            protected boolean removeEldestEntry(Map.Entry<String, String> entry) {
                if (size() > AmazonS3Client.BUCKET_REGION_CACHE_SIZE) {
                    return true;
                }
                return false;
            }
    ...
    private URI convertToVirtualHostEndpoint(URI uri, String str) {
        try {
            return new URI(uri.getScheme() + HttpConstant.SCHEME_SPLIT + str + InstructionFileId.DOT + uri.getAuthority());
    ...
    private void fireProgressEvent(ProgressListenerCallbackExecutor progressListenerCallbackExecutor, int i10) {
    ...
    private AccessControlList getAcl(String str, String str2, String str3, boolean z10, AmazonWebServiceRequest amazonWebServiceRequest) {
        ...
        populateRequesterPaysHeader(createRequest, z10);
    ...
    private String getBucketRegionViaHeadRequest(String str) {
        ...
        try {
            ...
            if (e10.getAdditionalDetails() != null) {
                str2 = e10.getAdditionalDetails().get(Headers.S3_BUCKET_REGION);
            }
    ...
    protected static void populateRequesterPaysHeader(Request<?> request, boolean z10) {
        if (z10) {
    ...
    private void setAcl(String str, String str2, String str3, CannedAccessControlList cannedAccessControlList, boolean z10, AmazonWebServiceRequest amazonWebServiceRequest) {
        if (amazonWebServiceRequest == null) {
            amazonWebServiceRequest = new GenericBucketRequest(str);
        }
    ...
    private void setContent(Request<?> request, byte[] bArr, String str, boolean z10) {
        ...
        if (z10) {
            try {
                request.addHeader(Headers.CONTENT_MD5, BinaryUtils.toBase64(Md5Utils.computeMD5Hash(bArr)));
            } catch (Exception e10) {
    ...
    private boolean shouldRetryCompleteMultipartUpload(AmazonWebServiceRequest amazonWebServiceRequest, AmazonS3Exception amazonS3Exception, int i10) {
        ...
        return this.completeMultipartUploadRetryCondition.shouldRetry(amazonWebServiceRequest, amazonS3Exception, i10);
    }

    private boolean shouldUseVirtualAddressing(URI uri, String str) {
        if (!this.clientOptions.isPathStyleAccess() && BucketNameUtils.isDNSBucketName(str) && !isValidIpV4Address(uri.getHost())) {
            return true;
        }
        return false;
    }
    ...
    public CompleteMultipartUploadResult completeMultipartUpload(CompleteMultipartUploadRequest completeMultipartUploadRequest) throws AmazonClientException, AmazonServiceException {
        ...
        while (true) {
            ...
            int i11 = i10 + 1;
            if (shouldRetryCompleteMultipartUpload(completeMultipartUploadRequest, completeMultipartUploadHandler.getAmazonS3Exception(), i10)) {
                i10 = i11;
            } else {
    ...
    public final ExecutionContext createExecutionContext(AmazonWebServiceRequest amazonWebServiceRequest) {
        ...
        return new S3ExecutionContext(this.requestHandler2s, z10, this);
    }

    protected <X extends AmazonWebServiceRequest> Request<X> createRequest(String str, String str2, X x10, HttpMethodName httpMethodName) {
        return createRequest(str, str2, x10, httpMethodName, null);
    }
    ...
    public DeleteObjectsResult deleteObjects(DeleteObjectsRequest deleteObjectsRequest) {
        ...
        createRequest.addParameter(ChatMenuDialog.CLICK_DELETE, null);
    ...
    public String getBucketLocation(GetBucketLocationRequest getBucketLocationRequest) throws AmazonClientException, AmazonServiceException {
        ...
        createRequest.addParameter(FirebaseAnalytics.Param.LOCATION, null);
    ...
    public void setNotificationThreshold(int i10) {
        this.notificationThreshold = i10;
    }
    ...
    private <X, Y extends AmazonWebServiceRequest> X invoke(Request<Y> request, HttpResponseHandler<AmazonWebServiceResponse<X>> httpResponseHandler, String str, String str2) {
        ...
        try {
            try {
                ...
                X x10 = (X) response.getAwsResponse();
                endClientExecution(awsRequestMetrics, request, response);
                return x10;
            } catch (AmazonS3Exception e10) {
                if (e10.getStatusCode() == 301 && e10.getAdditionalDetails() != null) {
                    String str3 = e10.getAdditionalDetails().get(Headers.S3_BUCKET_REGION);
    ...
    protected <X extends AmazonWebServiceRequest> Request<X> createRequest(String str, String str2, X x10, HttpMethodName httpMethodName, URI uri) {
        DefaultRequest defaultRequest = new DefaultRequest(x10, Constants.S3_SERVICE_DISPLAY_NAME);
    ...
    public URL generatePresignedUrl(GeneratePresignedUrlRequest generatePresignedUrlRequest) throws AmazonClientException {
        ...
        if (generatePresignedUrlRequest.getContentMd5() != null) {
            createRequest.addHeader(Headers.CONTENT_MD5, generatePresignedUrlRequest.getContentMd5());
        }
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) throws AmazonClientException, AmazonServiceException {
        ...
        if (l10 == null) {
            if (inputStream5.markSupported()) {
                createRequest.addHeader("Content-Length", String.valueOf(calculateContentLength(inputStream5)));
                ...
                ByteArrayInputStream byteArray = toByteArray(inputStream5);
            ...
            if (longValue >= 0) {
                ...
                createRequest.addHeader("Content-Length", l10.toString());
        ...
        try {
            try {
                ...
                try {
                    ...
                    log.debug("Unable to cleanly close input stream: " + e12.getMessage(), e12);
                }
    ...
    private void setAcl(String str, String str2, String str3, AccessControlList accessControlList, boolean z10, AmazonWebServiceRequest amazonWebServiceRequest) {
        if (amazonWebServiceRequest == null) {
            amazonWebServiceRequest = new GenericBucketRequest(str);
        }
        Request createRequest = createRequest(str, str2, amazonWebServiceRequest, HttpMethodName.PUT);
    ...
    @Override // com.amazonaws.services.s3.AmazonS3
    public void restoreObject(String str, String str2, int i10) throws AmazonServiceException {
        restoreObject(new RestoreObjectRequest(str, str2, i10));
    }
