...
class S3CryptoModuleEO extends S3CryptoModuleBase<MultipartUploadCbcContext> {
    ...
    protected final long ciphertextLength(long j10) {
        ...
        return j10 + (blockSizeInBytes - (j10 % blockSizeInBytes));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.amazonaws.services.s3.internal.crypto.S3CryptoModuleBase
    public final ByteRangeCapturingInputStream wrapForMultipart(CipherLiteInputStream cipherLiteInputStream, long j10) {
        return new ByteRangeCapturingInputStream(cipherLiteInputStream, j10 - this.contentCryptoScheme.getBlockSizeInBytes(), j10);
    }
