...
public class EncryptionUtils {
    ...
    public static Cipher createSymmetricCipher(SecretKey secretKey, int i10, Provider provider, byte[] bArr) {
        Cipher cipher;
        try {
            if (provider != null) {
    ...
    private static InputStream getEncryptedInputStream(PutObjectRequest putObjectRequest, CipherFactory cipherFactory, long j10) {
        try {
