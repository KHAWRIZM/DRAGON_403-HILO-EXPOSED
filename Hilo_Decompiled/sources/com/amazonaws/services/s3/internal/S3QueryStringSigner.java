...
public class S3QueryStringSigner extends AbstractAWSSigner {
    ...
    public void sign(Request<?> request, AWSCredentials aWSCredentials) {
        ...
        String l10 = Long.toString(this.expiration.getTime() / TIME_TO_SECONDS.longValue());
        String signAndBase64Encode = super.signAndBase64Encode(RestUtils.makeS3CanonicalString(this.httpVerb, this.resourcePath, request, l10), sanitizeCredentials.getAWSSecretKey(), SigningAlgorithm.HmacSHA1);
        request.addParameter("AWSAccessKeyId", sanitizeCredentials.getAWSAccessKeyId());
        request.addParameter(Headers.EXPIRES, l10);
