...
public final class Mimetypes {
    ...
    Mimetypes() {
        ...
        hashMap.put(ImageTypeDialog.CLICK_GIFT, "image/gif");
    ...
    public String getMimetype(String str) {
        ...
        if (lastIndexOf > 0 && (i10 = lastIndexOf + 1) < str.length()) {
            String lowerCase = StringUtils.lowerCase(str.substring(i10));
            ...
            if (log3.isDebugEnabled()) {
                log3.debug("Extension '" + lowerCase + "' is unrecognized in mime type listing, using default mime type: '" + MIMETYPE_OCTET_STREAM + "'");
            }
        } else {
            Log log4 = log;
