...
public class AmazonS3EncryptionClient extends AmazonS3Client implements AmazonS3Encryption {
    ...
    public void deleteObject(DeleteObjectRequest deleteObjectRequest) {
        ...
        DeleteObjectRequest deleteObjectRequest2 = (DeleteObjectRequest) deleteObjectRequest.mo٢٦٩clone();
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
        ...
        if (initiateMultipartUploadRequest instanceof EncryptedInitiateMultipartUploadRequest) {
            z10 = ((EncryptedInitiateMultipartUploadRequest) initiateMultipartUploadRequest).isCreateEncryptionMaterial();
        } else {
            z10 = true;
        }
        if (z10) {
    ...
    @Override // com.amazonaws.services.s3.AmazonS3Client, com.amazonaws.services.s3.AmazonS3, com.amazonaws.services.s3.internal.S3DirectSpi
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) {
        return this.crypto.putObjectSecurely(putObjectRequest.mo٢٦٩clone());
    }
            ...
            try {
                try {
                    try {
                        ...
                        throw ((ExecutionException) onAbort(uploadObjectObserver, e10));
                    }
                } catch (IOException e11) {
                    throw ((IOException) onAbort(uploadObjectObserver, e11));
                } catch (InterruptedException e12) {
                    throw ((InterruptedException) onAbort(uploadObjectObserver, e12));
                }
            } catch (Error e13) {
                throw ((Error) onAbort(uploadObjectObserver, e13));
            } catch (RuntimeException e14) {
                throw ((RuntimeException) onAbort(uploadObjectObserver, e14));
            }
        } catch (Throwable th) {
            if (z10) {
                executorService.shutdownNow();
    ...
    public AmazonS3EncryptionClient(AWSKMSClient aWSKMSClient, AWSCredentialsProvider aWSCredentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider, ClientConfiguration clientConfiguration, CryptoConfiguration cryptoConfiguration, RequestMetricCollector requestMetricCollector) {
        ...
        AWSKMSClient newAWSKMSClient = z10 ? newAWSKMSClient(aWSCredentialsProvider, clientConfiguration, cryptoConfiguration, requestMetricCollector) : aWSKMSClient;
