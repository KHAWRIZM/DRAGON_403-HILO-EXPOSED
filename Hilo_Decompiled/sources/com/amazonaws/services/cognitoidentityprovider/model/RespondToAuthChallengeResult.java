...
public class RespondToAuthChallengeResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (respondToAuthChallengeResult.getChallengeName() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (respondToAuthChallengeResult.getSession() == null) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (respondToAuthChallengeResult.getChallengeParameters() == null) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        if (respondToAuthChallengeResult.getAuthenticationResult() == null) {
            z16 = true;
        } else {
            z16 = false;
        }
