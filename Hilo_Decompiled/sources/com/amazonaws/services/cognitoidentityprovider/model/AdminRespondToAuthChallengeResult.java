...
public class AdminRespondToAuthChallengeResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (adminRespondToAuthChallengeResult.getChallengeName() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (adminRespondToAuthChallengeResult.getSession() == null) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (adminRespondToAuthChallengeResult.getChallengeParameters() == null) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        if (adminRespondToAuthChallengeResult.getAuthenticationResult() == null) {
            z16 = true;
        } else {
            z16 = false;
        }
