...
public class UpdateIdentityProviderResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (updateIdentityProviderResult.getIdentityProvider() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (updateIdentityProviderResult.getIdentityProvider() == null || updateIdentityProviderResult.getIdentityProvider().equals(getIdentityProvider())) {
            return true;
        }
        return false;
    }
