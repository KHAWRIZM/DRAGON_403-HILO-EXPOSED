...
public class DescribeIdentityProviderResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (describeIdentityProviderResult.getIdentityProvider() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (describeIdentityProviderResult.getIdentityProvider() == null || describeIdentityProviderResult.getIdentityProvider().equals(getIdentityProvider())) {
            return true;
        }
        return false;
    }
