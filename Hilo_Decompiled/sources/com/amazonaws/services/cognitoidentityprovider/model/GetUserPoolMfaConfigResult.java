...
public class GetUserPoolMfaConfigResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getUserPoolMfaConfigResult.getSmsMfaConfiguration() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (getUserPoolMfaConfigResult.getSoftwareTokenMfaConfiguration() == null) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (getUserPoolMfaConfigResult.getMfaConfiguration() == null) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        if (getUserPoolMfaConfigResult.getMfaConfiguration() == null || getUserPoolMfaConfigResult.getMfaConfiguration().equals(getMfaConfiguration())) {
            return true;
        }
        return false;
    }
