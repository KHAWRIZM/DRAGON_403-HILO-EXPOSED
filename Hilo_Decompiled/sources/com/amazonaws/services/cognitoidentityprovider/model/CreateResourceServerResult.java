...
public class CreateResourceServerResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (createResourceServerResult.getResourceServer() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (createResourceServerResult.getResourceServer() == null || createResourceServerResult.getResourceServer().equals(getResourceServer())) {
            return true;
        }
        return false;
    }
