...
public class AdminInitiateAuthResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (adminInitiateAuthResult.getChallengeName() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (adminInitiateAuthResult.getSession() == null) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (adminInitiateAuthResult.getChallengeParameters() == null) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        if (adminInitiateAuthResult.getAuthenticationResult() == null) {
            z16 = true;
        } else {
            z16 = false;
        }
