...
public class SignUpRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        if (getPassword() == null) {
            ...
            hashCode4 = getPassword().hashCode();
        }
        int i14 = (i13 + hashCode4) * 31;
        if (getUserAttributes() == null) {
            hashCode5 = 0;
        } else {
            hashCode5 = getUserAttributes().hashCode();
        }
        int i15 = (i14 + hashCode5) * 31;
        if (getValidationData() == null) {
            hashCode6 = 0;
        } else {
            hashCode6 = getValidationData().hashCode();
        }
        int i16 = (i15 + hashCode6) * 31;
        if (getAnalyticsMetadata() == null) {
            hashCode7 = 0;
        } else {
            hashCode7 = getAnalyticsMetadata().hashCode();
        }
        int i17 = (i16 + hashCode7) * 31;
        if (getUserContextData() == null) {
            hashCode8 = 0;
        } else {
            hashCode8 = getUserContextData().hashCode();
        }
