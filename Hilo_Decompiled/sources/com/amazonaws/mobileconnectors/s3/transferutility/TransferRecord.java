...
public class TransferRecord {
                ...
                new Thread(new Runnable() { // from class: com.amazonaws.mobileconnectors.s3.transferutility.TransferRecord.1
                    ...
                    public void run() {
                        try {
                            ...
                            TransferRecord.LOGGER.debug("Failed to abort multiplart upload: " + TransferRecord.this.id, e10);
                        }
                    }
                }).start();
    ...
    public void updateFromDB(Cursor cursor) {
        ...
        this.transferUtilityOptions = (TransferUtilityOptions) this.gson.j(cursor.getString(cursor.getColumnIndexOrThrow(TransferTable.COLUMN_TRANSFER_UTILITY_OPTIONS)), TransferUtilityOptions.class);
    }

    void waitTillFinish(long j10) throws InterruptedException, ExecutionException, TimeoutException {
        if (isRunning()) {
            this.submittedTask.get(j10, TimeUnit.MILLISECONDS);
        }
    }
}
