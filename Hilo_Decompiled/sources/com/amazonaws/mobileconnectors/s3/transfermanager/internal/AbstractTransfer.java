...
public abstract class AbstractTransfer implements Transfer {
    ...
    public void fireProgressEvent(int i10) {
        ProgressListenerCallbackExecutor.progressChanged(this.progressListenerChain, new ProgressEvent(i10, 0L));
    }
    ...
    public AmazonClientException waitForException() throws InterruptedException {
        while (!this.monitor.isDone()) {
            try {
                ...
                return unwrapExecutionException(e10);
            }
        }
        this.monitor.getFuture().get();
        return null;
