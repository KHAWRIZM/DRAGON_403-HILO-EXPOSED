...
public class HttpUtils {
    ...
    public static boolean isUsingNonDefaultPort(URI uri) {
        ...
        if (HttpConstant.HTTP.equals(lowerCase) && port == 80) {
            return false;
        }
        if (HttpConstant.HTTPS.equals(lowerCase) && port == PORT_HTTPS) {
            return false;
        }
        return true;
    }
    ...
    public static String appendUri(String str, String str2, boolean z10) {
