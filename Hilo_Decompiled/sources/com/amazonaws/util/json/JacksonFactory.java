...
final class JacksonFactory implements AwsJsonFactory {
    ...
    private static final class JacksonReader implements AwsJsonReader {
        ...
        public boolean hasNext() throws IOException {
            nextToken();
            if (JsonToken.END_OBJECT != this.nextToken && JsonToken.END_ARRAY != this.nextToken) {
                return true;
            }
            return false;
        }
        ...
        public boolean isContainer() throws IOException {
            nextToken();
            if (JsonToken.START_ARRAY != this.nextToken && JsonToken.START_OBJECT != this.nextToken) {
                return false;
            }
            return true;
        }
