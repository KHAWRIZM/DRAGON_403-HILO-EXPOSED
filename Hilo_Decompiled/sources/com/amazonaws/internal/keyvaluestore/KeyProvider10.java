...
class KeyProvider10 implements KeyProvider {
    ...
    public synchronized void deleteKey(String str) {
        try {
            ...
            logger.error("Error in deleting the AES key identified by " + str + " from SharedPreferences.", e10);
        }
    }
    ...
    public synchronized Key generateKey(String str) throws KeyNotGeneratedException {
        ...
        try {
            ...
            throw new KeyNotGeneratedException("Error in generating the AES Encryption key for the aesEncryptionKeyAlias", e10);
        }
        return generateKey;
    }
    ...
    public synchronized Key retrieveKey(String str) throws KeyNotFoundException {
        ...
        try {
            ...
            throw new KeyNotFoundException("Error occurred while retrieving key for keyAlias: " + str, e10);
        }
