...
public class OAuth2ClientStore {
    ...
    public OAuth2Tokens getTokens() {
        ...
        try {
            ...
            return new OAuth2Tokens(this.mKeyValueStore.get(OAuth2Constants.TokenResponseFields.ACCESS_TOKEN.toString()), this.mKeyValueStore.get(OAuth2Constants.TokenResponseFields.ID_TOKEN.toString()), this.mKeyValueStore.get(OAuth2Constants.TokenResponseFields.REFRESH_TOKEN.toString()), this.mKeyValueStore.get(OAuth2Constants.TokenResponseFields.TOKEN_TYPE.toString()), decode, Long.valueOf(this.mKeyValueStore.get(OAuth2Client.CREATE_DATE)), this.mKeyValueStore.get(OAuth2Constants.TokenResponseFields.SCOPES.toString()));
        } finally {
            this.mReadWriteLock.readLock().unlock();
        }
    }
    ...
    public void setPersistenceEnabled(boolean z10) {
        this.mKeyValueStore.setPersistenceEnabled(z10);
    }
