...
class HttpClientFactory {
    ...
    public org.apache.http.client.HttpClient createHttpClient(ClientConfiguration clientConfiguration) {
        ...
        int i10 = clientConfiguration.getSocketBufferSizeHints()[0];
        int i11 = clientConfiguration.getSocketBufferSizeHints()[1];
        if (i10 > 0 || i11 > 0) {
        ...
        Scheme scheme = new Scheme(HttpConstant.HTTP, PlainSocketFactory.getSocketFactory(), 80);
        SSLSocketFactory socketFactory = SSLSocketFactory.getSocketFactory();
        socketFactory.setHostnameVerifier(SSLSocketFactory.STRICT_HOSTNAME_VERIFIER);
        Scheme scheme2 = new Scheme(HttpConstant.HTTPS, socketFactory, HTTPS_PORT);
