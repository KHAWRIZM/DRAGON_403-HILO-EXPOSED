...
public abstract class BaseItemProvider<T> {
    ...
    public BaseItemProvider() {
        ...
        this.clickViewIds = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<ArrayList<Integer>>() { // from class: com.chad.library.adapter.base.provider.BaseItemProvider$clickViewIds$2
        ...
        this.longClickViewIds = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<ArrayList<Integer>>() { // from class: com.chad.library.adapter.base.provider.BaseItemProvider$longClickViewIds$2
            @Override // kotlin.jvm.functions.Function0
            @NotNull
            public final ArrayList<Integer> invoke() {
                return new ArrayList<>();
    ...
    public abstract void convert(@NotNull BaseViewHolder helper, T item);
    ...
    public final void setAdapter$com_github_CymChad_brvah(@NotNull BaseProviderMultiAdapter<T> adapter) {
