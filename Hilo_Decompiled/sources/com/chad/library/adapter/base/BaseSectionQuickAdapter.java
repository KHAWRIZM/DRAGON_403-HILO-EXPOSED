...
public abstract class BaseSectionQuickAdapter<T extends SectionEntity, VH extends BaseViewHolder> extends BaseMultiItemQuickAdapter<T, VH> {
    ...
    protected abstract void convertHeader(@NotNull VH helper, @NotNull T item);
    ...
    public boolean isFixedViewType(int type) {
        if (!super.isFixedViewType(type) && type != -99) {
            return false;
        }
        return true;
    }
    ...
    public /* synthetic */ BaseSectionQuickAdapter(int i10, List list, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public /* synthetic */ BaseSectionQuickAdapter(int i10, int i11, List list, int i12, DefaultConstructorMarker defaultConstructorMarker) {
