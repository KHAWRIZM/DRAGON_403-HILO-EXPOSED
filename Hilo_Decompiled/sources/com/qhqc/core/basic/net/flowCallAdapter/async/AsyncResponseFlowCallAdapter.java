...
public final class AsyncResponseFlowCallAdapter<R> implements CallAdapter<R, Flow<? extends Response<R>>> {
    ...
    public Flow<Response<R>> adapt(@NotNull Call<R> call) {
        ...
        return AsyncResponseFlowCallAdapterKt.asyncResponseFlow(call);
    }
}
