...
public final class RootViewDeferringInsetsCallback extends q1.b implements j0 {
    ...
    public d2 onApplyWindowInsets(@NotNull View v10, @NotNull d2 windowInsets) {
        ...
        v10.setPadding(f10.f٢٧٩٣a, 0, f10.f٢٧٩٥c, f10.f٢٧٩٦d);
