...
public class LineScaleIndicator extends Indicator {
    ...
    @Override // com.qhqc.core.basic.widget.svprogresshud.indicator.Indicator
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        for (final int i10 = 0; i10 < 5; i10++) {
            ...
            addUpdateListener(ofFloat, new ValueAnimator.AnimatorUpdateListener() { // from class: com.qhqc.core.basic.widget.svprogresshud.indicator.c
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    LineScaleIndicator.onCreateAnimators$lambda$0(LineScaleIndicator.this, i10, valueAnimator);
                }
            });
