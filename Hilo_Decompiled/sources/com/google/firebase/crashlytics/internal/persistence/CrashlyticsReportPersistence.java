...
public class CrashlyticsReportPersistence {
    ...
    private void synthesizeReport(String str, long j10) {
        ...
        synthesizeReportFile(this.fileStore.getSessionFile(str, "report"), arrayList, j10, z10, UserMetadata.readUserId(str, this.fileStore), this.sessionsSubscriber.getAppQualitySessionId(str));
    }

    private void synthesizeReportFile(File file, List<CrashlyticsReport.Session.Event> list, long j10, boolean z10, String str, String str2) {
        File report;
        try {
            CrashlyticsReportJsonTransform crashlyticsReportJsonTransform = TRANSFORM;
            CrashlyticsReport withEvents = crashlyticsReportJsonTransform.reportFromJson(readTextFile(file)).withSessionEndFields(j10, z10, str).withAppQualitySessionId(str2).withEvents(list);
