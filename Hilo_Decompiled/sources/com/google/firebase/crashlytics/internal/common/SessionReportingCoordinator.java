...
public class SessionReportingCoordinator {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$persistEvent$0(CrashlyticsReport.Session.Event event, EventMetadata eventMetadata, boolean z10) {
        Logger.getLogger().d("disk worker: log non-fatal event to persistence");
        this.reportPersistence.persistEvent(event, eventMetadata.getSessionId(), z10);
    }
    ...
    private void persistEvent(Throwable th, Thread thread, String str, final EventMetadata eventMetadata, boolean z10) {
        final boolean equals = str.equals("crash");
        final CrashlyticsReport.Session.Event addMetaDataToEvent = addMetaDataToEvent(this.dataCapture.captureEventData(th, thread, str, eventMetadata.getTimestamp(), 4, 8, z10), eventMetadata.getAdditionalCustomKeys());
        if (!z10) {
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.b0
    ...
    public void persistFatalEvent(Throwable th, Thread thread, String str, long j10) {
        ...
        persistEvent(th, thread, "crash", new EventMetadata(str, j10), true);
    }
    ...
    public Task<Void> sendReports(Executor executor, String str) {
        ...
        for (CrashlyticsReportWithSessionId crashlyticsReportWithSessionId : loadFinalizedReports) {
            if (str == null || str.equals(crashlyticsReportWithSessionId.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(ensureHasFid(crashlyticsReportWithSessionId), str != null).continueWith(executor, new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.d0
