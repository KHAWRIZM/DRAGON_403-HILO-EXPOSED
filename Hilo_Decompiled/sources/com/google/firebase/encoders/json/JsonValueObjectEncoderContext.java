...
public final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    JsonValueObjectEncoderContext doEncode(ObjectEncoder<Object> objectEncoder, Object obj, boolean z10) throws IOException {
        if (!z10) {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, double d10) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(d10);
    }
