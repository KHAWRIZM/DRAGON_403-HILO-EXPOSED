...
public class NotificationParams {
    ...
    public int[] getLightSettings() {
        ...
        try {
            ...
            Log.w(TAG, "LightSettings is invalid: " + jSONArray + ". " + e10.getMessage() + ". Skipping setting LightSettings");
            return null;
        } catch (JSONException unused) {
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        try {
            ...
            Log.w(TAG, "Missing format argument for " + userFriendlyKey(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e10);
            return null;
        }
    }
