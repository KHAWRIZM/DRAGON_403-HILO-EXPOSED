...
public class MessagingAnalytics {
    ...
    static long getProjectNumber(Bundle bundle) {
        ...
        if (!applicationId.startsWith("1:")) {
            ...
            try {
                ...
                Log.w(Constants.TAG, "error parsing app ID", e13);
            }
        }
        return 0L;
    }
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, z6.j jVar) {
        if (jVar == null) {
        ...
        try {
            jVar.a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, z6.c.b("proto"), new z6.h() { // from class: com.google.firebase.messaging.c0
                @Override // z6.h
                public final Object apply(Object obj) {
                    return ((MessagingClientEventExtension) obj).toByteArray();
                }
            }).b(z6.d.g(MessagingClientEventExtension.newBuilder().setMessagingClientEvent(eventToProto).build(), z6.g.b(Integer.valueOf(intent.getIntExtra(Constants.MessagePayloadKeys.PRODUCT_ID, DEFAULT_PRODUCT_ID)))));
