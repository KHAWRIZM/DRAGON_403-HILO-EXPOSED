...
public final class ProxyNotificationInitializer {
    ...
    public static void initialize(Context context) {
        ...
        setEnableProxyNotification(new androidx.credentials.b(), context, shouldEnableProxyNotification(context));
    }
    ...
    public static Task<Void> setEnableProxyNotification(Executor executor, final Context context, final boolean z10) {
        ...
        executor.execute(new Runnable() { // from class: com.google.firebase.messaging.f0
