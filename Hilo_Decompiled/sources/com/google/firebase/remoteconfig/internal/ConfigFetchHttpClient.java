...
public class ConfigFetchHttpClient {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l10, Map<String, String> map2) throws FirebaseRemoteConfigClientException {
        ...
        if (str != null) {
            ...
            try {
                ...
                if (packageInfo != null) {
                    ...
                    hashMap.put(RemoteConfigConstants.RequestFieldKey.APP_BUILD, Long.toString(g2.a.a(packageInfo)));
                }
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            Log.e(FirebaseRemoteConfig.TAG, "No such package: " + this.context.getPackageName(), e10);
            return null;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Keep
    public ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l10, Date date, Map<String, String> map3) throws FirebaseRemoteConfigException {
        setUpUrlConnection(httpURLConnection, str3, str2, map2);
        try {
            try {
                setFetchRequestBody(httpURLConnection, createFetchRequestBody(str, str2, map, l10, map3).toString().getBytes("utf-8"));
