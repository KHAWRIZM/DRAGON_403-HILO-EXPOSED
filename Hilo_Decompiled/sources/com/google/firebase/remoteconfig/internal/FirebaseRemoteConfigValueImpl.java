...
public class FirebaseRemoteConfigValueImpl implements FirebaseRemoteConfigValue {
    ...
    public double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format(ILLEGAL_ARGUMENT_STRING_FORMAT, asTrimmedString, "double"), e10);
        }
    }
    ...
    public long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format(ILLEGAL_ARGUMENT_STRING_FORMAT, asTrimmedString, "long"), e10);
        }
    }
