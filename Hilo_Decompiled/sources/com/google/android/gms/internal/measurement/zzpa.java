...
public final class zzpa implements zzoz {
    ...
    static {
        ...
        zza = zzb2.zzc("measurement.ad_id_cache_time", BaseServer.TIMEOUT_DEBUG);
        ...
        zzh = zzb2.zzf("measurement.config.url_scheme", HttpConstant.HTTPS);
        ...
        zzE = zzb2.zzc("measurement.upload.realtime_upload_interval", BaseServer.TIMEOUT_DEBUG);
        ...
        zzQ = zzb2.zzc("measurement.sgtm.upload.min_delay_after_background", AuthenticationTokenClaims.MAX_TIME_SINCE_TOKEN_ISSUED);
        ...
        zzT = zzb2.zzc("measurement.sgtm.upload.retry_interval", AuthenticationTokenClaims.MAX_TIME_SINCE_TOKEN_ISSUED);
        ...
        zzac = zzb2.zzf("measurement.rb.attribution.uri_scheme", HttpConstant.HTTPS);
