...
public final class zzba extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = RequestConstant.FALSE, id = 11)
    final boolean zzi;

    @SafeParcelable.Field(defaultValueUnchecked = RequestConstant.FALSE, id = 12)
    boolean zzj;
    ...
    public final zzba zzb(long j10) {
        if (this.zzb.getMaxWaitTime() <= this.zzb.getInterval()) {
            this.zzl = BaseServer.TIMEOUT_DEBUG;
            return this;
        }
