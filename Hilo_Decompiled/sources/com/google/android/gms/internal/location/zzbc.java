...
public final class zzbc extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, id = 2)
    final zzba zzb;

    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, getter = "getLocationListenerBinder", id = 3, type = "android.os.IBinder")
    final com.google.android.gms.location.zzbd zzc;

    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, id = 4)
    final PendingIntent zzd;

    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, getter = "getLocationCallbackBinder", id = 5, type = "android.os.IBinder")
    final com.google.android.gms.location.zzba zze;

    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, getter = "getFusedLocationProviderCallbackBinder", id = 6, type = "android.os.IBinder")
    final zzai zzf;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public zzbc(@SafeParcelable.Param(id = 1) int i10, @SafeParcelable.Param(id = 2) zzba zzbaVar, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(id = 5) IBinder iBinder2, @SafeParcelable.Param(id = 6) IBinder iBinder3) {
