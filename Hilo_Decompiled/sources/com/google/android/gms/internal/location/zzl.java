...
public final class zzl extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, getter = "getDeviceOrientationListenerBinder", id = 3, type = "android.os.IBinder")
    final com.google.android.gms.location.zzax zzc;

    @SafeParcelable.Field(defaultValueUnchecked = Constants.NULL_VERSION_ID, getter = "getFusedLocationProviderCallbackBinder", id = 4, type = "android.os.IBinder")
    final zzai zzd;
