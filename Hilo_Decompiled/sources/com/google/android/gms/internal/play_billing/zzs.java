...
public interface zzs extends IInterface {
    ...
    void zzq(int i10, String str, Bundle bundle, zzl zzlVar) throws RemoteException;

    void zzr(int i10, String str, Bundle bundle, zzn zznVar) throws RemoteException;

    void zzs(int i10, String str, Bundle bundle, zzp zzpVar) throws RemoteException;

    void zzt(int i10, String str, Bundle bundle, zzu zzuVar) throws RemoteException;

    int zzy(int i10, String str, String str2) throws RemoteException;
}
