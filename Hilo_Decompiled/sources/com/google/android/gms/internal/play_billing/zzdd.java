...
public final class zzdd {
    ...
    static {
        ...
        zzc = zzddVar3;
        zzdd zzddVar4 = new zzdd("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(DownloadProgress.UNKNOWN_PROGRESS));
        zzd = zzddVar4;
        zzdd zzddVar5 = new zzdd("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        zze = zzddVar5;
