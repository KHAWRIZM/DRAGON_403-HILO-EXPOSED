...
public final class zzfg {
                        ...
                        if (i16 != 2) {
                            if (i16 != 3) {
                                if (i16 == 5) {
                                    ...
                                    i10 = zzby.zzw(i15 << 3) + 4;
                                } else {
                                    throw new IllegalStateException(zzdc.zza());
                                }
                            } else {
                                int zzw2 = zzby.zzw(i15 << 3);
                                zzw = zzw2 + zzw2;
                                zzx = ((zzfg) this.zzd[i13]).zza();
                            }
                        } else {
                            int i17 = i15 << 3;
                            zzbq zzbqVar = (zzbq) this.zzd[i13];
                            int zzw3 = zzby.zzw(i17);
                            int zzd = zzbqVar.zzd();
                            i10 = zzw3 + zzby.zzw(zzd) + zzd;
                        }
                    } else {
                        ((Long) this.zzd[i13]).longValue();
                        i10 = zzby.zzw(i15 << 3) + 8;
                    }
                    i12 += i10;
                } else {
                    int i18 = i15 << 3;
    ...
    public final int zzb() {
        ...
        if (i10 == -1) {
            ...
            for (int i12 = 0; i12 < this.zzb; i12++) {
                ...
                int zzw = zzby.zzw(8);
                int zzw2 = zzby.zzw(16) + zzby.zzw(i13);
                int zzw3 = zzby.zzw(24);
                int zzd = zzbqVar.zzd();
                i11 += zzw + zzw + zzw2 + zzw3 + zzby.zzw(zzd) + zzd;
            }
            this.zze = i11;
            return i11;
        }
    ...
    public final void zzi(StringBuilder sb, int i10) {
        for (int i11 = 0; i11 < this.zzb; i11++) {
            zzee.zzb(sb, i10, String.valueOf(this.zzc[i11] >>> 3), this.zzd[i11]);
        }
    }
