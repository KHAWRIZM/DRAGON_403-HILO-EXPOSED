...
public final class zzq extends zzv implements zzs {
    ...
    public final Bundle zzl(int i10, String str, String str2, Bundle bundle, Bundle bundle2) throws RemoteException {
        ...
        zzx.zzc(zzu, bundle);
        zzx.zzc(zzu, bundle2);
        Parcel zzv = zzv(VideoCapture.VideoCaptureEvent.kCameraErrorRuntimeUnknown, zzu);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.android.gms.internal.play_billing.zzs
    public final void zzq(int i10, String str, Bundle bundle, zzl zzlVar) throws RemoteException {
        Parcel zzu = zzu();
        zzu.writeInt(22);
        zzu.writeString(str);
        zzx.zzc(zzu, bundle);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.android.gms.internal.play_billing.zzs
    public final void zzr(int i10, String str, Bundle bundle, zzn zznVar) throws RemoteException {
        Parcel zzu = zzu();
        zzu.writeInt(21);
        zzu.writeString(str);
        zzx.zzc(zzu, bundle);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.android.gms.internal.play_billing.zzs
    public final void zzs(int i10, String str, Bundle bundle, zzp zzpVar) throws RemoteException {
        Parcel zzu = zzu();
        zzu.writeInt(22);
        zzu.writeString(str);
        zzx.zzc(zzu, bundle);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.android.gms.internal.play_billing.zzs
    public final void zzt(int i10, String str, Bundle bundle, zzu zzuVar) throws RemoteException {
        Parcel zzu = zzu();
        zzu.writeInt(12);
        zzu.writeString(str);
        zzx.zzc(zzu, bundle);
