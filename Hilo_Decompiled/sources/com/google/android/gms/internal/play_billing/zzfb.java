...
public class zzfb extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i11 = 0;
        if (i10 >= 0) {
            int compareTo = comparable.compareTo(((zzev) this.zzb.get(i10)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i11 <= i10) {
            int i12 = (i11 + i10) / 2;
            int compareTo2 = comparable.compareTo(((zzev) this.zzb.get(i12)).zza());
            if (compareTo2 < 0) {
                i10 = i12 - 1;
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < zzb; i11++) {
            i10 += ((zzev) this.zzb.get(i11)).hashCode();
        }
        if (this.zzc.size() > 0) {
