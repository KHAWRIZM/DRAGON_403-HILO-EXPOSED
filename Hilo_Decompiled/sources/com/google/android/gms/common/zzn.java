...
public final class zzn {
    ...
    public static /* synthetic */ String zzd(boolean z10, String str, zzj zzjVar) throws Exception {
        String str2;
        if (!z10 && zzh(str, zzjVar, true, false).zza) {
    ...
    private static zzw zzh(final String str, final zzj zzjVar, final boolean z10, boolean z11) {
        try {
            ...
            try {
                if (zze.zzh(new zzs(str, zzjVar, z10, z11), ObjectWrapper.wrap(zzg.getPackageManager()))) {
                    return zzw.zzb();
                }
                return new zzu(new Callable() { // from class: com.google.android.gms.common.zze
    ...
    private static zzw zzi(String str, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        try {
            ...
            try {
                ...
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e11);
                zzd2 = zzw.zzd("module init: ".concat(String.valueOf(e11.getMessage())), e11);
            }
            StrictMode.setThreadPolicy(allowThreadDiskReads);
            return zzd2;
        } catch (Throwable th) {
