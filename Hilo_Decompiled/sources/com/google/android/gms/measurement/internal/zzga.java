...
public interface zzga extends IInterface {
    ...
    void zzl(long j10, String str, String str2, String str3) throws RemoteException;
    ...
    List zzp(String str, String str2, boolean z10, zzr zzrVar) throws RemoteException;

    List zzq(String str, String str2, String str3, boolean z10) throws RemoteException;
