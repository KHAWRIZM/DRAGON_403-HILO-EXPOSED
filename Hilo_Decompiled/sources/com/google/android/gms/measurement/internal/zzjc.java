...
public final class zzjc extends zzfz {
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        zzav zzj3 = zzpfVar2.zzj();
        long j10 = zzrVar.zzD;
        if (zzj3.zzX(str, j10)) {
            zzpfVar2.zzj().zzY(str, Long.valueOf(j10), null, bundle);
        }
    }
    ...
    public final void zzl(long j10, String str, String str2, String str3) {
        zzd(new zzif(this, str2, str3, str, j10));
    }
    ...
    public final zzao zzw(zzr zzrVar) {
        ...
        Preconditions.checkNotEmpty(zzrVar.zza);
        try {
            return (zzao) this.zza.zzaW().zzi(new zzip(this, zzrVar)).get(BaseServer.TIMEOUT_DEBUG, TimeUnit.MILLISECONDS);
        } catch (InterruptedException | ExecutionException | TimeoutException e10) {
            this.zza.zzaV().zzb().zzc("Failed to get consent. appId", zzgt.zzl(zzrVar.zza), e10);
    ...
    public final List zzx(zzr zzrVar, Bundle bundle) {
        ...
        if (zzpfVar.zzd().zzp(null, zzfx.zzaY)) {
            try {
                return (List) zzpfVar.zzaW().zzi(new zziu(this, zzrVar, bundle)).get(BaseServer.TIMEOUT_DEBUG, TimeUnit.MILLISECONDS);
            } catch (InterruptedException | ExecutionException | TimeoutException e10) {
                this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgt.zzl(zzrVar.zza), e10);
                return Collections.emptyList();
            }
        }
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgt.zzl(zzrVar.zza), e11);
            return Collections.emptyList();
        }
    }
