...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient.zzc(zzd, true, DownloadProgress.UNKNOWN_PROGRESS, SystemClock.elapsedRealtime() - elapsedRealtime, "", null);
            return zzd;
        } finally {
        }
    }
                ...
                try {
                    ...
                    try {
                        if (ConnectionTracker.getInstance().bindService(context, intent, blockingServiceConnection, 1)) {
                            ...
                            try {
                                this.zzb = zze.zza(blockingServiceConnection.getServiceWithTimeout(BaseServer.TIMEOUT_DEBUG, TimeUnit.MILLISECONDS));
                                this.zzc = true;
                                if (z10) {
                                    zze();
                                }
