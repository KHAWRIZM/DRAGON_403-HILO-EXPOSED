...
public abstract class i0 {
    ...
    private static final Comparator f٩٣١٠a = new a();
    ...
    public static TextView e(Toolbar toolbar) {
        List f10 = f(toolbar, toolbar.getSubtitle());
        if (f10.isEmpty()) {
            return null;
        }
        return (TextView) Collections.max(f10, f٩٣١٠a);
    }
    ...
    public static TextView g(Toolbar toolbar) {
        List f10 = f(toolbar, toolbar.getTitle());
        if (f10.isEmpty()) {
            return null;
        }
        return (TextView) Collections.min(f10, f٩٣١٠a);
    }
}
