...
public abstract class d {
    ...
    private static final ThreadLocal f٩٢٨٩a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f٩٢٩٠b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f٩٢٨٩a;
        ...
        ThreadLocal threadLocal2 = f٩٢٩٠b;
