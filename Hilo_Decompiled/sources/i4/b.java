...
public abstract class b {
    ...
    public static final int[] b(int i10, int i11, int i12, boolean z10) {
        int i13;
        if (i10 >= 1900 && i10 <= 2099 && i11 >= 1 && i11 <= 12 && i12 >= 1 && i12 <= 30) {
            int i14 = i10 - 1900;
            int i15 = f١٤٦٠٤b[i14];
            int i16 = i15 & 31;
            int i17 = i16 - 1;
            ...
            for (int i18 = 1; i18 < i11; i18++) {
                if (((anet.channel.bytes.a.MAX_POOL_SIZE >> (i18 - 1)) & f١٤٦٠٤b[i14]) == 0) {
                    i17 += 29;
                } else {
                    i17 += 30;
                }
            ...
            int i19 = i17 + i12;
            int i20 = f١٤٦٠٤b[i14];
            int i21 = (15728640 & i20) >> 20;
            if (i21 != 0 && (i11 > i21 || (i11 == i21 && z10))) {
                i19 = ((anet.channel.bytes.a.MAX_POOL_SIZE >> (i11 - 1)) & i20) == 0 ? i19 + 29 : i19 + 30;
            }
            if (i19 > 366 || (i10 % 4 != 0 && i19 > 365)) {
                i10++;
                i19 = i10 % 4 == 1 ? i19 - 366 : i19 - 365;
            }
            int[] iArr = new int[3];
            int i22 = 1;
            while (true) {
                ...
                if (i23 >= i19) {
                    ...
                    if (i19 > i13) {
                        ...
                        if (i24 == 0 && i22 == 2) {
                            iArr[2] = (iArr2[i22] - i25) + 1;
                        } else {
                            iArr[2] = iArr2[i22] - i25;
                        }
                    } else {
                        iArr[2] = i19;
                    }
    ...
    private static long c(int i10, int i11, int i12) {
        ...
        return (((i13 * 365) + (i13 / 4)) - (i13 / 100)) + (i13 / 400) + (((r3 * 306) + 5) / 10) + (i12 - 1);
    }
    ...
    public static final int[] d(int i10, int i11, int i12) {
        ...
        int i14 = 0;
        int i15 = i10 - iArr2[0];
        if (iArr2[i15] > ((i10 << 9) | (i11 << 5) | i12)) {
            i15--;
        }
        int i16 = iArr2[i15];
        long c10 = c(i10, i11, i12) - c(a(i16, 12, 9), a(i16, 4, 5), a(i16, 5, 0));
        int i17 = f١٤٦٠٦d[i15];
        int a10 = a(i17, 4, 13);
        int i18 = i15 + f١٤٦٠٥c[0];
        long j10 = c10 + 1;
        int i19 = 1;
