...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (isFallback && indexOf != -1) {
            Intrinsics.checkNotNullExpressionValue(enabledCipherSuites, "cipherSuitesIntersection");
        ...
        Intrinsics.checkNotNullExpressionValue(enabledProtocols, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m٣٢٣deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m٣٢٥deprecated_tlsVersions() {
        return tlsVersions();
    }
