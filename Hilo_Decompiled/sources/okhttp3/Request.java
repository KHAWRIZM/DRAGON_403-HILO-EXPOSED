...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder post(@NotNull RequestBody body) {
            Intrinsics.checkNotNullParameter(body, AgooConstants.MESSAGE_BODY);
            return method(SpdyRequest.POST_METHOD, body);
        }
    ...
    public final CacheControl m٤١٢deprecated_cacheControl() {
        return cacheControl();
    }
