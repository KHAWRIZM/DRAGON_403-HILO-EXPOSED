    ...
    public final void deflate(@NotNull Buffer buffer) throws IOException {
        ...
        if (this.deflatedBytes.size() == 0) {
            ...
            if (endsWith(buffer2, byteString)) {
                ...
                Buffer.UnsafeCursor readAndWriteUnsafe$default = Buffer.readAndWriteUnsafe$default(this.deflatedBytes, (Buffer.UnsafeCursor) null, 1, (Object) null);
                try {
                    readAndWriteUnsafe$default.resizeBuffer(size);
                    CloseableKt.closeFinally(readAndWriteUnsafe$default, (Throwable) null);
                } finally {
                }
            } else {
