...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    public boolean verify(@NotNull String host, @NotNull SSLSession session) {
        ...
        Intrinsics.checkNotNullParameter(host, Constants.KEY_HOST);
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        if (hostname != null && hostname.length() != 0 && !StringsKt.startsWith$default(hostname, ".", false, 2, (Object) null) && !StringsKt.endsWith$default(hostname, "..", false, 2, (Object) null) && pattern != null && pattern.length() != 0 && !StringsKt.startsWith$default(pattern, ".", false, 2, (Object) null) && !StringsKt.endsWith$default(pattern, "..", false, 2, (Object) null)) {
            ...
            if (!StringsKt.contains$default(asciiToLowercase, "*", false, 2, (Object) null)) {
                return Intrinsics.areEqual(str, asciiToLowercase);
            }
            if (!StringsKt.startsWith$default(asciiToLowercase, "*.", false, 2, (Object) null) || StringsKt.indexOf$default(asciiToLowercase, '*', 1, false, 4, (Object) null) != -1 || str.length() < asciiToLowercase.length() || Intrinsics.areEqual("*.", asciiToLowercase)) {
                return false;
            }
            ...
            return length <= 0 || StringsKt.lastIndexOf$default(str, '.', length + (-1), false, 4, (Object) null) == -1;
        }
        return false;
    }
}
