...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    @JvmField
    @NotNull
    public static final String VERSION_1 = MessageService.MSG_DB_NOTIFY_REACHED;
    ...
    private final void readJournalLine(String line) throws IOException {
        String substring;
        int indexOf$default = StringsKt.indexOf$default(line, ' ', 0, false, 6, (Object) null);
        if (indexOf$default != -1) {
            int i = indexOf$default + 1;
            int indexOf$default2 = StringsKt.indexOf$default(line, ' ', i, false, 4, (Object) null);
