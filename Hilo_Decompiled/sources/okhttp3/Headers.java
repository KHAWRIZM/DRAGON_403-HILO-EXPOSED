...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public static final class Builder {
        ...
        public final Builder addLenient$okhttp(@NotNull String line) {
            Intrinsics.checkNotNullParameter(line, "line");
            int indexOf$default = StringsKt.indexOf$default(line, ':', 1, false, 4, (Object) null);
            if (indexOf$default != -1) {
                String substring = line.substring(0, indexOf$default);
                Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
                String substring2 = line.substring(indexOf$default + 1);
    ...
    public static final class Companion {
        ...
        public final void checkValue(String value, String name) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (charAt != '\t' && (' ' > charAt || charAt >= 127)) {
                    ...
                    sb2.append(Util.format("Unexpected char %#04x at %d in %s value", Integer.valueOf(charAt), Integer.valueOf(i), name));
        ...
        public final Headers m٣٤٩deprecated_of(@NotNull String... namesAndValues) {
        ...
        @NotNull
        /* renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m٣٤٨deprecated_of(@NotNull Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
    ...
    public final int m٣٤٧deprecated_size() {
        return size();
    }
