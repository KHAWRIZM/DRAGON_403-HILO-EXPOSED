...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private final boolean isDot(String input) {
            if (Intrinsics.areEqual(input, ".") || StringsKt.equals(input, "%2e", true)) {
                return true;
            }
            return false;
        }
        ...
        private final boolean isDotDot(String input) {
            if (Intrinsics.areEqual(input, "..") || StringsKt.equals(input, "%2e.", true) || StringsKt.equals(input, ".%2e", true) || StringsKt.equals(input, "%2e%2e", true)) {
                return true;
            }
            return false;
        }
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String encodedValue) {
            ...
            Intrinsics.checkNotNull(list);
            Companion companion = HttpUrl.INSTANCE;
            list.add(Companion.canonicalize$okhttp$default(companion, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, RoomEvent.ROOM_IN, null));
            List<String> list2 = this.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list2);
            if (encodedValue != null) {
                str = Companion.canonicalize$okhttp$default(companion, encodedValue, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, RoomEvent.ROOM_IN, null);
            } else {
                str = null;
            }
            list2.add(str);
        ...
        public final Builder addQueryParameter(@NotNull String name, @Nullable String value) {
            ...
            Intrinsics.checkNotNull(list);
            Companion companion = HttpUrl.INSTANCE;
            list.add(Companion.canonicalize$okhttp$default(companion, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, RoomEvent.ROOM_CLEAN, null));
            List<String> list2 = this.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list2);
            if (value != null) {
                str = Companion.canonicalize$okhttp$default(companion, value, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, RoomEvent.ROOM_CLEAN, null);
            } else {
                str = null;
            }
            list2.add(str);
        ...
        public final Builder encodedFragment(@Nullable String encodedFragment) {
            ...
            if (encodedFragment != null) {
                str = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, "", true, false, false, true, null, UserProxyUtility.notification, null);
            } else {
                str = null;
            }
        ...
        public final Builder encodedQuery(@Nullable String encodedQuery) {
            ...
            if (encodedQuery != null) {
                Companion companion = HttpUrl.INSTANCE;
                String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(companion, encodedQuery, 0, 0, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, RoomEvent.ROOM_IN, null);
        ...
        public final Builder fragment(@Nullable String fragment) {
            String str;
            if (fragment != null) {
                str = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, "", false, false, false, true, null, UserProxyUtility.hiloGameNewRound, null);
            } else {
                str = null;
            }
            this.encodedFragment = str;
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl base, @NotNull String input) {
                ...
                while (true) {
                    ...
                    if (charAt == '@') {
                        if (!z2) {
                            ...
                            sb3.append("%40");
                            i3 = indexOfLastNonAsciiWhitespace$default;
                            sb3.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i4, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null));
            ...
            if (delimiterOffset3 < i6 && str.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, delimiterOffset3 + 1, i6, "", true, false, false, true, null, UserProxyUtility.foodieHot, null);
            }
            return this;
        }
        ...
        public final Builder query(@Nullable String query) {
            ...
            if (query != null) {
                Companion companion = HttpUrl.INSTANCE;
                String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(companion, query, 0, 0, HttpUrl.QUERY_ENCODE_SET, false, false, true, false, null, RoomEvent.ROOM_CLEAN, null);
                if (canonicalize$okhttp$default != null) {
                    list = companion.toQueryNamesAndValues$okhttp(canonicalize$okhttp$default);
                    this.encodedQueryNamesAndValues = list;
                    return this;
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            String str6 = this.encodedFragment;
            if (str6 != null) {
                str4 = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str6, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, null, UserProxyUtility.videoEffect, null);
            }
        ...
        public final Builder removeAllEncodedQueryParameters(@NotNull String encodedName) {
            ...
            removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, RoomEvent.ROOM_IN, null));
            return this;
        }
        ...
        public final Builder removeAllQueryParameters(@NotNull String name) {
            ...
            removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, RoomEvent.ROOM_CLEAN, null));
            return this;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:30:0x0083, code lost:
            ...
            if (r1 != r4.defaultPort(r3)) goto L٢٩;
         */
        @NotNull
        /*
    ...
    public static final class Companion {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:36:0x0064, code lost:
            ...
            if (isPercentEncoded(r16, r5, r18) == false) goto L٤٢;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
                ...
                if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                    if (codePointAt == 43 && z3) {
                        ...
                        if (codePointAt >= 32 && codePointAt != 127 && (codePointAt < 128 || z4)) {
                            if (!StringsKt.contains$default(str2, (char) codePointAt, false, 2, (Object) null)) {
                                if (codePointAt == 37) {
                                    if (z) {
                                        if (z2) {
                                        }
                        ...
                        while (!buffer2.exhausted()) {
                            ...
                            buffer.writeByte(37);
                            buffer.writeByte(HttpUrl.HEX_DIGITS[((readByte & 255) >> 4) & 15]);
                            buffer.writeByte(HttpUrl.HEX_DIGITS[readByte & 15]);
                        }
                        i3 += Character.charCount(codePointAt);
                    }
                }
        ...
        public final HttpUrl m٣٦٩deprecated_get(@NotNull String url) {
        ...
        public final HttpUrl m٣٧٢deprecated_parse(@NotNull String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        public final String canonicalize$okhttp(@NotNull String str, int i, int i2, @NotNull String str2, boolean z, boolean z2, boolean z3, boolean z4, @Nullable Charset charset) {
            ...
            while (i3 < i2) {
                int codePointAt = str.codePointAt(i3);
                if (codePointAt >= 32 && codePointAt != 127 && ((codePointAt < 128 || z4) && !StringsKt.contains$default(str2, (char) codePointAt, false, 2, (Object) null))) {
                    if (codePointAt == 37) {
                        if (z) {
                            if (z2) {
        ...
        @Nullable
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m٣٧١deprecated_get(@NotNull URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        @Nullable
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m٣٧٠deprecated_get(@NotNull URI uri) {
    ...
    public HttpUrl(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, int i, @NotNull List<String> list, @Nullable List<String> list2, @Nullable String str5, @NotNull String str6) {
        ...
        Intrinsics.checkNotNullParameter(str4, Constants.KEY_HOST);
    ...
    public final String m٣٥٠deprecated_encodedFragment() {
    ...
    public final String m٣٥١deprecated_encodedPassword() {
    ...
    public final String m٣٥٢deprecated_encodedPath() {
        return encodedPath();
    }
    ...
    public final List<String> m٣٥٣deprecated_encodedPathSegments() {
    ...
    public final String m٣٥٤deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m٣٥٥deprecated_encodedUsername() {
    ...
    public final List<String> m٣٥٩deprecated_pathSegments() {
    ...
    public final int m٣٦٠deprecated_pathSize() {
        return pathSize();
    }
    ...
    public final String m٣٦٢deprecated_query() {
        return query();
    }
    ...
    public final Set<String> m٣٦٣deprecated_queryParameterNames() {
    ...
    public final int m٣٦٤deprecated_querySize() {
        return querySize();
    }
    ...
    public final URI m٣٦٦deprecated_uri() {
        return uri();
    }
    ...
    public final URL m٣٦٧deprecated_url() {
        return url();
    }
    ...
    public final String encodedFragment() {
        ...
        String substring = this.url.substring(StringsKt.indexOf$default(this.url, '#', 0, false, 6, (Object) null) + 1);
    ...
    public final String encodedPassword() {
        ...
        String substring = this.url.substring(StringsKt.indexOf$default(this.url, ':', this.scheme.length() + 3, false, 4, (Object) null) + 1, StringsKt.indexOf$default(this.url, '@', 0, false, 6, (Object) null));
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        return substring;
    }
    ...
    public final String encodedPath() {
        int indexOf$default = StringsKt.indexOf$default(this.url, '/', this.scheme.length() + 3, false, 4, (Object) null);
        String str = this.url;
    ...
    public final String encodedQuery() {
        ...
        int indexOf$default = StringsKt.indexOf$default(this.url, '?', 0, false, 6, (Object) null) + 1;
        String str = this.url;
        String substring = this.url.substring(indexOf$default, Util.delimiterOffset(str, '#', indexOf$default, str.length()));
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        return substring;
