...
public final class Response implements Closeable {
    ...
    public final CacheControl m٤١٧deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = Constants.SHARED_MESSAGE_ID_FILE, imports = {}))
    ...
    public final ResponseBody peekBody(long byteCount) throws IOException {
        ...
        BufferedSource peek = responseBody.getSource().peek();
        BufferedSource buffer = new Buffer();
        peek.request(byteCount);
        buffer.write(peek, Math.min(byteCount, peek.getBuffer().size()));
