...
public final class CertificatePinner {
    ...
    public static final class Builder {
        ...
        public final CertificatePinner build() {
            ...
            return new CertificatePinner(CollectionsKt.toSet(this.pins), certificateChainCleaner, 2, certificateChainCleaner);
        }
    ...
    public static final class Pin {
        ...
        public Pin(@NotNull String str, @NotNull String str2) {
            ...
            if ((StringsKt.startsWith$default(str, "*.", false, 2, (Object) null) && StringsKt.indexOf$default(str, "*", 1, false, 4, (Object) null) == -1) || ((StringsKt.startsWith$default(str, "**.", false, 2, (Object) null) && StringsKt.indexOf$default(str, "*", 2, false, 4, (Object) null) == -1) || StringsKt.indexOf$default(str, "*", 0, false, 6, (Object) null) == -1)) {
        ...
        public final boolean matchesHostname(@NotNull String hostname) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                if (!StringsKt.regionMatches$default(hostname, hostname.length() - length3, this.pattern, 1, length3, false, 16, (Object) null) || StringsKt.lastIndexOf$default(hostname, '.', length4 - 1, false, 4, (Object) null) != -1) {
                    return false;
                }
            } else {
