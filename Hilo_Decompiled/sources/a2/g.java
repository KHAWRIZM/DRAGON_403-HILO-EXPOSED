...
public class g extends b {
    ...
    private double[] f١٥٩a;

    /* renamed from: b, reason: collision with root package name */
    private double[][] f١٦٠b;

    /* renamed from: c, reason: collision with root package name */
    private double[][] f١٦١c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f١٦٢d = true;
    ...
    public double c(double d10, int i10) {
        ...
        double d12;
        double f10;
        double[] dArr = this.f١٥٩a;
        int length = dArr.length;
        int i11 = 0;
        if (this.f١٦٢d) {
            double d13 = dArr[0];
            if (d10 <= d13) {
                d11 = this.f١٦٠b[0][i10];
                d12 = d10 - d13;
                f10 = f(d13, i10);
            } else {
                int i12 = length - 1;
        ...
        if (d10 <= dArr[0]) {
            return this.f١٦٠b[0][i10];
        }
        int i13 = length - 1;
        if (d10 >= dArr[i13]) {
            return this.f١٦٠b[i13][i10];
        }
        while (i11 < length - 1) {
            double[] dArr2 = this.f١٥٩a;
            double d15 = dArr2[i11];
            if (d10 == d15) {
                return this.f١٦٠b[i11][i10];
            }
            int i14 = i11 + 1;
    ...
    public void d(double d10, double[] dArr) {
        ...
        int i10 = 0;
        int length2 = this.f١٦٠b[0].length;
        if (this.f١٦٢d) {
            double d11 = dArr2[0];
            if (d10 <= d11) {
                g(d11, this.f١٦٣e);
                for (int i11 = 0; i11 < length2; i11++) {
                    dArr[i11] = this.f١٦٠b[0][i11] + ((d10 - this.f١٥٩a[0]) * this.f١٦٣e[i11]);
                }
                return;
            }
            int i12 = length - 1;
            ...
            if (d10 >= d12) {
                g(d12, this.f١٦٣e);
                while (i10 < length2) {
                    dArr[i10] = this.f١٦٠b[i12][i10] + ((d10 - this.f١٥٩a[i12]) * this.f١٦٣e[i10]);
                    i10++;
                }
                return;
            }
        ...
        int i15 = 0;
        while (i15 < length - 1) {
            if (d10 == this.f١٥٩a[i15]) {
                for (int i16 = 0; i16 < length2; i16++) {
                    dArr[i16] = this.f١٦٠b[i15][i16];
                }
            }
            double[] dArr3 = this.f١٥٩a;
            int i17 = i15 + 1;
    ...
    public void e(double d10, float[] fArr) {
        ...
        if (this.f١٦٢d) {
            ...
            if (d10 <= d11) {
                g(d11, this.f١٦٣e);
                for (int i11 = 0; i11 < length2; i11++) {
                    fArr[i11] = (float) (this.f١٦٠b[0][i11] + ((d10 - this.f١٥٩a[0]) * this.f١٦٣e[i11]));
                }
                return;
            }
            int i12 = length - 1;
            ...
            if (d10 >= d12) {
                g(d12, this.f١٦٣e);
                while (i10 < length2) {
                    fArr[i10] = (float) (this.f١٦٠b[i12][i10] + ((d10 - this.f١٥٩a[i12]) * this.f١٦٣e[i10]));
                    i10++;
                }
                return;
            }
            ...
            if (d10 <= dArr[0]) {
                for (int i13 = 0; i13 < length2; i13++) {
                    fArr[i13] = (float) this.f١٦٠b[0][i13];
                }
                return;
            }
            int i14 = length - 1;
            if (d10 >= dArr[i14]) {
                while (i10 < length2) {
                    fArr[i10] = (float) this.f١٦٠b[i14][i10];
                    i10++;
                }
                return;
            }
        ...
        while (i15 < length - 1) {
            if (d10 == this.f١٥٩a[i15]) {
                for (int i16 = 0; i16 < length2; i16++) {
                    fArr[i16] = (float) this.f١٦٠b[i15][i16];
                }
            }
            double[] dArr2 = this.f١٥٩a;
            int i17 = i15 + 1;
