...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((androidx.media.e) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            g.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            androidx.media.e currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        androidx.media.e getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(androidx.media.e eVar);
        ...
        void setPlaybackToRemote(k kVar);
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        int getRccTransportControlFlagsFromActions(long j10) {
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        ...
                        if (playbackSpeed > DownloadProgress.UNKNOWN_PROGRESS && playbackSpeed != 1.0f) {
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final androidx.media.e getCurrentControllerInfo() {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(androidx.media.e eVar) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private androidx.media.e mRemoteUserInfo;
        int mRepeatMode;
        ...
        private k.a mVolumeCallback = new k.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new androidx.media.e("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new androidx.media.e(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public androidx.media.e getCurrentControllerInfo() {
        ...
        int getRccStateFromState(int i10) {
            switch (i10) {
                case 0:
                    return 0;
                case 1:
        ...
        void postToHandler(int i10, int i11, int i12, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                try {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(k kVar) {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(g.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                g.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
            ...
            if (playbackStateCompat.getPosition() != -1) {
                if (playbackStateCompat.getState() == 3 || playbackStateCompat.getState() == 4 || playbackStateCompat.getState() == 5) {
                    if (playbackStateCompat.getLastPositionUpdateTime() > 0) {
                        ...
                        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), j10, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
                    }
                    return playbackStateCompat;
                }
                return playbackStateCompat;
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                if (!mediaSessionImplApi21.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new androidx.media.e(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
