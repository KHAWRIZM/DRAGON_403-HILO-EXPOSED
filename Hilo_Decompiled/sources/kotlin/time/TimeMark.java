...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(@NotNull TimeMark timeMark) {
            return Duration.m٢٠٢١isNegativeimpl(timeMark.mo٢١٢٦elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m٢١٠٨minusLRDsOJo(@NotNull TimeMark timeMark, long j10) {
            return timeMark.mo٢١٣٣plusLRDsOJo(Duration.m٢٠٣٩unaryMinusUwyO8pc(j10));
        }

        @NotNull
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m٢١٠٩plusLRDsOJo(@NotNull TimeMark timeMark, long j10) {
            return new AdjustedTimeMark(timeMark, j10, null);
        }
    }

    /* renamed from: elapsedNow-UwyO8pc, reason: contains not printable characters */
    long mo٢١٢٦elapsedNowUwyO8pc();
    ...
    TimeMark mo٢١٢٩minusLRDsOJo(long duration);

    @NotNull
    /* renamed from: plus-LRDsOJo, reason: contains not printable characters */
    TimeMark mo٢١٣٣plusLRDsOJo(long duration);
}
