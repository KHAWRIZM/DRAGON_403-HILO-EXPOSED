...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo٢١٢٦elapsedNowUwyO8pc() {
            return Duration.m٢٠٢٣minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(@Nullable Object other) {
            if ((other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m٢٠٠٠equalsimpl0(mo٢١٣٠minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m٢٠٨٦getZEROUwyO8pc())) {
                return true;
            }
            return false;
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m٢٠١٦hashCodeimpl(Duration.m٢٠٢٤plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo٢١٣٠minusUwyO8pc(@NotNull ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m٢٠٠٠equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m٢٠٢٠isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m٢٠٨٦getZEROUwyO8pc();
                    }
                    long j10 = Duration.m٢٠٢٣minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    if (Duration.m٢٠٠٠equalsimpl0(duration, Duration.m٢٠٣٩unaryMinusUwyO8pc(j10))) {
                        return Duration.INSTANCE.m٢٠٨٦getZEROUwyO8pc();
                    }
                    return Duration.m٢٠٢٤plusLRDsOJo(duration, j10);
                }
            }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m٢٠٣٥toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
        ...
        public ComparableTimeMark mo٢١٣٣plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m٢٠٢٤plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m٢٠٨٦getZEROUwyO8pc(), null);
    }
}
