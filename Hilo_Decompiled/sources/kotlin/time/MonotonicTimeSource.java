...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m٢٠٩٩adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m٢١١٤constructorimpl(LongSaturatedMathKt.m٢٠٩٧saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }

    /* renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m٢١٠٠differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m٢١٠١elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark, DurationUnit.NANOSECONDS);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m٢١١١boximpl(m٢١٠٢markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m٢١٠٢markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m٢١١٤constructorimpl(read());
    }
