...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m٢١٣٥copyRFiDyg4$default(TimedValue timedValue, Object obj, long j10, int i10, Object obj2) {
        if ((i10 & 1) != 0) {
        ...
        return timedValue.m٢١٣٧copyRFiDyg4(obj, j10);
    }
    ...
    public final TimedValue<T> m٢١٣٧copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m٢٠٠٠equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m٢١٣٨getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t10 = this.value;
        return ((t10 == null ? 0 : t10.hashCode()) * 31) + Duration.m٢٠١٦hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m٢٠٣٥toStringimpl(this.duration)) + ')';
    }
