...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m٦٣٣boximpl(m١٧٦٩nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m١٧٦٩nextpVg5ArA() {
        int i10 = this.next;
        if (i10 == this.finalElement) {
            ...
            this.next = UInt.m٦٣٩constructorimpl(this.step + i10);
        }
        return i10;
    }
    ...
    private UIntProgressionIterator(int i10, int i11, int i12) {
        ...
        this.hasNext = z10;
        this.step = UInt.m٦٣٩constructorimpl(i12);
