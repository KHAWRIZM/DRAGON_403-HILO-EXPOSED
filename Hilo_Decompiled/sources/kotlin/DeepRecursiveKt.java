...
public final class DeepRecursiveKt {
    ...
    static {
        ...
        UNDEFINED_RESULT = Result.m٥٤٤constructorimpl(IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }
    ...
    public static final <T, R> R invoke(@NotNull DeepRecursiveFunction<T, R> deepRecursiveFunction, T t10) {
        ...
        return (R) new DeepRecursiveScopeImpl(deepRecursiveFunction.getBlock$kotlin_stdlib(), t10).runCallLoop();
    }
}
