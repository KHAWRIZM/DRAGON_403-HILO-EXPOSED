...
public class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final <R> Sequence<R> filterIsInstance(@NotNull Sequence<?> sequence, @NotNull final Class<R> klass) {
        ...
        Sequence<R> filter = SequencesKt.filter(sequence, new Function1() { // from class: kotlin.sequences.f
    ...
    public static final /* synthetic */ Double m١٩٢٧max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m١٩٣٥maxOrNull((Sequence<Double>) sequence);
    }
    ...
    public static final /* synthetic */ Double m١٩٢٩min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m١٩٤٣minOrNull((Sequence<Double>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m١٩٢٨max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m١٩٣٦maxOrNull((Sequence<Float>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m١٩٣٠min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m١٩٤٤minOrNull((Sequence<Float>) sequence);
    }
