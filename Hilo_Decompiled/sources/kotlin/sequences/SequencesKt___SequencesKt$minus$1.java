...
public final class SequencesKt___SequencesKt$minus$1<T> implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        final T t10 = this.$element;
        return SequencesKt.filter(sequence, new Function1() { // from class: kotlin.sequences.q
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                boolean iterator$lambda$0;
                iterator$lambda$0 = SequencesKt___SequencesKt$minus$1.iterator$lambda$0(Ref.BooleanRef.this, t10, obj);
