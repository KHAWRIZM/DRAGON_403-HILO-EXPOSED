...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    private static final <T, R> Sequence<R> flatten$SequencesKt__SequencesKt(Sequence<? extends T> sequence, Function1<? super T, ? extends Iterator<? extends R>> function1) {
        ...
        return new FlatteningSequence(sequence, new Function1() { // from class: kotlin.sequences.e
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static <T> Sequence<T> generateSequence(@NotNull final Function0<? extends T> nextFunction) {
        ...
        return SequencesKt.constrainOnce(new GeneratorSequence(nextFunction, new Function1() { // from class: kotlin.sequences.b
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static <T> Sequence<T> generateSequence(@Nullable final T t10, @NotNull Function1<? super T, ? extends T> nextFunction) {
        ...
        return new GeneratorSequence(new Function0() { // from class: kotlin.sequences.a
            ...
            public final Object invoke() {
                ...
                generateSequence$lambda$6$SequencesKt__SequencesKt = SequencesKt__SequencesKt.generateSequence$lambda$6$SequencesKt__SequencesKt(t10);
