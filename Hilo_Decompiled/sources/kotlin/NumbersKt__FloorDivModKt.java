...
public class NumbersKt__FloorDivModKt extends NumbersKt__BigIntegersKt {
    ...
    private static final float mod(float f10, float f11) {
        float f12 = f10 % f11;
        return (f12 == DownloadProgress.UNKNOWN_PROGRESS || Math.signum(f12) == Math.signum(f11)) ? f12 : f12 + f11;
    }
    ...
    private static final double mod(float f10, double d10) {
        double d11 = f10 % d10;
        return (d11 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || Math.signum(d11) == Math.signum(d10)) ? d11 : d11 + d10;
    }
    ...
    private static final double mod(double d10, float f10) {
        double d11 = f10;
        double d12 = d10 % d11;
        return (d12 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || Math.signum(d12) == Math.signum(d11)) ? d12 : d12 + d11;
    }
