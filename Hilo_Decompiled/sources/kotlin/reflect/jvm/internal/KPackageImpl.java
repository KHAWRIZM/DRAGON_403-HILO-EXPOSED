...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public static final Class multifileFacade_delegate$lambda$2(Data data, KPackageImpl kPackageImpl) {
            ...
            return kPackageImpl.getJClass().getClassLoader().loadClass(StringsKt.replace$default(str, '/', '.', false, 4, (Object) null));
        }
    ...
    public boolean equals(@Nullable Object other) {
        if ((other instanceof KPackageImpl) && Intrinsics.areEqual(getJClass(), ((KPackageImpl) other).getJClass())) {
            return true;
        }
        return false;
    }
