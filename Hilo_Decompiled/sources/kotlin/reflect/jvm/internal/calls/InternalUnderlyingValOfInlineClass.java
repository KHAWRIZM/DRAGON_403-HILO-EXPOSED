...
public abstract class InternalUnderlyingValOfInlineClass implements Caller<Method> {
    ...
    @Override // kotlin.reflect.jvm.internal.calls.Caller
    @Nullable
    /* renamed from: getMember, reason: avoid collision after fix types in other method and contains not printable characters */
    public final Method mo١٨٢١getMember() {
        return null;
    }
