...
public class BitEncoding {
    ...
    private static void addModuloByte(@NotNull byte[] bArr, int i10) {
        if (bArr == null) {
            $$$reportNull$$$0(4);
        }
        int length = bArr.length;
        for (int i11 = 0; i11 < length; i11++) {
            bArr[i11] = (byte) ((bArr[i11] + i10) & Constants.ERR_WATERMARKR_INFO);
        }
    }
    ...
    private static byte[] decode7to8(@NotNull byte[] bArr) {
        ...
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = i10 + 1;
            int i14 = i11 + 1;
            bArr2[i12] = (byte) (((bArr[i10] & UByte.MAX_VALUE) >>> i11) + ((bArr[i13] & ((1 << i14) - 1)) << (7 - i11)));
            if (i11 == 6) {
                i10 += 2;
                i11 = 0;
            } else {
    ...
    public static byte[] decodeBytes(@NotNull String[] strArr) {
        ...
        addModuloByte(combineStringArrayIntoBytes, Constants.ERR_WATERMARKR_INFO);
