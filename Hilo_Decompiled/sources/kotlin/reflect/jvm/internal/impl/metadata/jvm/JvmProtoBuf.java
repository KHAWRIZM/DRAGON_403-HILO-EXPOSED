...
public final class JvmProtoBuf {
    ...
    public static final class JvmFieldSignature extends GeneratedMessageLite implements JvmFieldSignatureOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 2) == 2) {
                i10 += CodedOutputStream.computeInt32Size(2, this.desc_);
            }
    ...
    public static final class JvmPropertySignature extends GeneratedMessageLite implements JvmPropertySignatureOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 1) == 1) {
                i10 = CodedOutputStream.computeMessageSize(1, this.field_);
            } else {
                i10 = 0;
            }
            if ((this.bitField0_ & 2) == 2) {
                i10 += CodedOutputStream.computeMessageSize(2, this.syntheticMethod_);
            }
            if ((this.bitField0_ & 4) == 4) {
                i10 += CodedOutputStream.computeMessageSize(3, this.getter_);
            }
            if ((this.bitField0_ & 8) == 8) {
                i10 += CodedOutputStream.computeMessageSize(4, this.setter_);
            }
            if ((this.bitField0_ & 16) == 16) {
                i10 += CodedOutputStream.computeMessageSize(5, this.delegateMethod_);
            }
            int size = i10 + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            ...
            public int getSerializedSize() {
                ...
                if ((this.bitField0_ & 1) == 1) {
                    i10 = CodedOutputStream.computeInt32Size(1, this.range_);
                } else {
                    i10 = 0;
                }
                if ((this.bitField0_ & 2) == 2) {
                    i10 += CodedOutputStream.computeInt32Size(2, this.predefinedIndex_);
                }
                if ((this.bitField0_ & 8) == 8) {
                    i10 += CodedOutputStream.computeEnumSize(3, this.operation_.getNumber());
                }
                int i12 = 0;
