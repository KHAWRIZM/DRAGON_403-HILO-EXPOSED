...
public final class SignatureParts extends AbstractSignatureParts<AnnotationDescriptor> {
    ...
    public SignatureParts(@Nullable Annotated annotated, boolean z10, @NotNull LazyJavaResolverContext containerContext, @NotNull AnnotationQualifierApplicabilityType containerApplicabilityType, boolean z11) {
