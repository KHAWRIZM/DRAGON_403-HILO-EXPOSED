...
public final class OperatorNameConventions {
    ...
    static {
        ...
        SIMPLE_BINARY_OPERATION_NAMES = SetsKt.setOf((Object[]) new Name[]{identifier29, identifier24, identifier25, identifier30, identifier31, identifier32});
        ...
        NUMBER_CONVERSIONS = SetsKt.setOf((Object[]) new Name[]{identifier41, identifier42, identifier43, identifier44, identifier46, identifier47, identifier45});
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(identifier22, "++"), TuplesKt.to(identifier23, "--"), TuplesKt.to(identifier28, "+"), TuplesKt.to(identifier27, "-"), TuplesKt.to(identifier26, "!"), TuplesKt.to(identifier29, "*"), TuplesKt.to(identifier24, "+"), TuplesKt.to(identifier25, "-"), TuplesKt.to(identifier30, "/"), TuplesKt.to(identifier32, "%"), TuplesKt.to(identifier33, ".."), TuplesKt.to(identifier34, "..<"));
    }
