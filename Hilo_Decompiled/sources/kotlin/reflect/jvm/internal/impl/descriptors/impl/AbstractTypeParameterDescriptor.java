...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo١٨٩٧reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> list = ((TypeParameterTypeConstructor) getTypeConstructor()).mo١٩٢٤getSupertypes();
        if (list == null) {
            $$$reportNull$$$0(8);
        }
        return list;
    ...
    protected abstract void mo١٨٩٧reportSupertypeLoopError(@NotNull KotlinType kotlinType);
