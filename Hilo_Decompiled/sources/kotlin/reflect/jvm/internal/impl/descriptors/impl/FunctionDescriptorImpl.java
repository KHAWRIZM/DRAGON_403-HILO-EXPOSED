...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        public <V> FunctionDescriptor.CopyBuilder<FunctionDescriptor> putUserData(@NotNull CallableDescriptor.UserDataKey<V> userDataKey, V v10) {
            ...
            this.userDataMap.put(userDataKey, v10);
            return this;
        }
    ...
    @NotNull
    private SourceElement getSourceToUseForCopy(boolean z10, @Nullable FunctionDescriptor functionDescriptor) {
    ...
    public FunctionDescriptor doSubstitute(@NotNull CopyConfiguration copyConfiguration) {
        ...
        FunctionDescriptorImpl createSubstitutedCopy = createSubstitutedCopy(declarationDescriptor, functionDescriptor2, copyConfiguration.kind, copyConfiguration.name, annotations2, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, functionDescriptor2));
        ...
        if (!copyConfiguration.newContextReceiverParameters.isEmpty()) {
            ...
            for (ReceiverParameterDescriptor receiverParameterDescriptor2 : copyConfiguration.newContextReceiverParameters) {
                ...
                int i11 = i10 + 1;
                arrayList2.add(DescriptorFactory.createContextReceiverParameterForCallable(createSubstitutedCopy, substitute2, ((ImplicitContextReceiver) receiverParameterDescriptor2.getValue()).getCustomLabelName(), receiverParameterDescriptor2.getAnnotations(), i10));
                boolean z15 = zArr[0];
        ...
        boolean z19 = z18 | z10;
        zArr[0] = z19;
        if (!z19 && copyConfiguration.justForTypeSubstitution) {
            return this;
        }
        ...
        if (copyConfiguration.newHasSynthesizedParameterNames != null) {
            z11 = copyConfiguration.newHasSynthesizedParameterNames.booleanValue();
        } else {
            z11 = this.hasSynthesizedParameterNames;
        }
        createSubstitutedCopy.setHasSynthesizedParameterNames(z11);
    ...
    @Nullable
    public static List<ValueParameterDescriptor> getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, @NotNull List<ValueParameterDescriptor> list, @NotNull TypeSubstitutor typeSubstitutor, boolean z10, boolean z11, @Nullable boolean[] zArr) {
