...
public abstract class VariableDescriptorWithInitializerImpl extends VariableDescriptorImpl {
    ...
    public VariableDescriptorWithInitializerImpl(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, @NotNull Name name, @Nullable KotlinType kotlinType, boolean z10, @NotNull SourceElement sourceElement) {
    ...
    @Nullable
    /* renamed from: getCompileTimeInitializer, reason: contains not printable characters */
    public ConstantValue<?> mo١٩٢١getCompileTimeInitializer() {
