...
public final class ReflectionTypes {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final ClassDescriptor find(String str, int i10) {
        ClassDescriptor classDescriptor;
        Name identifier = Name.identifier(str);
        Intrinsics.checkNotNullExpressionValue(identifier, "identifier(...)");
        ClassifierDescriptor classifierDescriptor = getKotlinReflectScope().mo١٩٢٥getContributedClassifier(identifier, NoLookupLocation.FROM_REFLECTION);
        ...
        if (classDescriptor == null) {
            return this.notFoundClasses.getClass(new ClassId(StandardNames.KOTLIN_REFLECT_FQ_NAME, identifier), CollectionsKt.listOf(Integer.valueOf(i10)));
        }
