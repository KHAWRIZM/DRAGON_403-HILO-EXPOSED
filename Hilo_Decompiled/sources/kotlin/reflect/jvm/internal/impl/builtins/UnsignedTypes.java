...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(@NotNull KotlinType type) {
        ...
        if (TypeUtils.noExpectedType(type) || (classifierDescriptor = type.getConstructor().mo١٩٢٣getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptor);
    }
