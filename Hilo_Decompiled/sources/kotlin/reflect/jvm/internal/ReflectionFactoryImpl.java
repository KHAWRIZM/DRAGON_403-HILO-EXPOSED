...
public class ReflectionFactoryImpl extends ReflectionFactory {
    ...
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z10) {
        if (kClassifier instanceof ClassBasedDeclarationContainer) {
            return CachesKt.getOrCreateKType(((ClassBasedDeclarationContainer) kClassifier).getJClass(), list, z10);
        }
        return KClassifiers.createType(kClassifier, list, z10, Collections.emptyList());
    }
