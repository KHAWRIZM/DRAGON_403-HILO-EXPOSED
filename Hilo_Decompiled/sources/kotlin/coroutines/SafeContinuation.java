...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == coroutineSingletons) {
            if (androidx.concurrent.futures.b.a(RESULT, this, coroutineSingletons, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(@NotNull Object result) {
        while (true) {
            ...
            CoroutineSingletons coroutineSingletons = CoroutineSingletons.UNDECIDED;
            if (obj == coroutineSingletons) {
                if (androidx.concurrent.futures.b.a(RESULT, this, coroutineSingletons, result)) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (androidx.concurrent.futures.b.a(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
