...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public DeepRecursiveScopeImpl(@NotNull Function3<? super DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> block, T t10) {
        super(null);
        Object obj;
    ...
    @Nullable
    public Object callRecursive(T t10, @NotNull Continuation<? super R> continuation) {
    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (continuation != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m٥٤٦equalsimpl0(obj, r10)) {
                    ...
                    try {
                        ...
                        if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            continuation.resumeWith(Result.m٥٤٤constructorimpl(invoke));
                        }
                    } catch (Throwable th) {
    ...
    @Override // kotlin.DeepRecursiveScope
    @Nullable
    public <U, S> Object callRecursive(@NotNull DeepRecursiveFunction<U, S> deepRecursiveFunction, U u10, @NotNull Continuation<? super S> continuation) {
