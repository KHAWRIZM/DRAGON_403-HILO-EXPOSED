...
public final class DelimitedRangesSequence$iterator$1 implements Iterator<IntRange>, KMappedMarker {
    ...
    public DelimitedRangesSequence$iterator$1(DelimitedRangesSequence delimitedRangesSequence) {
        ...
        i10 = delimitedRangesSequence.startIndex;
        charSequence = delimitedRangesSequence.input;
        int coerceIn = RangesKt.coerceIn(i10, 0, charSequence.length());
    ...
    */
    private final void calcNext() {
        ...
        if (this.nextSearchIndex >= 0) {
            ...
            if (i10 > 0) {
                int i13 = this.counter + 1;
                this.counter = i13;
                i11 = this.this$0.limit;
            }
            int i14 = this.nextSearchIndex;
            ...
            if (i14 <= charSequence.length()) {
                ...
                if (pair == null) {
                    int i15 = this.currentStartIndex;
                    charSequence3 = this.this$0.input;
                    this.nextItem = new IntRange(i15, StringsKt.getLastIndex(charSequence3));
                    ...
                    this.nextSearchIndex = i16 + i12;
                }
                this.nextState = 1;
                return;
            }
            int i17 = this.currentStartIndex;
            charSequence4 = this.this$0.input;
            this.nextItem = new IntRange(i17, StringsKt.getLastIndex(charSequence4));
            this.nextSearchIndex = -1;
            this.nextState = 1;
            return;
        }
