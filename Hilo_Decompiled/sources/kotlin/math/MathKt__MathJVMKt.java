...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double asinh(double d10) {
        ...
        if (d10 < d11) {
            ...
            return Math.abs(d10) >= Constants.taylor_2_bound ? d10 - (((d10 * d10) * d10) / 6) : d10;
        }
