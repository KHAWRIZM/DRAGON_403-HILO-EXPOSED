...
public final class RomUtils {
    ...
    private static final String[] ROM_HUAWEI = {AgooConstants.MESSAGE_SYSTEM_SOURCE_HUAWEI};
    private static final String[] ROM_VIVO = {AgooConstants.MESSAGE_SYSTEM_SOURCE_VIVO};
    private static final String[] ROM_XIAOMI = {AgooConstants.MESSAGE_SYSTEM_SOURCE_XIAOMI};
    private static final String[] ROM_OPPO = {AgooConstants.MESSAGE_SYSTEM_SOURCE_OPPO};
    ...
    private static final String[] ROM_MEIZU = {AgooConstants.MESSAGE_SYSTEM_SOURCE_MEIZU};
