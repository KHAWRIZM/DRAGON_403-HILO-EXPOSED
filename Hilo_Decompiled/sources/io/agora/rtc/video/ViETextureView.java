...
public class ViETextureView extends GLTextureView implements GLTextureView.Renderer, GLRendererController {
    ...
    public void releaseOpenGLResource() {
        ...
        queueEvent(new Runnable() { // from class: io.agora.rtc.video.ViETextureView.2
            @Override // java.lang.Runnable
            public void run() {
                Logging.i(ViETextureView.TAG, "releaseOpenGLResource, value = " + ViETextureView.this.nativeGLPragram + " ," + ViETextureView.this.nativeGLTextureId[0] + " ," + ViETextureView.this.nativeGLTextureId[1] + " ," + ViETextureView.this.nativeGLTextureId[2] + ", " + ViETextureView.this.nativeOesGLProgram);
                ...
                if (glGetError != 0) {
                    Logging.e(ViETextureView.TAG, "glDelete error: " + glGetError);
                }
            }
        });
        this.nativeGLResourceUpdated = false;
    ...
    public static class ConfigChooser implements GLTextureView.EGLConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            ...
            Logging.w(ViETextureView.TAG, "The specified config was not found, use the first config. configs.length=" + eGLConfigArr.length);
    ...
    public ViETextureView(Context context, boolean z10, int i10, int i11) {
        super(context);
        this.surfaceCreated = false;
        this.openGLCreated = false;
        this.nativeFunctionsRegisted = false;
