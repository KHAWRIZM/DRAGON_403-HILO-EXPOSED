...
import io.agora.rtc.video.GLTextureViewWrapper;
...
public class ViETextureViewWrapper extends GLTextureViewWrapper implements GLTextureViewWrapper.Renderer, GLRendererController {
    private static final boolean DEBUG = false;
    private static String TAG = "ViETextureViewWrapper";
    ...
    public ViETextureViewWrapper(TextureView textureView) {
        super(textureView);
    ...
    public static boolean UseOpenGL2(Object obj) {
        return ViETextureViewWrapper.class.isInstance(obj);
    }
    ...
    public void doDrawFrame(boolean z10) {
        if (z10) {
            try {
    ...
    @Override // io.agora.rtc.video.GLTextureViewWrapper.Renderer
    ...
    public void releaseOpenGLResource() {
        ...
        queueEvent(new Runnable() { // from class: io.agora.rtc.video.ViETextureViewWrapper.2
            @Override // java.lang.Runnable
            public void run() {
                Logging.i(ViETextureViewWrapper.TAG, "releaseOpenGLResource, value = " + ViETextureViewWrapper.this.nativeGLPragram + " ," + ViETextureViewWrapper.this.nativeGLTextureId[0] + " ," + ViETextureViewWrapper.this.nativeGLTextureId[1] + " ," + ViETextureViewWrapper.this.nativeGLTextureId[2] + ", " + ViETextureViewWrapper.this.nativeOesGLProgram);
                if (ViETextureViewWrapper.this.nativeGLPragram > 0) {
                    GLES20.glDeleteProgram(ViETextureViewWrapper.this.nativeGLPragram);
                }
                if (ViETextureViewWrapper.this.nativeGLTextureId[0] > 0) {
                    GLES20.glDeleteTextures(3, ViETextureViewWrapper.this.nativeGLTextureId, 0);
                }
                if (ViETextureViewWrapper.this.nativeOesGLProgram > 0) {
                    GLES20.glDeleteProgram(ViETextureViewWrapper.this.nativeOesGLProgram);
                }
                int glGetError = GLES20.glGetError();
                if (glGetError != 0) {
                    Logging.e(ViETextureViewWrapper.TAG, "glDelete error: " + glGetError);
                }
            }
        });
        this.nativeGLResourceUpdated = false;
    ...
    @Override // io.agora.rtc.video.GLTextureViewWrapper
    public void surfaceDestroyed(SurfaceTexture surfaceTexture) {
        queueEvent(new Runnable() { // from class: io.agora.rtc.video.ViETextureViewWrapper.1
            @Override // java.lang.Runnable
            public void run() {
                synchronized (ViETextureViewWrapper.this) {
                    ViETextureViewWrapper.this.surfaceCreated = false;
                    ViETextureViewWrapper.this.textureRendererHelper.releaseSurfaceTexture();
                }
            }
        });
    ...
    /* loaded from: C:\Users\admin\Projects\Archive\SULAIMAN_EMPIRE\DEX_FILES\classes3.dex */
    public static class ConfigChooser implements GLTextureViewWrapper.EGLConfigChooser {
        ...
        private void printConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            ...
            for (int i10 = 0; i10 < 33; i10++) {
                ...
                if (egl10.eglGetConfigAttrib(eGLDisplay, eGLConfig, i11, iArr2)) {
                    Logging.w(ViETextureViewWrapper.TAG, String.format("  %s: %d\n", str, Integer.valueOf(iArr2[0])));
                }
                do {
        ...
        private void printConfigs(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            ...
            Logging.w(ViETextureViewWrapper.TAG, String.format("%d configurations", Integer.valueOf(length)));
            for (int i10 = 0; i10 < length; i10++) {
                Logging.w(ViETextureViewWrapper.TAG, String.format("Configuration %d:\n", Integer.valueOf(i10)));
        ...
        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay) {
            ...
            int i10 = iArr[0];
            if (i10 <= 0) {
                Logging.w(ViETextureViewWrapper.TAG, "no configurations found");
                return null;
            }
